...
module normalizer.Correctness.Correctness
...
open import normalizer.Correctness.Record public

------------------------------------------------------------------------
-- Import the parameterized proofs
------------------------------------------------------------------------

open import normalizer.Correctness.Terminates
  normalize strong-normalization
  public

open import normalizer.Correctness.ProducesNF
  normalize
  public

open import normalizer.Correctness.Preserves
