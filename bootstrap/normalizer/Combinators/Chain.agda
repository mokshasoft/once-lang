------------------------------------------------------------------------
-- Foundations.Chain: Reduction proof infrastructure
--
-- Provides common reduction lemmas for working with distrib and
...
open import normalizer.Syntax.NoRedex hiding (is-id) public
