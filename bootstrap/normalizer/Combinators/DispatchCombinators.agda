...
module normalizer.Combinators.DispatchCombinators where

open import normalizer.Combinators.ReductionCombinators public
open import normalizer.Encoding.Catamorphisms
...
open import normalizer.Syntax.CCC using (case-inr; case-inl)
...
open import normalizer.Encoding.Catamorphisms using (fmap-KK-id)
open import normalizer.Syntax.CCC using (id; id-left; K; _⊗_; fmap; _*_)
