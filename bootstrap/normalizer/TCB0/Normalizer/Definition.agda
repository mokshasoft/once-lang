...
module normalizer.TCB0.Normalizer.Definition where

-- Re-export everything from the submodule chain
-- Fixpoint is the top of the chain and re-exports everything below it
open import normalizer.TCB0.Normalizer.Proofs.Fixpoint public

-- Note: distrib, caseWithCtx, _>>_, ⟶1, etc. are all exported via Chain

-- Re-export the spec instance
open import normalizer.TCB0.Compiler.SatisfiesSpec public
