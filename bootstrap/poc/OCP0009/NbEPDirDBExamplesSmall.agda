...
{-# OPTIONS --safe #-}
module poc.OCP0009.NbEPDirDBExamplesSmall where
...
open import poc.OCP0009.NbEPDirDBPi
  using ( Cx; ε; _∙; RTy; base; U; El; Hom; Unit; Nat
        ...
        ; unit; nzero; nsuc )
open import poc.OCP0009.NbEPDirDBVar using ( NoNatC )
open import poc.OCP0009.NbEPDirDBType
  using ( _⟶ᵀ_
        ...
        ; ⊢⌜Nat⌝; ⊢⌜Unit⌝; ⊢⌜Hom⌝; ⊢absurd )
open import poc.OCP0009.NbEPDirDBInj using ( _⟶ᵀ*_; doneᵀ; stepᵀ; red→≅ᵀ )
