{-# OPTIONS --safe #-}
module poc.OCP0009.SpikeCostS6 where

-- ABLATION S6: carrier is a CLOSED code El ⌜Nat⌝, but the A : U slot IS present
--   (5 slots) — isolates slot count from variable-ness.
