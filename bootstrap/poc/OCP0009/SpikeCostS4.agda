{-# OPTIONS --safe #-}
module poc.OCP0009.SpikeCostS4 where

-- ABLATION S4: carrier=nat, step slot=Nat.
...
LStepT : RTy (ε ∙ ∙ ∙)
LStepT = Π Nat (Π REC1T (Π REC2T (El (app (var (vs (vs (vs (vs (vs vz)))))) (var (vs (vs vz)))))))

Γ₅ : Ctx
Γ₅ = (((◇ ▹ Π Nat U) ▹ Π Nat Nat) ▹ Π Nat Nat) ▹ Nat
