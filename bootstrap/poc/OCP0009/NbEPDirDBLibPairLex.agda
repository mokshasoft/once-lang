...
{-# OPTIONS --safe #-}
module poc.OCP0009.NbEPDirDBLibPairLex where

open import poc.OCP0009.NbEPDirDBPi using ( Cx; RTm; RTy; Nat; ⌜Nat⌝ )
...
open import poc.OCP0009.NbEPDirDBLibPair using ( PairT; ⊢PairT; msr₁; msr₂; ⊢msr₁; ⊢msr₂ )
open import poc.OCP0009.NbEPDirDBLibLexrec using ( rec2Tat )
