...
{-# OPTIONS --safe #-}
module poc.OCP0009.NbEPDirDBExamplesAbsProbe where
...
open import poc.OCP0009.NbEPDirDBLibAmrec using ( StepExt; aStepT )
open import poc.OCP0009.NbEPDirDBType using ( ⊢app )
