...
⚠ The standing lessons that used to be §4 here now live in
`LESSONS.md`, with the library-structure rules added beside them.
This file is the DATED state of 2026-08-22 and is superseded by the
later `HANDOFF-2026-08-NN.md`.
