...
JΟΒ9 JΟΒ10 JΟΒ11 JΟΒ12 JΟΒ13 JΟΒ14 JΟΒ15 JΟΒ16 JΟΒ17 : Ctx
JΟΒ9 = JΟΒ8 ▹ IMu JudgeD IJudge kJΟΒ8
JΟΒ10 = JΟΒ9 ▹ IMu JudgeD IJudge kJΟΒ9
JΟΒ11 = JΟΒ10 ▹ IMu JudgeD IJudge kJΟΒ10
JΟΒ12 = JΟΒ11 ▹ El kJΟΒ11
JΟΒ13 = JΟΒ12 ▹ El kJΟΒ12
JΟΒ14 = JΟΒ13 ▹ El kJΟΒ13
JΟΒ15 = JΟΒ14 ▹ El kJΟΒ14
JΟΒ16 = JΟΒ15 ▹ El kJΟΒ15
JΟΒ17 = JΟΒ16 ▹ El kJΟΒ16

aJΟΒ16 : JΟΒ16 ⊢ fst (var (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs (vs vz))))))))))))))))) ∷ Nat
aJΟΒ16 = ⊢fst (⊢var (there (there (there (there (there (there (there (there (there (there (there (there (there (there (there (there here)))))))))))))))))
CJΟΒ16 : ICon ⌊ JΟΒ16 ⌋
CJΟΒ16 = iκ kJΟΒ16 iι
W_JΟΒ16 : IConWf JudgeD IJudge JΟΒ16 CJΟΒ16
W_JΟΒ16 =
  iwf-κ kJΟΒ16 (icw-ford _ _ _)
    (⊢⌜Id⌝ (⊢⌜IMu⌝ IxWf (toI aJΟΒ16))
           ...
           (⊢jsub (⊢⌜IMu⌝ IxWf (toI (fromI (⊢var here))))
                  ...
                  (toI aJΟΒ16)
                  (⊢symN aJΟΒ16 (fromI (⊢var (there (there (there (there (there (there (there (there (there (there (there (there (there (there (there here)))))))))))))))))
...
W_JΟΒ7 =
  iwf-κ kJΟΒ7 (icw-imu (pair (num 0) (pair (var vz) (var (vs (vs vz))))) InIDWf)
...
CJΟΒ6 : ICon ⌊ JΟΒ6 ⌋
CJΟΒ6 = iκ kJΟΒ6 CJΟΒ7
W_JΟΒ6 : IConWf JudgeD IJudge JΟΒ6 CJΟΒ6
W_JΟΒ6 =
  iwf-κ kJΟΒ6 (icw-clo ⌜Nat⌝ ⊢⌜Nat⌝) ⊢⌜Nat⌝
    W_JΟΒ7
...
W_JΟΒ5 =
  iwf-κ kJΟΒ5 (icw-imu (pair sTy nzero) KnotWf)
...
W_JΟΒ4 =
  iwf-κ kJΟΒ4 (icw-imu (pair sIDesc nzero) KnotWf)
...
W_JΟΒ3 =
  iwf-κ kJΟΒ3 (icw-imu (pair sTm (var (vs (vs vz)))) KnotWf)
...
jd⊢iconWf : IConWf JudgeD IJudge JΟΒ0 jd⊢icon
jd⊢iconWf = W_JΟΒ0
