------------------------------------------------------------------------
-- OCP-0009 · EXAMPLES — ★★★ `ipayTy`'s `iκ` ROW, ALONE IN A MODULE.
--
...
{-# OPTIONS --safe #-}
module DirectedHoTT.Examples.Knot.IPayTyKap where
...
open import DirectedHoTT.Examples.Knot.Desc
  using ( KnotD; K; cICon-kap; cICon-kap )
open import DirectedHoTT.Examples.Knot.Wf
  using ( KnotWf; cICon-kapWf; cICon-kapWf )
open import DirectedHoTT.Examples.Knot.Tags using ( tagICon-kap; tagICon-kap )
...
ipayTyKap : {Γ : Cx} → RTm Γ
ipayTyKap =
  lam (lam (lam (lam (lam (lam (lam
    (Ty-SgK (Ty-ElK (subTmAtK (snd (var (vs (vs (vs (vs (vs (vs vz))))))))
                               (var (vs (vs (vs vz))))
                               (var (vs (vs vz)))
...
⊢ipayTyKap : {Γ : Ctx} →
             Γ ⊢ ipayTyKap
               ∷ imethTy KnotD IPair tagICon-kap cICon-kap ipayTyMotK
⊢ipayTyKap =
