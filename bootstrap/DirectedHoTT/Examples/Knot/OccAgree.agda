...
agree-ty x (Π y0 y1) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagTy-Pi)
    (aih-ρ (b2n (occTy x y0))
       ...
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » agree-ty (vs x) y1 _)
       (aih-κ aih-ι))))
...
agree-ty x (Hom y0 y1 y2) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagTy-Hom)
    (aih-ρ (b2n (occTy x y0))
       ...
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » agree-tm x y1 _)
       (aih-ρ (b2n (occTm x y2))
       (⟶*-appˡ ((chainOf (evProj 3 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 3 _)))) » agree-tm x y2 _)
       (aih-κ aih-ι)))))
agree-ty x Unit i =
...
agree-tm x (ordtr y0 y1 y2 y3 y4) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagTm-ordtr)
    (aih-ρ (b2n (occTm x y0))
       ...
       (⟶*-appˡ ((chainOf (evProj 4 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 4 _)))) » agree-tm x y3 _)
       (aih-ρ (b2n (occTm x y4))
       (⟶*-appˡ ((chainOf (evProj 5 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 5 _)))) » agree-tm x y4 _)
       (aih-κ aih-ι)))))))
agree-tm x (fst y0) i =
...
agree-tm x (⌜Π⌝ y0 y1) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagTm-cPi)
    (aih-ρ (b2n (occTm x y0))
       ...
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » agree-tm (vs x) y1 _)
       (aih-κ aih-ι))))
...
agree-tm x (natrec y0 y1 y2) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagTm-natrec)
    (aih-ρ (b2n (occTm x y0))
       ...
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » agree-tm (vs (vs x)) y1 _)
       (aih-ρ (b2n (occTm x y2))
       (⟶*-appˡ ((chainOf (evProj 3 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 3 _)))) » agree-tm x y2 _)
       (aih-κ aih-ι)))))
...
zero-desc x (c ◃ d) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagDesc-cons)
    (aih-ρ zero
       ...
       (aih-ρ zero
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » zero-desc x d _)
       (aih-κ aih-ι)))
zero-dcon x dι i =
...
zero-dcon x (dκ y0 y1) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagDCon-kap)
    (aih-ρ zero ok
       (aih-ρ zero
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » zero-dcon x y1 _)
       (aih-κ aih-ι)))
zero-idesc x inil i =
...
zero-idesc x (c ◂ e) i =
  ...
  occSum-red true (num (lvl x)) (ilookupD KnotD tagIDesc-cons)
    (aih-ρ zero ok
       (aih-ρ zero
       (⟶*-appˡ ((chainOf (evProj 2 _)) »
              ⟶*-ielimᵗ ((chainOf (evProj 2 _)))) » zero-idesc x e _)
       (aih-κ aih-ι)))
