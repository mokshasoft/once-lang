...
-- RedD  (0 rules the generator could not translate)
_ : ilen RedD ≡ rules _⟶_
_ = refl
...
-- JudgeD  (0 rules the generator could not translate)
_ : ilen JudgeD ≡ rules _⊢ty_ + rules _⊢_∷_ + rules DConWf + rules DescWf + rules IConWf + rules ICodeWf + rules IDescWfFrom
_ = refl
