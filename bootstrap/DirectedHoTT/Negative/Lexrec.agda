...
{-# OPTIONS --safe #-}
module DirectedHoTT.Negative.Lexrec where
...
open import DirectedHoTT.Negative.LexrecT public
open import DirectedHoTT.Negative.LexrecZZ using ( module ZZ )
open import DirectedHoTT.Negative.LexrecZS using ( module ZS )
open import DirectedHoTT.Negative.LexrecSZ using ( module SZ )
open import DirectedHoTT.Negative.LexrecSS using ( module SS )
