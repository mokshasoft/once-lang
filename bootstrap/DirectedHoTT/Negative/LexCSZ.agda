...
{-# OPTIONS --safe #-}
module DirectedHoTT.Negative.LexCSZ where
...
open import DirectedHoTT.Negative.LexCSZ1 using ( module SZ1 )
open import DirectedHoTT.Negative.LexCSZ2 using ( module SZ2 )
