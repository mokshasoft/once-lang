...
{-# OPTIONS --safe #-}
module DirectedHoTT.Negative.LexPair where
...
open import DirectedHoTT.Lib.Pair
...
open import DirectedHoTT.Negative.PairLex using ( ⊢rec1Tat; ⊢rec2Tat )
-- ★ ONE import: the façade re-exports the type layer.
open import DirectedHoTT.Negative.Lexrec using ( rec1T; rec2Tat; lStepT; module LxΠ )
