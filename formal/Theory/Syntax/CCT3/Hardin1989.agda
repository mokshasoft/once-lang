------------------------------------------------------------------------
-- Theory.Syntax.CCT3.Hardin1989
--
-- Hardin 1989 strong CCL at the CCT3 level: Curien combinators +
-- exponentials + coproducts + initial algebras (μ-types), with the
-- full rule set that gives CCC+BCC+μ-equational adequacy.
--
-- CCT3 adds 3 rules on top of the 19 CCT2 rules:
...
module Theory.Syntax.CCT3.Hardin1989 where
