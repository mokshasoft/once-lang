...
--
-- The rules are parameterized ONCE in Theory.Syntax.StrongCCL.BaseRules.CCTB
...
module Theory.Syntax.StrongCCL.CCTB where
...
import Theory.Syntax.StrongCCL.BaseRules.CCTB as B
