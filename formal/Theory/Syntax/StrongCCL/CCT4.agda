------------------------------------------------------------------------
-- Theory.Syntax.StrongCCL.CCT4
--
-- Full BCCR — BCC + μ + ν (CCT4) — completing the categorical-
-- combinator lineage up the tower:
--   - term algebra + CCTB/CCT1 from Hardin 1989
--   - CCT2 coproducts from Seely 1984
--   - CCT3 μ-types from Mendler 1987
--   - CCT4 ν-types from Abel 2012,
--     "Type-based termination, inflationary fixed-points,
--      and mixed inductive-coinductive types"
--
-- The Abel2012 layer contributes 3 CCT4 rules:
...
module Theory.Syntax.StrongCCL.CCT4 where
...
import Theory.Syntax.StrongCCL.BaseRules.CCT4 as CCT4-B
