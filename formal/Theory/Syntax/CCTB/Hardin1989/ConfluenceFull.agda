...
module Theory.Syntax.CCTB.Hardin1989.ConfluenceFull where

open import Data.Product
  using (Σ; _,_) renaming (_×_ to _∧_)

open import Theory.Syntax.CCTB.Hardin1989
open import Theory.Syntax.CCTB.Hardin1989.SN              using (sn)
open import Theory.Syntax.CCTB.Hardin1989.LocalConfluence using (local-confluent;
                                                       ⟶full*-trans; single)
