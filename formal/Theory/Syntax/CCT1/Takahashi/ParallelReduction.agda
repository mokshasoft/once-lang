------------------------------------------------------------------------
-- Theory.Syntax.CCT1.Takahashi.ParallelReduction
--
...
-- the chain (Theory.Syntax.CCT1.Takahashi.Diamond).
------------------------------------------------------------------------

module Theory.Syntax.CCT1.Takahashi.ParallelReduction where

open import Theory.Syntax.CCT1.Takahashi
