------------------------------------------------------------------------
-- Theory.Syntax.Bootstrap.CCT3
--
-- Takahashi-parallel CCL at the CCT3 level: adds initial algebras.
--
-- Extends CCT2/Takahashi with:
--   cata rules: out-in, in-out, cata-β
--
-- Adequacy: 22 laws total (9 CCTB + 4 CCT1 + 6 CCT2 + 3 CCT3).
-- Same NO_POSITIVITY_CHECK caveat as Hardin1989/CCT3 for μ.
------------------------------------------------------------------------

{-# OPTIONS --no-positivity-check #-}

module Theory.Syntax.Bootstrap.CCT3 where
