------------------------------------------------------------------------
-- Theory.Syntax.Bootstrap.CCT2.ParallelReduction
--
-- Parallel reduction on Takahashi's CCT2 syntax, plus bridges.
-- Extends CCTB's pattern with case / curry / initial constructors.
------------------------------------------------------------------------

module Theory.Syntax.Bootstrap.CCT2.ParallelReduction where

open import Theory.Syntax.Bootstrap.CCT2
