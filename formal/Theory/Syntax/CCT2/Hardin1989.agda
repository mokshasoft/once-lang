------------------------------------------------------------------------
-- Theory.Syntax.CCT2.Hardin1989
--
-- Hardin 1989 strong CCL at the CCT2 level: Curien combinators +
-- exponentials + coproducts, with the full rule set that makes the
-- rewrite system CCC+BCC-equationally complete.
--
-- CCT2 adds 6 rules on top of the 13 CCT1 rules:
--   β:  case-inl, case-inr, eta-case
--   s:  eta-case-gen, case-dist, initial-unique
--
-- The rules are parameterized ONCE in Theory.Syntax.CCT2.BaseRules
...
module Theory.Syntax.CCT2.Hardin1989 where
