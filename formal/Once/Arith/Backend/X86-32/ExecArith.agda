...
writes (Xfadd-rr dst src2)             = arith-reg dst ∷ []
writes (Xfsub-rr dst src2)             = arith-reg dst ∷ []
writes (Xfmul-rr dst src2)             = arith-reg dst ∷ []
writes (Xfdiv-rrr dst _ _)             = arith-reg dst ∷ []
writes (Xfsubr-rr dst src2)             = arith-reg dst ∷ []
writes (Xfneg-r dst)             = arith-reg dst ∷ []
writes (Xi2f-r dst src2)             = arith-reg dst ∷ []
writes (Xmov-fimm dst src2)             = arith-reg dst ∷ []
writes (Xmov-farg dst src2)             = arith-reg dst ∷ []
