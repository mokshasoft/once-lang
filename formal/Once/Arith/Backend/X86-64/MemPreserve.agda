...
--
-- x86-64 memory CCC-preservation: only the per-arch base — that a one-address
-- `writeMem` leaves other addresses alone — over the real x86-64 `Memory`. The
...
open import Once.CCC.Target.X86-64.Semantics using (Memory; readMem; writeMem)
