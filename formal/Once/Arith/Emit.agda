...
module Once.Arith.Target.Emit where

open import Data.String using (String)

-- Import backend modules
import Once.Arith.Target.X86.Emit as X86
import Once.Arith.Target.X86.Syntax as X86S
import Once.Arith.Target.AArch64.Emit as AArch64
import Once.Arith.Target.AArch64.Syntax as AArch64S
import Once.Arith.Target.RiscV.Emit as RiscV
import Once.Arith.Target.RiscV.Syntax as RiscVS
