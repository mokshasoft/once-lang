------------------------------------------------------------------------
-- Once.Arith.Target.AArch64.Correct
--
...
module Once.Arith.Target.AArch64.Correct where

open import Once.Arith.Type
open import Once.Arith.IR
open import Once.Arith.Semantics
open import Once.Arith.Target.AArch64.Syntax
...
open import Once.Arith.Target.AArch64.CodeGen using (compile-arith; compile-lit-int-char)
