...
module Once.Arith.Target.X86.Correct where
...
-- Matches the 10 GPRegs in Once.Arith.Target.X86.Syntax
...
open import Once.Arith.Target.X86.CodeGen using (compile-arith; initAlloc; compile-lit-int-char)
