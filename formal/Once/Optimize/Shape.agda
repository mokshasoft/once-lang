...
open import Once.Optimize using (optimize-pair; optimize-case; _≟IR_)
...
-- f = curry
optimize-pair-shape (curry _) g = ops-pair _ g
...
optimize-pair-shape fst (curry _) = ops-pair fst _
...
optimize-pair-shape (fst ∘ _) (curry _) = ops-pair _ _
...
-- f = curry
optimize-case-shape (curry _) g = ocs-case _ g
...
optimize-case-shape (_ ∘ (inl _)) (curry _) = ocs-case _ _
...
optimize-case-shape (_ ∘ (inl _)) (_ ∘ (curry _)) = ocs-case _ _
...
optimize-case-shape (_ ∘ (curry _)) g = ocs-case _ g
