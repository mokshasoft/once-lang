...
open import Once.Spec.Module using (EffUU; AllFunsTyped; tnil; tcons; ModuleTyped; ModuleTyped-ef; MainExists; AllMainEffUU; HasValidMain-decl; ModuleMainEffUU-ef; ModuleMainExists-ef)
