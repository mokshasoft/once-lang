...
open import Once.CCC.Memory.Regions x86-layout public
  hiding (Addr)

-- Stack slots (slot-addr, StackPointer, etc.)
-- Hide InStack since it's already exported from Regions
open import Once.CCC.Memory.StackSlots x86-layout x86-stack-growth public
  hiding (InStack)

-- Frame operations (frameSlot, memory preservation)
open import Once.CCC.Memory.FrameOps x86-layout x86-stack-growth public

-- Allocator semantics (encode-in-heap, heap-offset)
open import Once.CCC.Memory.AllocatorSemantics x86-layout public
