...
module Once.CCC.Target.RiscV64.Postulates where
...
open import Once.Target.RiscV64.Syntax using (a0; sp; Program; Reg)
open import Once.Target.RiscV64.Semantics using (State; readReg; RegFile)
open import Once.Target.RiscV64.Semantics using () renaming (module State to St)
open St using (regs; halted; pc)
open import Once.CCC.Target.RiscV64.CodeGen using (compile-riscv; StackDepth)
open import Once.CCC.Target.RiscV64.Correct.StarBase using (IRStarResult)

-- Reference the common apply postulate pattern documentation
-- (See Once.CCC.ApplyPostulate for detailed documentation)
postulate
...
------------------------------------------------------------------------
--
-- GENERALIZED (Priority 2): Follows Once.CCC.ApplyPostulate pattern
--
...
--
-- NEEDED BY: Once.CCC.Target.RiscV64.Correct.MutualIR (run-ir-star-at-offset for apply)
--
...
--
-- See Once.CCC.ApplyPostulate for full documentation including:
...
--
-- Stack analysis is now in Once.CCC.StackAnalysis, shared
