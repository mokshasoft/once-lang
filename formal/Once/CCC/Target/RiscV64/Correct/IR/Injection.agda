------------------------------------------------------------------------
-- Once.CCC.Target.RiscV64.Correct.IR.Injection
--
...
module Once.CCC.Target.RiscV64.Correct.IR.Injection where
...
open State
open import Once.CCC.Target.RiscV64.CodeGen using (compile-riscv; neg16)
