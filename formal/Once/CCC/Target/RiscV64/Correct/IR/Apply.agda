------------------------------------------------------------------------
-- Once.CCC.Target.RiscV64.Correct.IR.Apply
--
...
module Once.CCC.Target.RiscV64.Correct.IR.Apply where
...
open State
open import Once.Target.RiscV64.Semantics using (effectiveAddr)
open import Once.CCC.Target.RiscV64.CodeGen using (compile-riscv; compile-length)
...
open import Once.CCC.Target.RiscV64.Correct.CompileLength hiding (length-++)
