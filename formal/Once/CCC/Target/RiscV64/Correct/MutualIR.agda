------------------------------------------------------------------------
-- Once.CCC.Target.RiscV64.Correct.MutualIR
--
...
module Once.CCC.Target.RiscV64.Correct.MutualIR where
...
open import Once.CCC.Target.RiscV64.Postulates
...
open import Once.CCC.Target.RiscV64.Correct.ClosureWellFormed
...
open import Once.CCC.Target.RiscV64.Correct.StarBase public
...
open import Once.CCC.Target.RiscV64.Correct.IR.Compose
  using (ComposeContext; make-compose-context;
         assemble-compose-result; transform-f-result; transform-g-result)
open import Once.CCC.Target.RiscV64.Correct.IR.Compose using (module ComposeContext)

-- Import extracted pair helpers
open import Once.CCC.Target.RiscV64.Correct.IR.Pair
...
open import Once.CCC.Target.RiscV64.Correct.IR.Case
...
open import Once.CCC.Target.RiscV64.Correct.IR.Curry using (run-curry-star)

-- Import thunk setup proof
open import Once.CCC.Target.RiscV64.Correct.IR.ThunkSetup using (thunk-setup-star-proven; thunk-cleanup-star-proven)

-- Import apply proof (proven when ClosureWellFormed is available)
open import Once.CCC.Target.RiscV64.Correct.IR.Apply
...
open import Once.CCC.Target.RiscV64.Correct.IR.Injection
  using (run-inl-star; run-inr-star)

-- Import extracted IR modules (following X86 pattern)
open import Once.CCC.Target.RiscV64.Correct.IR.Id
  using (run-id-star-s)
open import Once.CCC.Target.RiscV64.Correct.IR.Terminal
  using (run-terminal-star-s)
open import Once.CCC.Target.RiscV64.Correct.IR.Fold
  using (run-fold-star-s)
open import Once.CCC.Target.RiscV64.Correct.IR.Unfold
  using (run-unfold-star-s)
open import Once.CCC.Target.RiscV64.Correct.IR.Arr
...
------------------------------------------------------------------------
-- Apply and stack bound postulates now in Once.CCC.Target.RiscV64.Postulates
