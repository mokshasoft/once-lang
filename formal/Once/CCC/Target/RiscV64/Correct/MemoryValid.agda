{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.RiscV64.Correct.MemoryValid
--
...
module Once.CCC.Target.RiscV64.Correct.MemoryValid where

open import Once.Type
open import Once.Semantics using (⟦_⟧; encode)
open import Once.Target.RiscV64.Semantics using (State; Memory; Word; readMem; writeMem)
open import Once.Target.RiscV64.Encoding using (mem-read-write; mem-read-other; n≢n+8)
