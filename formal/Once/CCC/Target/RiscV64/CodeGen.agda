------------------------------------------------------------------------
-- Once.CCC.Target.RiscV64.CodeGen
--
...
module Once.CCC.Target.RiscV64.CodeGen where
...
open Once.Target.RiscV64.Syntax using (fstOffset; sndOffset; tagOffset; valueOffset)
...
open import Once.CCC.StackAnalysisS
...
-- Once.CCC.StackAnalysis (see import above)
