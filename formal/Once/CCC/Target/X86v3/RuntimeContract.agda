------------------------------------------------------------------------
-- Once.CCC.Target.X86v3.RuntimeContract
--
...
module Once.CCC.Target.X86v3.RuntimeContract where
...
open import Once.CCC.MemoryLayoutSemantics as MLS using (MemoryLayout; upper)
open import Once.CCC.SlotMachine using (ValueLocation; OnStack; OnHeap; HeapLocation; HeapRef)
...
module FrameRegion (layout : MemoryLayout) where
  open import Once.CCC.Regions layout public
