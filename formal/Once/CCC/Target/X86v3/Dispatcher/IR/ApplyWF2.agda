------------------------------------------------------------------------
-- Once.CCC.Target.X86v3.IR.ApplyWF2
--
...
module Once.CCC.Target.X86v3.Dispatcher.IR.ApplyWF2 where
...
module BFTransfer2 {FS : FrameSemantics} where
...
module ApplyWF2Impl {FS : FrameSemantics} (program-bound : ℕ) (primSem : PrimSem)
