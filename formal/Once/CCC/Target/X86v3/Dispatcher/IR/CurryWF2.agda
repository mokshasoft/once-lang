------------------------------------------------------------------------
-- Once.CCC.Target.X86v3.IR.CurryWF2
--
...
module Once.CCC.Target.X86v3.Dispatcher.IR.CurryWF2 where
...
module CurryWF2Impl {FS : FrameSemantics} (program-bound : ℕ) (primSem : PrimSem) where
