------------------------------------------------------------------------
-- Once.CCC.Target.X86.LayoutInstantiation
--
...
module Once.CCC.Target.X86.LayoutInstantiation where
...
open import Once.CCC.Target.X86.Layout using (RegionBounds; Addr; lower; upper)
open import Once.CCC.Target.X86.Layout as Layout
