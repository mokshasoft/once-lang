------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.ClosureWellFormed
--
...
module Once.CCC.Target.X86.Correct.ClosureWellFormed where
...
open import Once.CCC.Target.X86.Correct.StackInstantiation using (slots; StackCapacity; ir-output-capacity; thunk-setup-capacity)
