------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.MutualIR.Compose
--
...
module Once.CCC.Target.X86.Correct.MutualIR.Compose
  (bound : ℕ)
...
open import Once.CCC.Target.X86.Correct.IR.Compose
  using (ComposeContext; make-compose-context; TransferResultV;
         compose-transfer-star-v; assemble-compose-result-v)
open import Once.CCC.Target.X86.Correct.IR.Compose using (module ComposeContext)
open import Once.CCC.Target.X86.Correct.IR.Compose using (module TransferResultV)
