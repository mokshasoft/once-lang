------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.ClosureContext
--
...
module Once.CCC.Target.X86.Correct.ClosureContext where
...
open import Once.CCC.Target.X86.Correct.StackInstantiation using (slots; pair-alloc; StackCapacity; apply-capacity; apply-consumed-slots)
...
open import Once.CCC.Target.X86.Correct.IR.Apply as ApplyProof
