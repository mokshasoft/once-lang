...
open import Once.CCC.Target.X86.Correct.ExecLemmas using (fetch-at-prefix-end)
open import Once.CCC.Target.X86.Correct.Arithmetic using (∸-preserves-<; <⇒≢; ∸+<-lemma)
