------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.IR.ThunkStructure
--
...
module Once.CCC.Target.X86.Correct.IR.ThunkStructure where

-- Import consolidated Foundation module
open import Once.CCC.Target.X86.Correct.Foundation

-- Additional imports not in Foundation
open import Once.CCC.Target.X86.Correct.CompileLength using (compile-length-correct)
open import Once.CCC.Target.X86.Correct.ExecLemmas using (fetch-at-prefix-end)
open import Once.CCC.Target.X86.Correct.StackInstantiation using (slots; pair-alloc)
open import Once.CCC.Target.X86.Correct.Arithmetic using (from-yes-<)
