...
open import Once.CCC.Target.X86.Correct.Arithmetic using (word-plus-one-fits-pair; >-implies-positive)
...
thunk-setup-star {A} {B} {C} f prefix suffix env arg s
  ...
  where
    ...
    open import Once.Target.X86.Encoding using (mem-read-write; mem-read-other; n≢n+word-size)
