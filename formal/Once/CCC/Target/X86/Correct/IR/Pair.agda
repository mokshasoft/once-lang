------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.IR.Pair
--
...
module Once.CCC.Target.X86.Correct.IR.Pair where
...
open import Once.CCC.Target.X86.Correct.Foundation hiding (n≢n+word-size; n+word-size≢n)

-- Additional imports not in Foundation
open import Once.Postulates using (encode-pair-construct)
open import Once.Target.X86.Encoding using (mem-read-write; mem-read-other; n≢n+word-size; n≢n+suc-m)
open import Once.CCC.Target.X86.Correct.CompileLength hiding (length-++)
open import Once.CCC.Target.X86.Correct.Arithmetic using (m∸n+k≡m∸n-k; m∸n+k≡m∸n-k'; <⇒≢)
open import Once.CCC.Target.X86.Correct.ArithmeticLemmas using (word-fits-frame-strict; pair-fits-frame-strict; regs-fits-frame-strict; word-fits-regs; pair-fits-regs; regs-fits-frame)
...
open import Once.CCC.Target.X86.Correct.SeqExec using (frame-setup-star; FrameSetupResult; pair-middle-star-at; PairMiddleStarResult)
...
open import Once.CCC.Target.X86.Layout using (InHeap; InCode)
