------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.InitState
--
...
module Once.CCC.Target.X86.Correct.InitState where
...
open import Once.CCC.Target.X86.Layout using () renaming (addr to sp-addr; haddr to hp-addr)
