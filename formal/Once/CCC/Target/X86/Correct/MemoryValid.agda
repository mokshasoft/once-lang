------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.MemoryValid
--
...
module Once.CCC.Target.X86.Correct.MemoryValid where

open import Once.Type
open import Once.Semantics using (⟦_⟧; encode; Closure; ⟦Fix⟧; wrap)
open ⟦Fix⟧
open import Once.Target.X86.Semantics using (State; Memory; Word; readMem; writeMem)
open import Once.Target.X86.Encoding using (mem-read-write; mem-read-other; n≢n+word-size)
open import Once.CCC.Target.X86.Correct.StackInstantiation using (slot-size)
...
open import Once.CCC.Target.X86.Correct.Star using (just-injective)
