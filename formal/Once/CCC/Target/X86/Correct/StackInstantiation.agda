------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.StackInstantiation
--
...
module Once.CCC.Target.X86.Correct.StackInstantiation where
...
open import Once.Target.X86.Syntax public using (slot-size; slots)
open import Once.Target.X86.Syntax hiding (slot-size; slots)
...
open import Once.CCC.Target.X86.Correct.StackInvariant public
...
open import Once.CCC.Target.X86.Layout using () renaming (addr to sp-addr; in-stack to sp-in-stack)
...
open import Once.CCC.Target.X86.Correct.Arithmetic public
...
-- slot-size and slots are imported from Once.Target.X86.Syntax
-- Computed slot consumption values are imported from Once.CCC.Target.X86.CodeGen:
...
-- imported from Once.CCC.Target.X86.CodeGen:
