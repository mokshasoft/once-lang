------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.MutualIR
--
...
module Once.CCC.Target.X86.Correct.MutualIR where
...
open Once.Target.X86.Semantics.Flags
...
open import Once.CCC.ProgramLemmas
...
open import Once.CCC.Target.X86.Layout using (module FrameSlotInternal)
...
open import Once.CCC.Target.X86.Correct.RegisterLemmas
open import Once.CCC.Target.X86.Correct.FetchStep
open import Once.CCC.Target.X86.Correct.CompileLength hiding (length-++)
open import Once.CCC.Target.X86.Correct.InstrExec
open import Once.CCC.Target.X86.Correct.InitState
open import Once.CCC.Target.X86.Correct.StackInstantiation
open import Once.CCC.Target.X86.Correct.ExecLemmas
open import Once.CCC.Target.X86.Correct.SeqExec
open import Once.CCC.Target.X86.Correct.ArithmeticLemmas using (word-fits-thunk-bound; word-fits-pair-strict)
...
open import Once.CCC.Target.X86.Correct.MemoryValid
...
open import Once.CCC.Target.X86.Correct.StarBase public
...
open import Once.CCC.Target.X86.Correct.ClosureWellFormed
...
open import Once.CCC.Target.X86.Correct.IR.ThunkStructure
...
open import Once.CCC.Target.X86.Correct.IR.ThunkExec
  using (thunk-setup-star; thunk-ret-star; ThunkSetupResult; ThunkRetResult)
import Once.CCC.Target.X86.Correct.IR.ThunkExec as TE
open ThunkRetResult

-- Import apply proof (uses ClosureWellFormed)
open import Once.CCC.Target.X86.Correct.IR.Apply
...
import Once.CCC.Target.X86.Correct.MutualIR.Compose as ComposeModule
import Once.CCC.Target.X86.Correct.MutualIR.Pair as PairModule
import Once.CCC.Target.X86.Correct.MutualIR.Case as CaseModule

-- Import well-founded recursion and IR size measure
open import Induction.WellFounded using (Acc; acc)
open import Data.Nat.Induction using (<-wellFounded)
open import Once.CCC.Target.X86.Correct.IRSize
...
open import Once.CCC.Target.X86.Correct.MutualIR.Dispatcher
