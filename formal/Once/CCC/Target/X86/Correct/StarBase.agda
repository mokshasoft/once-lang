------------------------------------------------------------------------
-- Once.CCC.Target.X86.Correct.StarBase
--
...
module Once.CCC.Target.X86.Correct.StarBase where
...
open import Once.CCC.Target.X86.Correct.StackInvariant using (StackInvariant; r15-in-heap; r15-in-code; RbpInvariant; stack-inv-preserved-unchanged)
open import Once.CCC.Target.X86.Layout using (InStack; InHeap; InCode; stack-code-disjoint)
...
open import Once.CCC.Target.X86.Correct.ClosureWellFormed using (ClosureWellFormed)
