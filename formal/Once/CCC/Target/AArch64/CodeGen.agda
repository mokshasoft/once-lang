{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.CodeGen
--
...
module Once.CCC.Target.AArch64.CodeGen where

open import Once.Type
open import Once.IR

open import Once.Target.AArch64.Syntax
open Once.Target.AArch64.Syntax using (fstOffset; sndOffset; tagOffset; valueOffset)
