------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.Star
--
...
--
-- Ported from Once.CCC.Target.X86.Correct.Star
------------------------------------------------------------------------

module Once.CCC.Target.AArch64.Correct.Star where
...
open import Once.CCC.Star Program State halted step public
