{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.ClosureWellFormed
--
...
module Once.CCC.Target.AArch64.Correct.ClosureWellFormed where
...
open State
open import Once.Target.AArch64.Semantics using (writeReg)
