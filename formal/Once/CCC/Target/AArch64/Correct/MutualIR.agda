...
open import Once.CCC.Memory using (readMem-writeMem-diff)
open import Once.CCC.Target.AArch64.Correct.FetchStep
...
open import Once.CCC.Target.AArch64.Correct.IR.ThunkSetup
  using (thunk-setup-star)

-- Re-export StarBase for backwards compatibility
open import Once.CCC.Target.AArch64.Correct.StarBase public
...
open import Once.CCC.Target.AArch64.Correct.IR.StatefulProducers public
  using (run-inl-star-s; run-inr-star-s)

-- Import stateful consumers (extracted to reduce compile time)
open import Once.CCC.Target.AArch64.Correct.IR.StatefulConsumers public
...
open import Once.CCC.Target.AArch64.Correct.IR.StatefulCompose public
  using (run-compose-star-s)

-- Import ClosureContext for closure entry tracking
open import Once.CCC.Target.AArch64.Correct.ClosureContext
  using (ClosureEntry; make-entry)
open import Once.CCC.Target.AArch64.Correct.ClosureWellFormed
  using (ClosureWellFormed)

-- Import extracted IR helper modules (non-recursive parts)
open import Once.CCC.Target.AArch64.Correct.IR.Compose
...
open import Once.CCC.Target.AArch64.Correct.IR.Pair
...
open import Once.CCC.Target.AArch64.Correct.IR.Case
...
open import Once.CCC.Target.AArch64.Correct.IR.Curry
...
open import Once.CCC.Target.AArch64.Correct.IR.Apply
