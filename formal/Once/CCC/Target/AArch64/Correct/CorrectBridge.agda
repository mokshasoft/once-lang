{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.CorrectBridge
--
...
module Once.CCC.Target.AArch64.Correct.CorrectBridge where
...
open import Once.CCC.Target.AArch64.Correct.MutualIR
  using (run-ir-star-at-offset; IRResultFor-to-IRStarResult)

open import Once.CCC.Fetch using (fetch-past-end)
...
open Once.CCC.Target.AArch64.Correct.Foundation public
  using (initWithInput; initWithInput-x0; initWithInput-halted; initWithInput-pc;
         encode)

open Once.CCC.Target.AArch64.Correct.Star public
  using (Star)
