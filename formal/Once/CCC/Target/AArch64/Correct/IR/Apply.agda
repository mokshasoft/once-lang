{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.IR.Apply
--
...
module Once.CCC.Target.AArch64.Correct.IR.Apply where
...
open import Once.CCC.Target.AArch64.Correct.Foundation using (encode; encodedMemory)
...
-- Once.CCC.Target.AArch64.Postulates. It provides a Star-based proof
-- with complete register and memory preservation guarantees.
--
-- For apply proofs, import from Postulates:
--   open import Once.CCC.Target.AArch64.Postulates using (apply-produces-result)
--
