------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.IR.ThunkSetup
--
...
module Once.CCC.Target.AArch64.Correct.IR.ThunkSetup where
...
open import Once.CCC.Target.AArch64.Correct.FetchStep using (step-exec-at-offset)
