{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.MemoryValid
--
...
module Once.CCC.Target.AArch64.Correct.MemoryValid where

open import Once.Type
open import Once.Semantics using (⟦_⟧; encode)
open import Once.Target.AArch64.Semantics using (State; Memory; Word; readMem; writeMem)
