{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.CCC.Target.AArch64.Correct.Foundation
--
...
module Once.CCC.Target.AArch64.Correct.Foundation where
...
open Once.Target.AArch64.Semantics.PSTATE
...
-- n≡ᵇn is now imported from Once.CCC.Memory (renamed from ≡ᵇ-refl)
...
-- Memory lemmas now imported from Once.CCC.Memory:
...
-- are now imported from Once.CCC.Fetch.
