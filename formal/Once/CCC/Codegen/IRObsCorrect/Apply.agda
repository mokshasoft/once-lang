...
module ApplyC {FS : FrameSemantics} where
  ...
  obs-correct-apply n l prog base _ cr span mIn x s alloc cl n≤ nh (in-reg () _) k
  obs-correct-apply n l prog base _ cr span mIn x s alloc cl n≤ nh (in-unit ()) k
  obs-correct-apply {A} {B} n l prog base _ cr span mIn x s alloc cl n≤ nh
