{-# OPTIONS --sized-types #-}
------------------------------------------------------------------------
-- Once.Backend.AArch64.Correct.ClosureContext
--
...
module Once.Backend.AArch64.Correct.ClosureContext where
...
open import Once.Backend.AArch64.Correct.IR.Apply as ApplyProof
