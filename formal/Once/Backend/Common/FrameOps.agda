...
module Once.Backend.Common.FrameOps
  (layout : MemoryLayout)
  (sg : StackGrowth)
  where
...
-- Import from Regions
open import Once.Backend.Common.Regions layout
  using (InStack; InHeap; InCode;
         stack-heap-addr-disjoint; stack-code-addr-disjoint)

-- Import from StackSlots
open import Once.Backend.Common.StackSlots layout sg
