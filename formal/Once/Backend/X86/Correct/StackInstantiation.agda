...
-- Curry: closure setup (2) + apply overhead (2) + thunk setup (4) + inner requirement
ir-stack-requirement (curry f) = 2 +ℕ (2 +ℕ (4 +ℕ ir-stack-requirement f))
...
--        ir-stack-requirement (curry f) = 2 + (2 + (4 + ir-stack-requirement f)) = 8 + ir-stack-requirement f ≥ 8 ≥ 4
