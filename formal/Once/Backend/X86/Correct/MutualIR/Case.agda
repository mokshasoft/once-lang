...
open import Once.Backend.X86.Correct.StackInstantiation
  using (slots; slot-size; StackCapacity; ir-stack-requirement; ir-output-capacity;
         ...
         rsp-sufficient)
open import Once.Backend.Common.MemoryRegionLemmas using (InStack; InHeap; InCode; heap-offset)
  ...
  where
    ...
    rbp-inv-final = record
      ...
      where
        ...
        open import Once.Backend.Common.MemoryRegionLemmas using (StackPointer) renaming (addr to sp-addr)
