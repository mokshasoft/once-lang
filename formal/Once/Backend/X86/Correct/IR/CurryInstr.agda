------------------------------------------------------------------------
-- Once.Backend.X86.Correct.IR.CurryInstr
--
-- Curry instruction-tracing: run-curry-star, run-curry-star-v.
-- Extracted from Curry.agda to reduce compilation time.
------------------------------------------------------------------------

module Once.Backend.X86.Correct.IR.CurryInstr where
