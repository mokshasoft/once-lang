...
--
-- Mutual recursive proofs for IR code generation correctness.
--
-- This module contains the expensive mutual block and its helpers,
-- isolated for better incremental compilation. Changes to other
-- parts of the correctness proofs won't trigger recompilation of
-- this module.
--
...
--
-- Level 3 - depends on StackInvariant, ExecLemmas, RegisterLemmas
------------------------------------------------------------------------
