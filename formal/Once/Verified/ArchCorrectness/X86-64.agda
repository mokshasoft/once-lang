...
------------------------------------------------------------------------
-- Once.Verified.ArchCorrectness.X86-64 — x86-64's backend-correctness
...
module Once.Verified.ArchCorrectness.X86-64 where

open import Data.Nat using (ℕ)
open import Once.CCC.IR using (IR)
open import Once.Verified.CPU using (x86-64; arch-semantics)
