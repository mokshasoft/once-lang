...
atomExprVarWF name eq []                = just (RVar name , [] , pae-var eq)
atomExprVarWF name eq (TWord _    ∷ r)  = just (RVar name , TWord _    ∷ r , pae-var eq)
atomExprVarWF name eq (TInt _     ∷ r)  = just (RVar name , TInt _     ∷ r , pae-var eq)
atomExprVarWF name eq (TString _  ∷ r)  = just (RVar name , TString _  ∷ r , pae-var eq)
atomExprVarWF name eq (TLParen    ∷ r)  = just (RVar name , TLParen    ∷ r , pae-var eq)
atomExprVarWF name eq (TRParen    ∷ r)  = just (RVar name , TRParen    ∷ r , pae-var eq)
atomExprVarWF name eq (TLBrace    ∷ r)  = just (RVar name , TLBrace    ∷ r , pae-var eq)
atomExprVarWF name eq (TRBrace    ∷ r)  = just (RVar name , TRBrace    ∷ r , pae-var eq)
atomExprVarWF name eq (TColon     ∷ r)  = just (RVar name , TColon     ∷ r , pae-var eq)
atomExprVarWF name eq (TEquals    ∷ r)  = just (RVar name , TEquals    ∷ r , pae-var eq)
atomExprVarWF name eq (TArrow     ∷ r)  = just (RVar name , TArrow     ∷ r , pae-var eq)
atomExprVarWF name eq (TCaret1    ∷ r)  = just (RVar name , TCaret1    ∷ r , pae-var eq)
atomExprVarWF name eq (TCaret0    ∷ r)  = just (RVar name , TCaret0    ∷ r , pae-var eq)
atomExprVarWF name eq (TCaretW    ∷ r)  = just (RVar name , TCaretW    ∷ r , pae-var eq)
atomExprVarWF name eq (TLambda    ∷ r)  = just (RVar name , TLambda    ∷ r , pae-var eq)
atomExprVarWF name eq (TComma     ∷ r)  = just (RVar name , TComma     ∷ r , pae-var eq)
atomExprVarWF name eq (TSemicolon ∷ r)  = just (RVar name , TSemicolon ∷ r , pae-var eq)
-- TAt without a following TWord: just a variable.
atomExprVarWF name eq (TAt        ∷ []) = just (RVar name , TAt ∷ [] , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TInt _     ∷ r) = just (RVar name , TAt ∷ TInt _     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TString _  ∷ r) = just (RVar name , TAt ∷ TString _  ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TLParen    ∷ r) = just (RVar name , TAt ∷ TLParen    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TRParen    ∷ r) = just (RVar name , TAt ∷ TRParen    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TLBrace    ∷ r) = just (RVar name , TAt ∷ TLBrace    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TRBrace    ∷ r) = just (RVar name , TAt ∷ TRBrace    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TColon     ∷ r) = just (RVar name , TAt ∷ TColon     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TEquals    ∷ r) = just (RVar name , TAt ∷ TEquals    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TArrow     ∷ r) = just (RVar name , TAt ∷ TArrow     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TCaret1    ∷ r) = just (RVar name , TAt ∷ TCaret1    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TCaret0    ∷ r) = just (RVar name , TAt ∷ TCaret0    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TCaretW    ∷ r) = just (RVar name , TAt ∷ TCaretW    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TLambda    ∷ r) = just (RVar name , TAt ∷ TLambda    ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TComma     ∷ r) = just (RVar name , TAt ∷ TComma     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TSemicolon ∷ r) = just (RVar name , TAt ∷ TSemicolon ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TAt        ∷ r) = just (RVar name , TAt ∷ TAt        ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TPipe      ∷ r) = just (RVar name , TAt ∷ TPipe      ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TDot       ∷ r) = just (RVar name , TAt ∷ TDot       ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TPlus      ∷ r) = just (RVar name , TAt ∷ TPlus      ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TMinus     ∷ r) = just (RVar name , TAt ∷ TMinus     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TStar      ∷ r) = just (RVar name , TAt ∷ TStar      ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TSlash     ∷ r) = just (RVar name , TAt ∷ TSlash     ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TPercent   ∷ r) = just (RVar name , TAt ∷ TPercent   ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TAmpersand ∷ r) = just (RVar name , TAt ∷ TAmpersand ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TLt        ∷ r) = just (RVar name , TAt ∷ TLt        ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TLe        ∷ r) = just (RVar name , TAt ∷ TLe        ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TGt        ∷ r) = just (RVar name , TAt ∷ TGt        ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TGe        ∷ r) = just (RVar name , TAt ∷ TGe        ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TEqEq      ∷ r) = just (RVar name , TAt ∷ TEqEq      ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TNeq       ∷ r) = just (RVar name , TAt ∷ TNeq       ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TNewline   ∷ r) = just (RVar name , TAt ∷ TNewline   ∷ r , pae-var eq)
atomExprVarWF name eq (TAt        ∷ TEOF       ∷ r) = just (RVar name , TAt ∷ TEOF       ∷ r , pae-var eq)
atomExprVarWF name eq (TPipe      ∷ r)  = just (RVar name , TPipe      ∷ r , pae-var eq)
atomExprVarWF name eq (TDot       ∷ r)  = just (RVar name , TDot       ∷ r , pae-var eq)
atomExprVarWF name eq (TPlus      ∷ r)  = just (RVar name , TPlus      ∷ r , pae-var eq)
atomExprVarWF name eq (TMinus     ∷ r)  = just (RVar name , TMinus     ∷ r , pae-var eq)
atomExprVarWF name eq (TStar      ∷ r)  = just (RVar name , TStar      ∷ r , pae-var eq)
atomExprVarWF name eq (TSlash     ∷ r)  = just (RVar name , TSlash     ∷ r , pae-var eq)
atomExprVarWF name eq (TPercent   ∷ r)  = just (RVar name , TPercent   ∷ r , pae-var eq)
atomExprVarWF name eq (TAmpersand ∷ r)  = just (RVar name , TAmpersand ∷ r , pae-var eq)
atomExprVarWF name eq (TLt        ∷ r)  = just (RVar name , TLt        ∷ r , pae-var eq)
atomExprVarWF name eq (TLe        ∷ r)  = just (RVar name , TLe        ∷ r , pae-var eq)
atomExprVarWF name eq (TGt        ∷ r)  = just (RVar name , TGt        ∷ r , pae-var eq)
atomExprVarWF name eq (TGe        ∷ r)  = just (RVar name , TGe        ∷ r , pae-var eq)
atomExprVarWF name eq (TEqEq      ∷ r)  = just (RVar name , TEqEq      ∷ r , pae-var eq)
atomExprVarWF name eq (TNeq       ∷ r)  = just (RVar name , TNeq       ∷ r , pae-var eq)
atomExprVarWF name eq (TNewline   ∷ r)  = just (RVar name , TNewline   ∷ r , pae-var eq)
atomExprVarWF name eq (TEOF       ∷ r)  = just (RVar name , TEOF       ∷ r , pae-var eq)
