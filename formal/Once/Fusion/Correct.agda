...
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ (inl m3) ∘ h , (inr m4) ∘ k ] (inj₁ a) = refl
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ (inl m3) ∘ h , (inr m4) ∘ k ] (inj₂ b) = refl
...
fusion-compose-correct [ (inl m1) ∘ f , inr m2 ] [ (inl m3) ∘ g , inr m4 ] (inj₁ a) = refl
fusion-compose-correct [ (inl m1) ∘ f , inr m2 ] [ (inl m3) ∘ g , inr m4 ] (inj₂ b) = refl
...
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ inl m3 , (inr m4) ∘ k ] (inj₁ a) = refl
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ inl m3 , (inr m4) ∘ k ] (inj₂ b) = refl
...
fusion-compose-correct [ inl m1 , (inr m2) ∘ h ] [ (inl m3) ∘ f , (inr m4) ∘ g ] (inj₁ a) = refl
fusion-compose-correct [ inl m1 , (inr m2) ∘ h ] [ (inl m3) ∘ f , (inr m4) ∘ g ] (inj₂ b) = refl
...
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ (inl m3) ∘ h , inr m4 ] (inj₁ a) = refl
fusion-compose-correct [ (inl m1) ∘ f , (inr m2) ∘ g ] [ (inl m3) ∘ h , inr m4 ] (inj₂ b) = refl
...
fusion-compose-correct [ (inl m1) ∘ f , inr m2 ] [ (inl m3) ∘ h , (inr m4) ∘ k ] (inj₁ a) = refl
fusion-compose-correct [ (inl m1) ∘ f , inr m2 ] [ (inl m3) ∘ h , (inr m4) ∘ k ] (inj₂ b) = refl
...
-- Second arg: case [ f' , g' ] where first component f' is NOT (inl _) or (inl _) ∘ _
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ id , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (id ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ ((_ ∘ _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (fst ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (snd ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ ((inr _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ ([ _ , _ ] ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (initial ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (apply ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (unfold ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ ((Prim _) ∘ _) , _ ] x = refl
...
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , id ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , fst ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , snd ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (inl _) ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (inr _) ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , [ _ , _ ] ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , initial ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , apply ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , unfold ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (Prim _) ] x = refl

-- Second arg: case [ (inl _) ∘ _ , h ∘ _ ] where h is NOT (inr _)
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , id ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (_ ∘ _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , fst ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , snd ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (inl _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , [ _ , _ ] ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , initial ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , apply ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , unfold ∘ _ ] x = refl
fusion-compose-correct [ (inl _) , (inr _) ∘ _ ] [ (inl _) ∘ _ , (Prim _) ∘ _ ] x = refl
...
------------------------------------------------------------------------
-- First arg is [ f' , g' ] where f' is NOT (inl _) or (inl _) ∘ _
-- Note: (inl _) ∘ _ forms are covered by fusion rules 2, 3, 4a, 5a, 5b
------------------------------------------------------------------------

fusion-compose-correct [ id , _ ] f x = refl
fusion-compose-correct [ (id ∘ _) , _ ] f x = refl
fusion-compose-correct [ ((_ ∘ _) ∘ _) , _ ] f x = refl
fusion-compose-correct [ (fst ∘ _) , _ ] f x = refl
fusion-compose-correct [ (snd ∘ _) , _ ] f x = refl
fusion-compose-correct [ ((⟨ _ , _ ⟩ _) ∘ _) , _ ] f x = refl
fusion-compose-correct [ ((inr _) ∘ _) , _ ] f x = refl
fusion-compose-correct [ ([ _ , _ ] ∘ _) , _ ] f x = refl
fusion-compose-correct [ (terminal ∘ _) , _ ] f x = refl
fusion-compose-correct [ (initial ∘ _) , _ ] f x = refl
fusion-compose-correct [ ((curry _ _) ∘ _) , _ ] f x = refl
fusion-compose-correct [ (apply ∘ _) , _ ] f x = refl
fusion-compose-correct [ (fold ∘ _) , _ ] f x = refl
fusion-compose-correct [ (unfold ∘ _) , _ ] f x = refl
fusion-compose-correct [ (arr ∘ _) , _ ] f x = refl
fusion-compose-correct [ ((Prim _) ∘ _) , _ ] f x = refl
...
fusion-compose-correct [ (inl _) ∘ _ , id ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , fst ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , snd ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inl _) ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , [ _ , _ ] ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , initial ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , apply ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , unfold ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , (Prim _) ] f x = refl

-- g' = h ∘ _ where h is NOT (inr _)
fusion-compose-correct [ (inl _) ∘ _ , id ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , (_ ∘ _) ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , fst ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , snd ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inl _) ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , [ _ , _ ] ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , initial ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , apply ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , unfold ∘ _ ] f x = refl
fusion-compose-correct [ (inl _) ∘ _ , (Prim _) ∘ _ ] f x = refl
...
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] id x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] (f ∘ f') x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] fst x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] snd x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] (inl _) x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] (inr _) x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] initial x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] apply x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] unfold x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] (Prim _) x = refl

-- Second arg: case where first branch is NOT (inl _) or (inl _) ∘ _
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ id , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (id ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ ((_ ∘ _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (fst ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (snd ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ ((inr _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ ([ _ , _ ] ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (initial ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (apply ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (unfold ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ ((Prim _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ fst , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ snd , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inr _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ [ _ , _ ] , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ initial , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ apply , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ unfold , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (Prim _) , _ ] x = refl

-- Second arg: case [ (inl _) , g' ] where g' is NOT (inr _) ∘ _
-- (Rule 4a covers [ (inl _) , (inr _) ∘ _ ])
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , id ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , fst ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , snd ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (inl _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (inr _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , [ _ , _ ] ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , initial ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , apply ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , unfold ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (Prim _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , id ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (_ ∘ _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , fst ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , snd ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (inl _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , [ _ , _ ] ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , initial ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , apply ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , unfold ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) , (Prim _) ∘ _ ] x = refl

-- Second arg: case [ (inl _) ∘ _ , g' ] where g' is NOT (inr _) ∘ _ or inr _
-- (Rule 2 covers [ (inl _) ∘ _ , (inr _) ∘ _ ], Rule 5a covers [ (inl _) ∘ _ , inr _ ])
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , id ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , fst ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , snd ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , (inl _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , [ _ , _ ] ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , initial ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , apply ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , unfold ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , (Prim _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , id ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , (_ ∘ _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , fst ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , snd ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , (inl _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , [ _ , _ ] ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , initial ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , apply ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , unfold ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , (inr _) ∘ _ ] [ (inl _) ∘ _ , (Prim _) ∘ _ ] x = refl
...
-- Second arg: non-case forms
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] id x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] (f ∘ f') x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] fst x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] snd x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] (inl _) x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] (inr _) x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] initial x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] apply x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] unfold x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] (Prim _) x = refl

-- Second arg: case where first branch is NOT (inl _) or (inl _) ∘ _
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ id , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (id ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ ((_ ∘ _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (fst ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (snd ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ ((inr _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ ([ _ , _ ] ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (initial ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (apply ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (unfold ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ ((Prim _) ∘ _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ fst , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ snd , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inr _) , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ [ _ , _ ] , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ initial , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ apply , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ unfold , _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (Prim _) , _ ] x = refl

-- Second arg: case [ (inl _) , g' ] where g' doesn't matter
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) , _ ] x = refl

-- Second arg: case [ (inl _) ∘ _ , g' ] where g' is NOT inr _ or (inr _) ∘ _
-- (Rule 3 covers [ (inl _) ∘ _ , inr _ ], Rule 5b covers [ (inl _) ∘ _ , (inr _) ∘ _ ])
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , id ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , fst ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , snd ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , (inl _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , [ _ , _ ] ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , initial ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , apply ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , unfold ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , (Prim _) ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , id ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , (_ ∘ _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , fst ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , snd ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , (inl _) ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , [ _ , _ ] ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , initial ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , apply ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , unfold ∘ _ ] x = refl
fusion-compose-correct [ (inl _) ∘ _ , inr _ ] [ (inl _) ∘ _ , (Prim _) ∘ _ ] x = refl
