...
optimize-pair-normal fst (curry _) nf ng = normal-pair nf ng λ ()
...
-- f = curry _ _
optimize-pair-normal (curry _) _ nf ng = normal-pair nf ng λ ()
...
optimize-pair-normal (fst ∘ _) (curry _) nf ng = normal-pair nf ng λ ()
...
-- f = curry _ _
optimize-case-normal (curry _) _ nf ng = normal-case nf ng λ ()
...
optimize-case-normal (_ ∘ (curry _)) _ nf ng = normal-case nf ng λ ()
...
optimize-case-normal (_ ∘ (inl _)) (curry _) nf ng = normal-case nf ng λ ()
...
optimize-case-normal (_ ∘ (inl _)) (_ ∘ (curry _)) nf ng = normal-case nf ng λ ()
