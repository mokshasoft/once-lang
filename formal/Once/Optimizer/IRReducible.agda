...
comp-reducible? (curry _) id = yes red-id-right
...
comp-reducible? (curry _) initial = yes red-initial
...
comp-reducible? (⟨ _ , _ ⟩) (curry _) = no λ ()
...
comp-reducible? (inl _) (curry _) = no λ ()
...
comp-reducible? (inr _) (curry _) = no λ ()
...
comp-reducible? (curry _) (_ ∘ _) = no λ ()
comp-reducible? (curry _) fst = no λ ()
comp-reducible? (curry _) snd = no λ ()
comp-reducible? (curry _) (⟨ _ , _ ⟩) = no λ ()
comp-reducible? (curry _) (inl _) = no λ ()
comp-reducible? (curry _) (inr _) = no λ ()
comp-reducible? (curry _) (case _ _) = no λ ()
comp-reducible? (curry _) terminal = no λ ()
comp-reducible? (curry _) (curry _) = no λ ()
comp-reducible? (curry _) apply = no λ ()
comp-reducible? (curry _) (fold _) = no λ ()
comp-reducible? (curry _) unfold = no λ ()
comp-reducible? (curry _) arr = no λ ()
comp-reducible? (curry _) (SigOp _) = no λ ()
...
comp-reducible? (fold _) (curry _) = no λ ()
...
comp-reducible? arr (curry _) = no λ ()
...
comp-reducible? (SigOp _) (curry _) = no λ ()
...
pair-reducible? fst (curry _) = no λ ()
...
pair-reducible? (fst ∘ _) (curry _) = no λ ()
...
-- f = _ ∘ (curry _)
case-reducible? (_ ∘ (curry _)) _ = no λ ()
-- f = _ ∘ apply
...
case-reducible? (_ ∘ (inl _)) (curry _) = no λ ()
...
case-reducible? (_ ∘ (inl _)) (_ ∘ (curry _)) = no λ ()
