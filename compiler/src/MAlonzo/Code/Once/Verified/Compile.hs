...
d_compile'45'asm_6 ::
  ...
  MAlonzo.Code.Once.Compile.T_CompileResult_542
      ...
      (case coe v2 of
         MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v3
           -> let v4
              ...
              coe
                (coe
                   MAlonzo.Code.Once.Compile.d_compileFromModule_654
                   (coe MAlonzo.Code.Once.CCC.IR.C_Heap_262)
                   (coe MAlonzo.Code.Once.Compile.C_Build_540)
         ...
         MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
           -> case coe v2 of
                ...
                MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
                  -> coe
                       MAlonzo.Code.Once.Compile.C_Error_550
...
d_compile'45'cli'45'asm_26 ::
  ...
  MAlonzo.Code.Once.Compile.T_Stage_534 ->
  Bool ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
...
d_compile'45'cli'45'asm_26 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.Compile.d_compileFromModule_654 (coe v0) (coe v1)
...
d_gmoduleToModule'45'correct_118 ::
  MAlonzo.Code.Once.Grammar.T_GModule_138 ->
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_gmoduleToModule'45'correct_118 = erased
...
d_exec_136 ::
  ...
  Integer -> [MAlonzo.Code.Once.Verified.Trace.T_SigOpEvent_136]
d_exec_136 v0 ~v1 v2 v3 = du_exec_136 v0 v2 v3
du_exec_136 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
...
d_string'45'to'45'bytes_142 ::
  ...
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  [MAlonzo.Code.Data.Fin.Base.T_Fin_10]
d_string'45'to'45'bytes_142 v0 ~v1 v2
  = du_string'45'to'45'bytes_142 v0 v2
du_string'45'to'45'bytes_142 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  [MAlonzo.Code.Data.Fin.Base.T_Fin_10]
du_string'45'to'45'bytes_142 v0 v1
  = coe
...
d_compile_146 v0 ~v1 v2 v3 = du_compile_146 v0 v2 v3
du_compile_146 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
                                               ...
                                               -> let v14
                                                        = coe
                                                            ...
                                                            (MAlonzo.Code.Once.Target.d_asmHeader_38
                                                               (coe
                                                                  MAlonzo.Code.Once.Compile.d_archTarget_464
                                                                  (coe v1)))
                                                            (MAlonzo.Code.Once.Compile.d_compileAllWithTarget_502
                                                               (coe
                                                                  MAlonzo.Code.Once.Compile.d_archTarget_464
                                                                  (coe v1))
                                                               (coe v13)) in
                                                  coe
                                                    (coe
                                                       ...
                                                       (coe du_string'45'to'45'bytes_142 v0 v1 v14))
                                             _ -> MAlonzo.RTE.mazUnreachableError)
                                   _ -> MAlonzo.RTE.mazUnreachableError
                            _ -> MAlonzo.RTE.mazUnreachableError))))
         MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
...
d_'10214'_'10215'A__184 ::
  ...
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  Integer -> [MAlonzo.Code.Once.Verified.Trace.T_SigOpEvent_136]
d_'10214'_'10215'A__184 ~v0 v1 v2 v3
  = du_'10214'_'10215'A__184 v1 v2 v3
du_'10214'_'10215'A__184 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 -> T_ArchCorrect_46) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  Integer -> [MAlonzo.Code.Once.Verified.Trace.T_SigOpEvent_136]
du_'10214'_'10215'A__184 v0 v1 v2
  = coe d_asm'45'sem_76 (coe v0 v1) v2
-- Once.Verified.Compile.WithCPU.string-to-bytes-correct
d_string'45'to'45'bytes'45'correct_196 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 -> T_ArchCorrect_46) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_string'45'to'45'bytes'45'correct_196 = erased
-- Once.Verified.Compile.WithCPU.codegen-asm-correct
d_codegen'45'asm'45'correct_212 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 -> T_ArchCorrect_46) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_codegen'45'asm'45'correct_212 = erased
-- Once.Verified.Compile.WithCPU.mta-aux
d_mta'45'aux_234 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 -> T_ArchCorrect_46) ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_mta'45'aux_234 = erased
-- Once.Verified.Compile.WithCPU.module-to-asm-correct
d_module'45'to'45'asm'45'correct_274 ::
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
   MAlonzo.Code.Once.Verified.CPU.Interface.T_ArchSemantics_10) ->
  (MAlonzo.Code.Once.Target.Arch.T_Arch_6 -> T_ArchCorrect_46) ->
  MAlonzo.Code.Once.Target.Arch.T_Arch_6 ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_module'45'to'45'asm'45'correct_274 = erased
