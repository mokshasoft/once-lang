...
module MAlonzo.Code.Once.Verified.ArchCorrectness.X86Z45Z64 where
...
-- Once.Verified.ArchCorrectness.X86-64.program-bound
d_program'45'bound_8
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Verified.ArchCorrectness.X86-64.program-bound"
-- Once.Verified.ArchCorrectness.X86-64._.IRObsCorrectF
d_IRObsCorrectF_12 ::
...
-- Once.Verified.ArchCorrectness.X86-64.x86-flat-from-obs
d_x86'45'flat'45'from'45'obs_22
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Verified.ArchCorrectness.X86-64.x86-flat-from-obs"
-- Once.Verified.ArchCorrectness.X86-64.x86-64-correct
