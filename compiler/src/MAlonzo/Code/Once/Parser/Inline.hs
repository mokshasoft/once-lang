...
d_expandBuiltins_188 ::
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34
d_expandBuiltins_188 v0 = coe v0
-- Once.Parser.Inline.expandPairs
d_expandPairs_192 ::
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34
d_expandPairs_192 v0 = coe v0
...
d_subst_194 v0 v1 v2
  = case coe v2 of
      ...
      MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_40 v3 v4
        -> coe
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_40
             (coe d_subst_194 (coe v0) (coe v1) (coe v3))
             (coe d_subst_194 (coe v0) (coe v1) (coe v4))
                  ...
                  -> if coe v7
                       then coe
                              ...
                              (coe
                                 ...
                                 (coe d_subst_194 (coe v0) (coe v1) (coe v4)) (coe v5))
                       else coe
                              seq (coe v8)
                              (coe
                                 MAlonzo.Code.Once.TypeCheck.Raw.C_RLet_44 (coe v3)
                                 (coe d_subst_194 (coe v0) (coe v1) (coe v4))
                                 (coe d_subst_194 (coe v0) (coe v1) (coe v5)))
                _ -> MAlonzo.RTE.mazUnreachableError)
                                      ...
                                      -> if coe v12
                                           then coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe d_subst_194 (coe v0) (coe v1) (coe v7)))
                                    _ -> MAlonzo.RTE.mazUnreachableError)
                          else coe
                                 seq (coe v11)
                                 (case coe v9 of
      ...
      MAlonzo.Code.Once.TypeCheck.Raw.C_RAnnot_56 v3 v4
        -> coe
             MAlonzo.Code.Once.TypeCheck.Raw.C_RAnnot_56
             (coe d_subst_194 (coe v0) (coe v1) (coe v3)) (coe v4)
      ...
      MAlonzo.Code.Once.TypeCheck.Raw.C_RUnaryOp_60 v4
        -> coe
             MAlonzo.Code.Once.TypeCheck.Raw.C_RUnaryOp_60
             (d_subst_194 (coe v0) (coe v1) (coe v4))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Parser.Inline.betaReduceApps
d_betaReduceApps_404 ::
  Integer ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34
d_betaReduceApps_404 v0 v1
  = case coe v0 of
      0 -> coe v1
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v1 of
                ...
                MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_40 v3 v4
                  -> let v5 = d_betaReduceApps_404 (coe v2) (coe v3) in
                     coe
                       (let v6
                              = coe
                                  MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_40 (coe v5)
                                  (coe d_betaReduceApps_404 (coe v2) (coe v4)) in
                        coe
                          (case coe v5 of
                             MAlonzo.Code.Once.TypeCheck.Raw.C_RLam_42 v7 v8
                               -> coe
                                    d_betaReduceApps_404 (coe v2)
                                    (coe
                                       d_subst_194 (coe v7)
                                       (coe d_betaReduceApps_404 (coe v2) (coe v4)) (coe v8))
                             _ -> coe v6))
                MAlonzo.Code.Once.TypeCheck.Raw.C_RLam_42 v3 v4
                  -> coe
                       MAlonzo.Code.Once.TypeCheck.Raw.C_RLam_42 (coe v3)
                       (coe d_betaReduceApps_404 (coe v2) (coe v4))
                MAlonzo.Code.Once.TypeCheck.Raw.C_RLet_44 v3 v4 v5
                  -> coe
                       MAlonzo.Code.Once.TypeCheck.Raw.C_RLet_44 (coe v3)
                       (coe d_betaReduceApps_404 (coe v2) (coe v4))
                       (coe d_betaReduceApps_404 (coe v2) (coe v5))
                MAlonzo.Code.Once.TypeCheck.Raw.C_RPair_46 v3 v4
                  -> coe
                       MAlonzo.Code.Once.TypeCheck.Raw.C_RPair_46
                       (coe d_betaReduceApps_404 (coe v2) (coe v3))
                       (coe d_betaReduceApps_404 (coe v2) (coe v4))
                MAlonzo.Code.Once.TypeCheck.Raw.C_RDestruct_48 v3 v4 v5 v6 v7
                  -> coe
                       MAlonzo.Code.Once.TypeCheck.Raw.C_RDestruct_48
                       (coe d_betaReduceApps_404 (coe v2) (coe v3)) (coe v4)
                       (coe d_betaReduceApps_404 (coe v2) (coe v5)) (coe v6)
                       (coe d_betaReduceApps_404 (coe v2) (coe v7))
                ...
                MAlonzo.Code.Once.TypeCheck.Raw.C_RUnaryOp_60 v4
                  -> coe
                       MAlonzo.Code.Once.TypeCheck.Raw.C_RUnaryOp_60
                       (d_betaReduceApps_404 (coe v2) (coe v4))
                _ -> MAlonzo.RTE.mazUnreachableError)
