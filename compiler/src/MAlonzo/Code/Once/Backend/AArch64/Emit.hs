  ...
  = case coe v0 of
      ...
      MAlonzo.Code.Once.Backend.AArch64.Syntax.C_brk_126 v1
        -> coe
             ...
             ("    brk #" :: Data.Text.Text)
             (coe MAlonzo.Code.Data.Nat.Show.d_show_56 v1)
      MAlonzo.Code.Once.Backend.AArch64.Syntax.C_adr_128 v1 v2
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             ("    adr " :: Data.Text.Text)
             (coe
                ...
                (coe
                   ...
                   (", .L" :: Data.Text.Text)
                   (coe MAlonzo.Code.Data.Nat.Show.d_show_56 v2)))
      MAlonzo.Code.Once.Backend.AArch64.Syntax.C_str'45'zr_130 v1
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             ("    str xzr, " :: Data.Text.Text) (d_memToText_18 (coe v1))
      MAlonzo.Code.Once.Backend.AArch64.Syntax.C_label_132 v1
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             (".L" :: Data.Text.Text)
             (coe
