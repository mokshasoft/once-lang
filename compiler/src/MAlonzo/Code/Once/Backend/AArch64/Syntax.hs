...
data T_Instr_88
  = C_mov_90 T_Reg_8 T_Operand_80 | C_ldr_92 T_Reg_8 T_Mem_72 |
    ...
    C_nop_124 | C_brk_126 Integer | C_adr_128 T_Reg_8 Integer |
    C_str'45'zr_130 T_Mem_72 | C_label_132 Integer
-- Once.Backend.AArch64.Syntax.Program
d_Program_134 :: ()
d_Program_134 = erased
-- Once.Backend.AArch64.Syntax.Function
d_Function_136 = ()
data T_Function_136 = C_mkfun_146 Integer [T_Instr_88]
-- Once.Backend.AArch64.Syntax.Function.name
d_name_142 :: T_Function_136 -> Integer
d_name_142 v0
  = case coe v0 of
      C_mkfun_146 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Backend.AArch64.Syntax.Function.body
d_body_144 :: T_Function_136 -> [T_Instr_88]
d_body_144 v0
  = case coe v0 of
      C_mkfun_146 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Backend.AArch64.Syntax.fstOffset
d_fstOffset_148 :: Integer
d_fstOffset_148 = coe (0 :: Integer)
-- Once.Backend.AArch64.Syntax.sndOffset
d_sndOffset_150 :: Integer
d_sndOffset_150 = coe (8 :: Integer)
-- Once.Backend.AArch64.Syntax.tagOffset
d_tagOffset_152 :: Integer
d_tagOffset_152 = coe (0 :: Integer)
-- Once.Backend.AArch64.Syntax.valueOffset
d_valueOffset_154 :: Integer
d_valueOffset_154 = coe (8 :: Integer)
-- Once.Backend.AArch64.Syntax.inlTag
d_inlTag_156 :: Integer
d_inlTag_156 = coe (0 :: Integer)
-- Once.Backend.AArch64.Syntax.inrTag
d_inrTag_158 :: Integer
d_inrTag_158 = coe (1 :: Integer)
-- Once.Backend.AArch64.Syntax.pairFrameSize
d_pairFrameSize_160 :: Integer
d_pairFrameSize_160 = coe (16 :: Integer)
-- Once.Backend.AArch64.Syntax.sumFrameSize
d_sumFrameSize_162 :: Integer
d_sumFrameSize_162 = coe (16 :: Integer)
-- Once.Backend.AArch64.Syntax.closureFrameSize
d_closureFrameSize_164 :: Integer
d_closureFrameSize_164 = coe (16 :: Integer)
