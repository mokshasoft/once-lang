...
d_rt'45'atom_40 v0 v1 v2
  = case coe v1 of
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'unit_62
        -> coe MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'unit_112
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'void_64
        -> coe MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'void_116
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'int_66
        -> coe MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'int_120
      ...
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'prod_78 v5 v6
        -> case coe v0 of
             MAlonzo.Code.Once.Grammar.C__'8855'__24 v7 v8
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Once.Parser.Token.C_TRParen_16) (coe v2)))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'sum_84 v5 v6
        -> case coe v0 of
             MAlonzo.Code.Once.Grammar.C__'8853'__26 v7 v8
               -> coe
                    MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'paren_162
                    (coe
                       MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Once.Parser.Token.C_TRParen_16) (coe v2)))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'fun_92 v6 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Grammar.C__'8658''91'_'93'__22 v8 v9 v10
               -> coe
                    MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'paren_162
                    (coe
                       MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Once.Parser.Token.C_TRParen_16) (coe v2)))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.Grammar.Printer.C_c'45'eff_98 v5 v6
        -> case coe v0 of
             MAlonzo.Code.Once.Grammar.C_TEff_28 v7 v8
               -> coe
                    MAlonzo.Code.Once.Parser.TypeRelation.C_pa'45'paren_162
                    (coe
                       MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
...
du_rt'45'type'45'of'45'prod_52 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.Parser.TypeRelation.C_pt'45'mk_238 v4
      (coe
         ...
         (coe
            ...
            (coe v3)))
      (coe
         MAlonzo.Code.Once.Parser.TypeRelation.C_ps'45'mk_206 v4
         (coe
            MAlonzo.Code.Once.Type.C__'42'__140
            (coe
               MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8 (coe v0)
            ...
            (d_rt'45'atom_40
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe v4))))
            (coe
               MAlonzo.Code.Once.Parser.TypeRelation.C_ppt'45'star_194 v4
               (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
                  (coe v1) (coe v3))
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Agda.Builtin.Unit.C_tt_8)))
         (coe
            MAlonzo.Code.Once.Parser.TypeRelation.C_pst'45'plus_226 v4
            (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
               (coe v1) (coe v3))
            (coe
               MAlonzo.Code.Once.Parser.TypeRelation.C_pp'45'mk_174 v4
               (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
                  (coe v1) (coe v3))
               (d_rt'45'atom_40 (coe v1) (coe v3) (coe v4))
               (coe
...
du_rt'45'type_86 v0 v1 v2
  = coe
      MAlonzo.Code.Once.Parser.TypeRelation.C_pt'45'mk_238 v2
      (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
         (coe v0) (coe v1))
      (coe
         MAlonzo.Code.Once.Parser.TypeRelation.C_ps'45'mk_206 v2
         (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
            (coe v0) (coe v1))
         (coe
            MAlonzo.Code.Once.Parser.TypeRelation.C_pp'45'mk_174 v2
            (MAlonzo.Code.Once.Grammar.ParserRelation.d_toType_8
               (coe v0) (coe v1))
