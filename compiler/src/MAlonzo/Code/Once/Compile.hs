...
d_compileFunBody_24 v0 v1 v2 v3 v4 v5
  = let v6
          = MAlonzo.Code.Once.TypeCheck.Elaborate.d_checkElab_1858
              (coe
                 MAlonzo.Code.Once.TypeCheck.Elaborate.d_ctxWithImportsAndSelfAndPolys_598
         ...
         MAlonzo.Code.Once.TypeCheck.Elaborate.C_success_416 v7 v8 v9 v10
           -> coe
                ...
                (coe
                   ...
                   (coe
                      MAlonzo.Code.Once.Optimize.d_optimize_3280
                      (coe
                      ...
                      (coe
                         ...
                         (coe
                            MAlonzo.Code.Once.TypeCheck.Elaborate.du_resolveExpr_7152
                            (coe (0 :: Integer))
...
d_cfType_160 ::
  T_CompiledFun_150 -> MAlonzo.Code.Once.Type.T_Type_38
d_cfType_160 v0
  = case coe v0 of
...
d_pipeline_294 v0 v1 v2
  = coe
      ...
      (coe
         MAlonzo.Code.Once.Optimize.d_optimize_3280 v0 v1
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe MAlonzo.Code.Once.Type.C_Unit_48) (d_cfType_160 (coe v1))
            (d_cfIR_162 (coe v1)))
