...
data T_SurfaceIR_6
  = C_id_10 |
    C__'8728'__18 MAlonzo.Code.Once.Type.T_Type_32 T_SurfaceIR_6
                  T_SurfaceIR_6 |
    C_fst_24 | C_snd_30 |
    ...
    C_apply_80 | C_fold_84 | C_unfold_88 | C_arr_94 |
    C_Let_102 MAlonzo.Code.Once.Type.T_Type_32 T_SurfaceIR_6
              T_SurfaceIR_6 |
