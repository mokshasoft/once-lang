...
du_elaborate_108 v0 v1 v2 v3
  = case coe v3 of
      ...
      MAlonzo.Code.Once.Surface.Syntax.C_neg_248 v7
        -> coe
             MAlonzo.Code.Once.IR.C__'8728'__30
             (coe MAlonzo.Code.Once.IRTy.C_Int_30) d_negIR_28
             (coe
                du_elaborate_108 (coe v0) (coe MAlonzo.Code.Once.Type.C_Int_136)
                (coe v2) (coe v7))
...
d_elaborate'45'default_326 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  MAlonzo.Code.Once.IR.T_IR_16
d_elaborate'45'default_326 ~v0 v1 ~v2 v3
  = du_elaborate'45'default_326 v1 v3
du_elaborate'45'default_326 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  MAlonzo.Code.Once.IR.T_IR_16
du_elaborate'45'default_326 v0 v1
  = coe
      du_elaborate_108 (coe v0) (coe v1)
      (coe MAlonzo.Code.Once.IR.C_Heap_8)
-- Once.Surface.Elaborate.distribute-default
d_distribute'45'default_334 ::
  MAlonzo.Code.Once.IRTy.T_IRTy_6 ->
  MAlonzo.Code.Once.IRTy.T_IRTy_6 ->
  MAlonzo.Code.Once.IRTy.T_IRTy_6 -> MAlonzo.Code.Once.IR.T_IR_16
d_distribute'45'default_334 v0 v1 v2
  = coe
