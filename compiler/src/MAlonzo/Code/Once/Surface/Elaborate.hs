...
d_addIR_24
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Int_136))
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_add'45'info_332)
...
d_subIR_26
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Int_136))
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_sub'45'info_334)
...
d_mulIR_28
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Int_136))
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_mul'45'info_336)
...
d_divIR_30
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Int_136))
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_div'45'info_338)
...
d_modIR_32
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Int_136))
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_mod'45'info_340)
...
d_negIR_34
  = coe
      ...
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Type.C_Int_136)
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_neg'45'info_342)
...
d_ltIR_36
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_lt'45'info_344)
...
d_leIR_38
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_le'45'info_346)
...
d_gtIR_40
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_gt'45'info_348)
...
d_geIR_42
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_ge'45'info_350)
...
d_eqIR_44
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_eq'45'info_352)
...
d_neIR_46
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Type.C_Unit_122)
         (coe MAlonzo.Code.Once.Type.C_Unit_122))
      (coe MAlonzo.Code.Once.Arith.SigOp.Builders.d_ne'45'info_354)
      ...
      MAlonzo.Code.Once.Surface.Syntax.C_closure_344 v7
        -> coe
             ...
             (coe
                ...
                (coe MAlonzo.Code.Once.Type.C_Unit_122) (coe v1)
                (coe
                   MAlonzo.Code.Once.Arith.SigOp.Builders.d_internal'45'info_380
