...
du_intLit_8 :: Integer -> MAlonzo.Code.Once.CCC.IR.T_IR_278
du_intLit_8 v0
  = coe
      MAlonzo.Code.Once.CCC.IR.C__'8728'__292
      (coe MAlonzo.Code.Once.Type.C_Unit_122)
      (coe
         MAlonzo.Code.Once.CCC.IR.C_const_422
...
du_swap''_78 v0
  = coe
      ...
      (coe MAlonzo.Code.Once.CCC.IR.C_snd_312)
      (coe MAlonzo.Code.Once.CCC.IR.C_fst_306) v0
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe MAlonzo.Code.Once.CCC.IR.C_fst_306))
         (coe MAlonzo.Code.Once.CCC.IR.C_snd_312) v3)
  ...
  = case coe v3 of
      ...
      MAlonzo.Code.Once.Surface.Syntax.C_inl''_278 v9
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'43'__128 v10 v11
               -> coe
                    MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v10
                    (coe MAlonzo.Code.Once.CCC.IR.C_inl_318 v2)
      ...
      MAlonzo.Code.Once.Surface.Syntax.C_inr''_290 v9
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'43'__128 v10 v11
               -> coe
                    MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v11
                    (coe MAlonzo.Code.Once.CCC.IR.C_inr_324 v2)
      ...
      MAlonzo.Code.Once.Surface.Syntax.C_sigOp_494 v7
        -> let v8
                 = coe
                     ...
                     (coe MAlonzo.Code.Once.CCC.IR.C_terminal_336) in
           coe
             (case coe v1 of
                MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v9 v10 v11
                  -> coe
                       MAlonzo.Code.Once.CCC.IR.C_curry_350
                       (coe
                          MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v9
                          (coe
                             MAlonzo.Code.Once.CCC.IR.C_SigOp_428
        ...
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v10 v11 v12
               -> coe
                    MAlonzo.Code.Once.CCC.IR.C_curry_350
                    (coe
                       MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v10 v9
                       (coe MAlonzo.Code.Once.CCC.IR.C_snd_312))
                    v2
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.Surface.Syntax.C_morph'45'app_536 v6 v7 v9 v10
        -> coe
             MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v7 v9
                           ...
                           MAlonzo.Code.Once.Type.C_mk'45'kind_50 v15 v16
                             -> coe
                                  ...
                                  (coe
                                     MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v11
                                     (coe
                                        MAlonzo.Code.Once.CCC.IR.C_Cata_380 v9
                                        (coe
                                           MAlonzo.Code.Once.CCC.IR.C__'8728'__292
                                           (coe
                                              MAlonzo.Code.Once.Type.C__'42'__126
                                           ...
                                           (coe
                                              ...
                                              (coe
                                                 ...
                                                 (coe
                                                    ...
                                                    (coe v2) (coe v10))
                                                 (coe MAlonzo.Code.Once.CCC.IR.C_terminal_336))
                                              (coe MAlonzo.Code.Once.CCC.IR.C_id_284) v2)))
                                     (coe MAlonzo.Code.Once.CCC.IR.C_snd_312))
                                  v2
                           _ -> MAlonzo.RTE.mazUnreachableError
                    _ -> MAlonzo.RTE.mazUnreachableError
                           ...
                           MAlonzo.Code.Once.Type.C_ν'45'type_134 v16
                             -> coe
                                  ...
                                  (coe
                                     MAlonzo.Code.Once.CCC.IR.C__'8728'__292 v11
                                     (coe
                                        MAlonzo.Code.Once.CCC.IR.C_Ana_400 v9
                                        (coe
                                           MAlonzo.Code.Once.CCC.IR.C__'8728'__292
                                           (coe
                                              MAlonzo.Code.Once.Type.C__'42'__126
