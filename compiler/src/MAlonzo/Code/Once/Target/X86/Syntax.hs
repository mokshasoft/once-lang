...
module MAlonzo.Code.Once.Target.X86.Syntax where
  ...
  = let v1 = 0 :: Integer in
    coe
      (case coe v0 of
         ...
         _ -> coe v1)
-- Once.Target.X86.Syntax.instrs-consumed-slots
