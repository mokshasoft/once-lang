      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
               (coe
                  MAlonzo.Code.Once.CCC.Codegen.IRToTrace.d_ir'45'to'45'trace'45'from_532
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (mulInt
                  (coe
                     MAlonzo.Code.Once.CCC.Codegen.IRToTrace.d_ir'45'stack'45'budget'45'from_546
                     (coe v1) (coe v2) (coe v0) (coe v3))
                  (coe (8 :: Integer))))
            (coe
               MAlonzo.Code.Data.String.Base.d__'43''43'__20
...
d_x86'45'64'45'irToBodies_52 v0 v1 v2 v3
  = coe
      ...
      (coe
         MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
         (coe
            MAlonzo.Code.Once.CCC.Codegen.IRToTrace.d_ir'45'to'45'bodies'45'from_556
            (coe v1) (coe v2) (coe v0) (coe v3)))
      (coe
         MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
         (coe
