...
data T_WellTyped_6
  = C_T'45'Var_18 MAlonzo.Code.Once.TypeCheck.Context.T_Quantity_6
                  Integer |
    C_T'45'Gen_30 Integer Integer |
    C_T'45'App_42 MAlonzo.Code.Once.Type.T_Type_4 T_WellTyped_6
                  T_WellTyped_6 |
    C_T'45'Lam_54 T_WellTyped_6 |
    C_T'45'Let_68 MAlonzo.Code.Once.Type.T_Type_4 T_WellTyped_6
                  T_WellTyped_6 |
    C_T'45'Pair_80 T_WellTyped_6 T_WellTyped_6 |
    C_T'45'Case_100 MAlonzo.Code.Once.Type.T_Type_4
                    MAlonzo.Code.Once.Type.T_Type_4 T_WellTyped_6 T_WellTyped_6
                    T_WellTyped_6 |
...
d_Closed_200 a0 = ()
data T_Closed_200
  = C_closed'45'unit_202 | C_closed'45'void_204 |
    C_closed'45'int_206 | C_closed'45'float_208 | C_closed'45'str_210 |
    C_closed'45'buffer_212 |
    C_closed'45'prod_218 T_Closed_200 T_Closed_200 |
    C_closed'45'sum_224 T_Closed_200 T_Closed_200 |
    C_closed'45'arrow_230 T_Closed_200 T_Closed_200 |
    C_closed'45'eff_236 T_Closed_200 T_Closed_200 |
    C_closed'45'fix_240 T_Closed_200
-- Once.TypeCheck.Sound.applySubst-closed
d_applySubst'45'closed_246
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.TypeCheck.Sound.applySubst-closed"
-- Once.TypeCheck.Sound.Decidable
d_Decidable_248 :: ()
d_Decidable_248 = erased
-- Once.TypeCheck.Sound.decidable
d_decidable_258 ::
  [MAlonzo.Code.Once.TypeCheck.Context.T_Binding_14] ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_decidable_258 v0 v1 v2
  = coe
