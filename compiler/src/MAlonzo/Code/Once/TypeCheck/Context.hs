...
d_type_16 :: T_Binding_6 -> MAlonzo.Code.Once.Type.T_Type_32
d_type_16 v0
  = case coe v0 of
...
d__'44'_'8759'__26 ::
  ...
  MAlonzo.Code.Once.Type.T_Type_32 -> [T_Binding_6]
...
data T_LookupResult_44
  = C_found_52 MAlonzo.Code.Once.Type.T_Type_32
...
d_ctxTypes_234 ::
  [T_Binding_6] -> [MAlonzo.Code.Once.Type.T_Type_32]
d_ctxTypes_234 v0
  = case coe v0 of
      [] -> coe v0
      (:) v1 v2
