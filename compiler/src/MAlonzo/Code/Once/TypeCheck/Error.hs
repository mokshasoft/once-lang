...
data T_TypeError_6
  = C_UnboundVariable_8 MAlonzo.Code.Agda.Builtin.String.T_String_6 |
    ...
    C_ApplicationTypeMismatch_46 MAlonzo.Code.Once.Type.T_Type_126
                                 MAlonzo.Code.Once.Type.T_Type_126 |
    C_TypeMismatch_52 MAlonzo.Code.Once.Type.T_Type_126
                      MAlonzo.Code.Once.Type.T_Type_126 |
    C_NotFunction_56 MAlonzo.Code.Once.Type.T_Type_126 |
  ...
  = case coe v0 of
      ...
      C_ApplicationTypeMismatch_46 v1 v2
        -> coe
             ...
             (coe
                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                (MAlonzo.Code.Once.Type.d_showType_218 (coe v2))
                (coe
                   MAlonzo.Code.Data.String.Base.d__'43''43'__20
                   (" does not match function domain " :: Data.Text.Text)
                   (MAlonzo.Code.Once.Type.d_showType_218 (coe v1))))
