...
d_const'45'morph'45'strong_160
  = error
...
d_named'45'morph'45'strong_186
  = error
...
d_named'45'morph'45'strong'45'resolved_198
  = error
...
d_morph'45'elab_210 ::
  ...
  MAlonzo.Code.Once.TypeCheck.Judgment.T__'8866''7504'_'8758'_'8680''91'_'93'__18 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_morph'45'elab_210 v0 v1 v2 v3 v4 v5
  = case coe v5 of
...
d_morph'45'complete_1040 ::
  ...
  MAlonzo.Code.Once.TypeCheck.Judgment.T__'8866''7504'_'8758'_'8680''91'_'93'__18 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_morph'45'complete_1040 v0 v1 v2 v3 v4 v5
  = let v6
          = d_morph'45'elab_210
...
d_pair'45'eff'45'complete_1076 ::
  MAlonzo.Code.Once.TypeCheck.Classify.T_NamedCtx_170 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  ...
  MAlonzo.Code.Once.TypeCheck.Judgment.T__'8866''7504'_'8758'_'8680''91'_'93'__18 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pair'45'eff'45'complete_1076 v0 v1 v2 v3 v4 v5 v6 v7
  = let v8
          = d_morph'45'elab_210
...
d_curry'45'eff'45'complete_1162 ::
  MAlonzo.Code.Once.TypeCheck.Classify.T_NamedCtx_170 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  ...
  MAlonzo.Code.Once.TypeCheck.Judgment.T__'8866''7504'_'8758'_'8680''91'_'93'__18 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_curry'45'eff'45'complete_1162 v0 v1 v2 v3 v4 v5
  = let v6
          = d_morph'45'elab_210
              (coe v0) (coe v1)
