...
d_FlatState_56 a0 = ()
data T_FlatState_56
  = C_mkFlat_70 MAlonzo.Code.Once.CCC.Machine.SMCore.T_LocState_468
                MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_522 Integer
...
du_sv'45'is'45'zero_72 v0
  = let v1 = coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8 in
    coe
      (case coe v0 of
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_SV'45'Tag_84 v2
           -> case coe v2 of
...
du_flat'45'read'45'at_78 v0 v1
  = case coe v1 of
      MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v2
        -> coe
             MAlonzo.Code.Once.CCC.Machine.SMCore.du_readLoc_630 (coe v0)
             (coe v2)
    ...
    coe
      (case coe v0 of
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2130 v2
           -> case coe v2 of
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2052 v3
             ...
             (\ v1 ->
                coe
                  ...
                  (coe
                     ...
                     (coe
                        MAlonzo.Code.Once.CCC.Machine.SMCore.d_regs_480
                        (coe d_floc_64 (coe v1)))
                     (coe
                        MAlonzo.Code.Once.CCC.Machine.SMCore.d_stackMem_482
                        (coe d_floc_64 (coe v1)))
                     (coe
                        MAlonzo.Code.Once.CCC.Machine.SMCore.d_heapMem_484
                        (coe d_floc_64 (coe v1)))
    ...
    coe
      (case coe v1 of
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2130 v3
           -> case coe v3 of
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2052 v4
                  -> coe
                       (\ v5 v6 ->
                          coe
                            C_mkFlat_70 (coe d_floc_64 (coe v6)) (coe d_falloc_66 (coe v6))
                            (coe addInt (coe (1 :: Integer)) (coe d_fpc_68 (coe v6))))
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'jmp_2054 v4
                  -> coe
                       (\ v5 v6 ->
                          coe
                            du_do'45'jump_150 (d_find'45'label_136 (coe v0) (coe v5) (coe v4))
                            v6)
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'branch'45'scratch'45'zero_2056 v4
                  -> coe
                       (\ v5 v6 ->
                          coe
                            ...
                            (coe
                               ...
                               (coe
                                  ...
                                  (coe MAlonzo.Code.Once.CCC.Machine.SMCore.C_Scratch_64)))
                            v4 v5 v6)
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'branch'45'tag'45'zero_2058 v4
                  -> coe
                       (\ v5 v6 ->
                          coe
                            d_do'45'branch_158 v0
...
du_shift'45'loc_518 v0 v1 v2 v3 v4 v5
  = case coe v1 of
      ...
      _ -> let v6 = subInt (coe v1) (coe (1 :: Integer)) in
           coe
             (let v7
                    = MAlonzo.Code.Once.CCC.Machine.SMCore.d_halted_486 (coe v3) in
              coe
                (if coe v7
...
du_exec'45'trace'45'is'45'flat_676 v0 v1 v2
  = let v3
          = MAlonzo.Code.Once.CCC.Machine.SMCore.d_halted_486 (coe v1) in
    coe
      (if coe v3
         then coe MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 erased erased
         else (case coe v0 of
