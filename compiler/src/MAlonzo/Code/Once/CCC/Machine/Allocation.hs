...
du_write'45'heap'45'slot_310 v0 v1 v2
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.du_writeHeapMem_764
...
d_push'45'frame_1086 ::
  ...
  AgdaAny ->
  Integer -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568
d_push'45'frame_1086 ~v0 v1 v2 v3 = du_push'45'frame_1086 v1 v2 v3
du_push'45'frame_1086 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  Integer -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568
du_push'45'frame_1086 v0 v1 v2
  = coe
...
d_pop'45'frame_1100 ::
  ...
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  Integer -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568
d_pop'45'frame_1100 ~v0 v1 v2 v3 = du_pop'45'frame_1100 v1 v2 v3
du_pop'45'frame_1100 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  Integer -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568
du_pop'45'frame_1100 v0 v1 v2
  = coe
      MAlonzo.Code.Once.CCC.Machine.SMCore.C_mkAllocState_660
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.d_current'45'frame_648
...
d_in'45'parent'45'frame'45'before'45'child_1116 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  Integer ->
  Integer ->
...
d_in'45'parent'45'frame'45'before'45'child_1116 v0 ~v1 ~v2 ~v3 v4
                                                v5
  = du_in'45'parent'45'frame'45'before'45'child_1116 v0 v4 v5
du_in'45'parent'45'frame'45'before'45'child_1116 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
du_in'45'parent'45'frame'45'before'45'child_1116 v0 v1 v2
  = coe
...
d_heap'45'before'45'child_1138 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  Integer ->
  MAlonzo.Code.Once.Memory.HeapAddress.T_HeapLocation_42 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
d_heap'45'before'45'child_1138 ~v0 ~v1 ~v2 ~v3 v4
  = du_heap'45'before'45'child_1138 v4
du_heap'45'before'45'child_1138 ::
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
du_heap'45'before'45'child_1138 v0 = coe C_heap'45'before_656 v0
-- Once.CCC.Machine.Allocation.FrameOps.ancestor-frame-before-child
d_ancestor'45'frame'45'before'45'child_1164 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  Integer ->
...
d_ancestor'45'frame'45'before'45'child_1164 v0 v1 v2 ~v3 v4 ~v5 v6
                                            v7 v8 v9
  = du_ancestor'45'frame'45'before'45'child_1164
...
du_ancestor'45'frame'45'before'45'child_1164 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  AgdaAny -> AgdaAny -> T_BeforeFrontier_634
du_ancestor'45'frame'45'before'45'child_1164 v0 v1 v2 v3 v4 v5 v6
                                             v7
  = coe
      C_stack'45'ancestor_652
      (MAlonzo.Code.Once.CCC.Machine.SMCore.d_current'45'frame_648
...
d_parent'45'before'45'child_1192 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  Integer ->
...
d_parent'45'before'45'child_1192 v0 v1 v2 ~v3 v4 v5 v6
  = du_parent'45'before'45'child_1192 v0 v1 v2 v4 v5 v6
du_parent'45'before'45'child_1192 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  AgdaAny ->
  MAlonzo.Code.Once.CCC.Machine.Locations.T_ValueLocation_12 ->
  AgdaAny -> T_BeforeFrontier_634 -> T_BeforeFrontier_634
du_parent'45'before'45'child_1192 v0 v1 v2 v3 v4 v5
  = case coe v3 of
...
d_pop'45'preserves'45'before_1264 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  Integer ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
d_pop'45'preserves'45'before_1264 ~v0 ~v1 ~v2 ~v3 v4
  = du_pop'45'preserves'45'before_1264 v4
du_pop'45'preserves'45'before_1264 ::
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
du_pop'45'preserves'45'before_1264 v0
  = coe C_stack'45'before_642 v0
-- Once.CCC.Machine.Allocation.FrameOps.pop-heap-before
d_pop'45'heap'45'before_1284 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_568 ->
  Integer ->
  MAlonzo.Code.Once.Memory.HeapAddress.T_HeapLocation_42 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
d_pop'45'heap'45'before_1284 ~v0 ~v1 ~v2 ~v3 v4
  = du_pop'45'heap'45'before_1284 v4
du_pop'45'heap'45'before_1284 ::
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 -> T_BeforeFrontier_634
du_pop'45'heap'45'before_1284 v0 = coe C_heap'45'before_656 v0
