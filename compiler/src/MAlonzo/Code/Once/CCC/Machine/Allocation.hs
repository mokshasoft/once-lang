...
data T_AllocResult_168
  = C_constructor_182 MAlonzo.Code.Once.CCC.Machine.Locations.T_ValueLocation_12
                      MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_510
...
data T_LocStateWithAlloc_206
  = C_mkLocStateWithAlloc_218 MAlonzo.Code.Once.CCC.Machine.SMCore.T_LocState_456
                              MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_510
...
d_write'45'stack'45'slot_284 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.CCC.Machine.SMCore.d_stackMem_470 (coe v1))
         (coe v2) (coe v3) (coe v4))
      (coe MAlonzo.Code.Once.CCC.Machine.SMCore.d_heapMem_472 (coe v1))
      (coe MAlonzo.Code.Once.CCC.Machine.SMCore.d_halted_474 (coe v1))
...
du_write'45'heap'45'slot_294 v0 v1 v2
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.du_writeHeapMem_670
         (coe MAlonzo.Code.Once.CCC.Machine.SMCore.d_heapMem_472 (coe v0))
         (coe v1) (coe v2))
      (coe MAlonzo.Code.Once.CCC.Machine.SMCore.d_halted_474 (coe v0))
...
du_apply'45'bump_888 v0 v1
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.d_next'45'slot_570 (coe v1)))
      (coe
...
du_push'45'frame_1054 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_510 ->
  AgdaAny -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_510
du_push'45'frame_1054 v0 v1
  = coe
      MAlonzo.Code.Once.CCC.Machine.SMCore.C_mkAllocState_574 (coe v1)
      (coe (0 :: Integer))
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.d_next'45'heap'45'ref_572
         (coe v0))
