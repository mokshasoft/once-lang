...
d_write'45'stack'45'slot_300 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.d_writeStackMem_758 (coe v0)
...
du_apply'45'bump_912 v0 v1
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.d_next'45'slot_674 (coe v1)))
      (coe
...
du_push'45'frame_1086 ::
  MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_594 ->
  AgdaAny -> MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_594
