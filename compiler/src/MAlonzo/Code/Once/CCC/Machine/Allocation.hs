...
data T_LocStateWithAlloc_214
  = C_mkLocStateWithAlloc_226 MAlonzo.Code.Once.CCC.Machine.SMCore.T_LocState_402
                              MAlonzo.Code.Once.CCC.Machine.SMCore.T_AllocState_488
...
du_write'45'heap'45'slot_316 v0 v1 v2
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.du_writeHeapMem_770
...
du_apply'45'bump_924 v0 v1
  = coe
      ...
      (coe
         ...
         (coe v1))
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.d_frame'45'slots_572 (coe v1))
      (coe
...
du_push'45'frame_1098 v0 v1 v2
  = coe
      MAlonzo.Code.Once.CCC.Machine.SMCore.C_mkAllocState_580 (coe v1)
      (coe
