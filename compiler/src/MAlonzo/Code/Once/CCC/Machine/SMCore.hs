...
d_sucHL_160 :: T_HeapLocation_54 -> T_HeapLocation_54
d_sucHL_160 v0
  = case coe v0 of
...
d_offsetHL_166 :: T_HeapLocation_54 -> Integer -> T_HeapLocation_54
d_offsetHL_166 v0 v1
  = case coe v0 of
      C_heap'45'loc_64 v2 v3
...
d_sucLoc_176 ~v0 v1 = du_sucLoc_176 v1
du_sucLoc_176 :: T_ValueLocation_152 -> T_ValueLocation_152
du_sucLoc_176 v0
  = case coe v0 of
      C_AtStack_156 v1 v2
        -> coe
      ...
      C_AtDynamic_158 v1
        -> coe C_AtDynamic_158 (coe d_sucHL_160 (coe v1))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Machine.SMCore.offsetLoc
d_offsetLoc_186 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_ValueLocation_152 -> Integer -> T_ValueLocation_152
d_offsetLoc_186 ~v0 v1 v2 = du_offsetLoc_186 v1 v2
du_offsetLoc_186 ::
  T_ValueLocation_152 -> Integer -> T_ValueLocation_152
du_offsetLoc_186 v0 v1
  = case coe v0 of
      C_AtStack_156 v2 v3
        -> coe C_AtStack_156 (coe v2) (coe addInt (coe v1) (coe v3))
      C_AtDynamic_158 v2
        -> coe C_AtDynamic_158 (coe d_offsetHL_166 (coe v2) (coe v1))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Machine.SMCore.StackMem
d_StackMem_200 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 -> ()
d_StackMem_200 = erased
-- Once.CCC.Machine.SMCore.HeapMem
d_HeapMem_204 :: ()
d_HeapMem_204 = erased
...
d_readReg_238 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_Registers_214 -> T_AbstractReg_142 -> T_ValueLocation_152
d_readReg_238 ~v0 v1 v2 = du_readReg_238 v1 v2
du_readReg_238 ::
  T_Registers_214 -> T_AbstractReg_142 -> T_ValueLocation_152
du_readReg_238 v0 v1
  = case coe v1 of
      C_Input1_144 -> coe d_input1_226 (coe v0)
      C_Input2_146 -> coe d_input2_228 (coe v0)
      C_Output_148 -> coe d_output_230 (coe v0)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Machine.SMCore.writeReg
d_writeReg_248 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_Registers_214 ->
  T_AbstractReg_142 -> T_ValueLocation_152 -> T_Registers_214
...
d_stackMem_458 ::
  T_LocState_444 -> AgdaAny -> Integer -> Maybe T_ValueLocation_152
d_stackMem_458 v0
  = case coe v0 of
...
d_readLoc_582 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_LocState_444 -> T_ValueLocation_152 -> Maybe T_ValueLocation_152
d_readLoc_582 ~v0 v1 v2 = du_readLoc_582 v1 v2
du_readLoc_582 ::
  T_LocState_444 -> T_ValueLocation_152 -> Maybe T_ValueLocation_152
du_readLoc_582 v0 v1
  = case coe v1 of
      C_AtStack_156 v2 v3 -> coe d_stackMem_458 v0 v2 v3
      C_AtDynamic_158 v2
...
d_writeLocToStack_668 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_LocState_444 ->
  AgdaAny -> Integer -> T_ValueLocation_152 -> T_LocState_444
...
d_writeLoc_686 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_LocState_444 ->
  T_ValueLocation_152 -> T_ValueLocation_152 -> T_LocState_444
...
data T_LocSourceExt_994
  = C_Loc_998 T_ValueLocation_152 | C_IndReg_1000 T_AbstractReg_142 |
    C_IndRegSuc_1002 T_AbstractReg_142
-- Once.CCC.Machine.SMCore.resolveSourceExt
d_resolveSourceExt_1006 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_Registers_214 -> T_LocSourceExt_994 -> T_ValueLocation_152
...
du_resolveSourceExt_1006 v0 v1
  = case coe v1 of
      ...
      C_IndRegSuc_1002 v2
        -> coe du_sucLoc_176 (coe du_readReg_238 (coe v0) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Machine.SMCore.Instr
d_Instr_1022 a0 = ()
data T_Instr_1022
  = C_load_1026 T_AbstractReg_142 T_LocSourceExt_994 |
    C_store_1028 T_LocSourceExt_994 T_AbstractReg_142 |
    C_mov_1030 T_AbstractReg_142 T_AbstractReg_142
...
d_exec'45'load'45'with'45'value_1070 ::
  MAlonzo.Code.Once.CCC.FrameSemantics.T_FrameSemantics_6 ->
  T_AbstractReg_142 ->
  Maybe T_ValueLocation_152 -> T_LocState_444 -> T_LocState_444
  ...
  = case coe v0 of
      MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v3
        -> coe
             ...
             (coe
                C_mkLocState_464
                (coe du_writeReg_248 (d_regs_456 (coe v1)) (coe C_Output_148) v3)
  ...
  = case coe v0 of
      MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v3
        -> coe
             ...
             (coe
                C_mkLocState_464
                (coe du_writeReg_248 (d_regs_456 (coe v1)) (coe C_Input1_144) v3)
                (coe d_stackMem_458 (coe v1)) (coe d_heapMem_460 (coe v1))
                (coe d_halted_462 (coe v1)))
             (coe v2)
      MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
  ...
  = case coe v1 of
      C_mov'45'to'45'output_1572
        -> coe
             ...
             (coe
                C_mkLocState_464
                (coe
                   du_writeReg_248 (d_regs_456 (coe v2)) (coe C_Output_148)
                   (coe du_readReg_238 (coe d_regs_456 (coe v2)) (coe C_Input1_144)))
                (coe d_stackMem_458 (coe v2)) (coe d_heapMem_460 (coe v2))
      ...
      C_mov'45'to'45'input_1574
        -> coe
             ...
             (coe
                C_mkLocState_464
                (coe
                   du_writeReg_248 (d_regs_456 (coe v2)) (coe C_Input1_144)
                   (coe du_readReg_238 (coe d_regs_456 (coe v2)) (coe C_Output_148)))
                (coe d_stackMem_458 (coe v2)) (coe d_heapMem_460 (coe v2))
                (coe d_halted_462 (coe v2)))
             (coe v3)
      C_mov'45'output'45'to'45'input2_1576
        -> coe
             ...
             (coe
                C_mkLocState_464
                (coe
                   du_writeReg_248 (d_regs_456 (coe v2)) (coe C_Input2_146)
                   (coe du_readReg_238 (coe d_regs_456 (coe v2)) (coe C_Output_148)))
                (coe d_stackMem_458 (coe v2)) (coe d_heapMem_460 (coe v2))
                (coe d_halted_462 (coe v2)))
             (coe v3)
      C_mov'45'input2'45'to'45'output_1578
        -> coe
             ...
             (coe
                ...
                (coe
                   du_writeReg_248 (d_regs_456 (coe v2)) (coe C_Output_148)
                   (coe du_readReg_238 (coe d_regs_456 (coe v2)) (coe C_Input2_146)))
                (coe d_stackMem_458 (coe v2)) (coe d_heapMem_460 (coe v2))
                (coe d_halted_462 (coe v2)))
             (coe v3)
      C_load'45'indirect_1580
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                du_exec'45'load'45'with'45'value_1070 (coe C_Output_148)
                (coe
      ...
      C_load'45'from'45'slot_1584 v4
        -> coe
             ...
             (coe
                du_readLoc_582 (coe v2)
                (coe C_AtStack_156 (coe d_current'45'frame_532 (coe v3)) (coe v4)))
             (coe v2) (coe v3)
