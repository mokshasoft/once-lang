...
d_exec'45'sigop'45'output_2422 v0 v1 v2 v3 v4
  = coe
      ...
      (coe MAlonzo.Code.Once.SigOp.Info.d_effect_150 (coe v3)) (coe v3)
      (coe v4)
...
du_exec'45'sigop'45'halts_2438 ::
  MAlonzo.Code.Once.SigOp.Info.T_SigOpInfo_134 -> Bool
du_exec'45'sigop'45'halts_2438 v0
  = coe
      du_exec'45'sigop'45'halts'45'of_2432
      (coe MAlonzo.Code.Once.SigOp.Info.d_effect_150 (coe v0))
