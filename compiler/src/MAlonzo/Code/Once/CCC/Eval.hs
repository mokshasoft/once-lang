...
d_eval_10 ::
  ...
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_282 -> AgdaAny -> AgdaAny
d_eval_10 v0 v1 v2 v3
  = case coe v2 of
      MAlonzo.Code.Once.CCC.IR.C_id_286 -> coe v3
      MAlonzo.Code.Once.CCC.IR.C__'8728'__294 v5 v7 v8
        -> coe
             d_eval_10 (coe v5) (coe v1) (coe v7)
             (coe d_eval_10 (coe v0) (coe v5) (coe v8) (coe v3))
      MAlonzo.Code.Once.CCC.IR.C_'10216'_'44'_'10217'_302 v7 v8 v9
        -> case coe v1 of
      ...
      MAlonzo.Code.Once.CCC.IR.C_inl_320 v6
        -> coe MAlonzo.Code.Once.Semantics.Core.du_sem'45'inl_330 v3
      MAlonzo.Code.Once.CCC.IR.C_inr_326 v6
        -> coe MAlonzo.Code.Once.Semantics.Core.du_sem'45'inr_336 v3
      MAlonzo.Code.Once.CCC.IR.C_case_334 v7 v8
        -> case coe v0 of
      ...
      MAlonzo.Code.Once.CCC.IR.C_curry_352 v8 v9
        -> case coe v1 of
      ...
      MAlonzo.Code.Once.CCC.IR.C_apply_360
        -> case coe v3 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_arr_368 -> coe v3
      MAlonzo.Code.Once.CCC.IR.C_In_372 v5 v6
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v7
               -> coe
                    ...
                    (coe
                       ...
                       (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_376 v5
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v6
               -> coe
                    ...
                    (coe
                       ...
                       (coe v5) (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Cata_382 v5 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v8
               -> coe
                    ...
                    v3
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Para_388 v5 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v8
               -> coe
                    ...
                    (coe v3)
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Out_392 v5
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_ν'45'type_134 v6
               -> coe
                    ...
                    (coe
                       ...
                       (coe v5) (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_in'45'ν_396 v5 v6
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C_ν'45'type_134 v7
               -> coe
                    ...
                    (coe
                       ...
                       (coe v3))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Ana_402 v5 v7
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C_ν'45'type_134 v8
               -> coe
                    ...
                    (coe v3)
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Hylo_410 v4 v6 v7 v9 v10
        -> case coe v0 of
                    ...
                    (\ v12 ->
                       coe
                         ...
                         (coe
                            d_eval_10 (coe v0)
                            (coe
                               MAlonzo.Code.Once.Type.d_'10214'_'10215'T_162 (coe v4) (coe v0))
                            (coe v10) (coe v12)))
                    v3
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Fuse_418 v4 v6 v7 v9 v10
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v11
               -> coe
                    ...
                    (\ v12 ->
                       coe
                         ...
                         (coe
                            d_eval_10
                            (coe
                               MAlonzo.Code.Once.Type.d_'10214'_'10215'T_162 (coe v11) (coe v0))
                            (coe
                               MAlonzo.Code.Once.Type.d_'10214'_'10215'T_162 (coe v4) (coe v0))
                            (coe v10)
                            (coe
                    ...
                    v3
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_free'45'heap_420 v4 -> coe v3
      MAlonzo.Code.Once.CCC.IR.C_const_424 v5 v6 v7 -> coe v7
      MAlonzo.Code.Once.CCC.IR.C_SigOp_430 v6
        -> coe MAlonzo.Code.Once.CCC.SigOp.Info.d_semM_168 v6 v3
      _ -> MAlonzo.RTE.mazUnreachableError
