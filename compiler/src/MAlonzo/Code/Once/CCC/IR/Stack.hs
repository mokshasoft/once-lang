...
d_ir'45'stack'45'requirement_40 v0 v1 v2
  = case coe v2 of
      MAlonzo.Code.Once.CCC.IR.C_id_252 -> coe (0 :: Integer)
      ...
      MAlonzo.Code.Once.CCC.IR.C_'10216'_'44'_'10217'_268 v6 v7 v8
        -> case coe v1 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_fst_274 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_snd_280 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_inl_286 v5 -> coe d_pair'45'slots_8
      MAlonzo.Code.Once.CCC.IR.C_inr_292 v5 -> coe d_pair'45'slots_8
      MAlonzo.Code.Once.CCC.IR.C_case_300 v6 v7
        -> case coe v0 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_terminal_304 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_initial_308 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_curry_318 v7 v8 -> coe d_pair'45'slots_8
      MAlonzo.Code.Once.CCC.IR.C_apply_326 -> coe d_pair'45'slots_8
      MAlonzo.Code.Once.CCC.IR.C_arr_334 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_In_338 v4 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_342 v4 -> coe (0 :: Integer)
        ...
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C_μ'45'type_132 v7
               -> coe
                    ...
                    (coe d_pair'45'slots_8)
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_Out_358 v4 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_in'45'ν_362 v4 v5 -> coe (1 :: Integer)
      ...
      MAlonzo.Code.Once.CCC.IR.C_free'45'heap_386 v3
        -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_const_390 v4 v5 v6 -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_SigOp_396 v5 -> coe (0 :: Integer)
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v3 of
      ...
      MAlonzo.Code.Once.Functor.Translate.C_wf'45'Id_180
        -> coe
             ...
             (coe MAlonzo.Code.Once.CCC.IR.C_Cata_348 v4 v5)
  ...
  = coe
      ...
      (coe
         ...
         (d_ir'45'stack'45'requirement_40
            ...
            (coe MAlonzo.Code.Once.CCC.IR.C_Cata_348 v2 v3))
         (coe
