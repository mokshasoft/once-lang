...
d_stable'63'_106 v0 v1 v2
  = let v3 = coe MAlonzo.Code.Agda.Builtin.Bool.C_true_10 in
    coe
      (case coe v2 of
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'alloc'45'stack_2234 v4
           -> coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'reclaim'45'to_2238 v4
           -> coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'case'45'on'45'tag_2272 v4 v5
           -> coe
                MAlonzo.Code.Data.Bool.Base.d__'8743'__24
                (coe d_all'45'stable'63'_108 (coe v0) (coe v1) (coe v4))
                (coe d_all'45'stable'63'_108 (coe v0) (coe v1) (coe v5))
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'loop_2276 v4
           -> coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8
         _ -> coe v3)
                      ...
                      (coe
                         ...
                         (coe
                            ...
                            (coe
                               ...
                               (coe
                                  MAlonzo.Code.Once.CCC.Codegen.IRToTrace.du_lsize_190 (coe v8)))
                            (coe v7)))
                      (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe
                            ...
                            (coe
                               addInt
                               (coe MAlonzo.Code.Once.CCC.Codegen.IRToTrace.du_lsize_190 (coe v8))
                               (coe v7)))
                         (coe
                            d_visit'45'walk'45'stable_228 (coe v0) (coe v1) (coe v2) (coe v3)
                            (coe v4) (coe v9) (coe addInt (coe (4 :: Integer)) (coe v6))
                      ...
                      (coe
                         ...
                         (coe
                            ...
                            (coe
                               addInt (coe (2 :: Integer))
                               (coe
                                  MAlonzo.Code.Once.CCC.Codegen.IRToTrace.du_lsize_190 (coe v6)))
                            (coe v5)))
                      (coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  addInt (coe (1 :: Integer)) (coe du_cl_450 (coe v2) (coe v3))))
            (coe
               du_all'45'stable'63''45'sound_130 (coe v0) (coe v1)
               (coe
                  MAlonzo.Code.Once.CCC.Codegen.IRToTrace.du_cata'45'call_108
             ...
             MAlonzo.Code.Once.IRTy.C_μ'45'type_26 v11
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe v3) (coe (0 :: Integer)) (coe v6) (coe v10))))
                    (coe
                       du_trc_94
                       (coe
                          MAlonzo.Code.Once.CCC.Codegen.IRToTrace.d_ir'45'to'45'trace''_396
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Once.IRTy.d_'10214'_'10215'TI_68 (coe v11) (coe v3))
                       (coe v3) (coe v10) (coe (0 :: Integer)) (coe v6))
             _ -> MAlonzo.RTE.mazUnreachableError
