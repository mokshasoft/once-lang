...
data T_CataStrategy_18
  = C_strat'45'const_20 | C_strat'45'nat_22 | C_strat'45'linear_24 |
    C_strat'45'branching_26 MAlonzo.Code.Once.Type.T_Functor_106
...
d_fsize_140 :: MAlonzo.Code.Once.Type.T_Functor_106 -> Integer
d_fsize_140 v0
  = case coe v0 of
      ...
      MAlonzo.Code.Once.Type.C_K_110 v3
        -> coe
             ...
             (coe
                MAlonzo.Code.Once.CCC.Machine.SMCore.C_mov'45'to'45'output_2062)
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
      MAlonzo.Code.Once.Type.C_Id_112 -> coe d_pop2_166 (coe v0)
