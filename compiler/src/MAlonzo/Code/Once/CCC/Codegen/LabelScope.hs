...
data T_Pieces2_1930
  = C_p2nil_1940 MAlonzo.Code.Data.List.Relation.Unary.All.T_All_44 |
    C_p2cons_1956 [MAlonzo.Code.Once.CCC.Machine.SMCore.T_AbstractInstr_2212]
                  [MAlonzo.Code.Once.CCC.Machine.SMCore.T_AbstractInstr_2212]
                  [MAlonzo.Code.Once.CCC.Machine.SMCore.T_AbstractInstr_2212] Integer
                  Integer MAlonzo.Code.Data.List.Relation.Unary.All.T_All_44
                  MAlonzo.Code.Data.List.Relation.Unary.All.T_All_44
                  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
                  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
  ...
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
            (coe
               MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'thunk_2208 (coe v2)
               (coe v3)))
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
                  (coe
                     MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'ret_2210 (coe v3)))
               (coe
                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                  (coe
                     MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
                     (coe
                        MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2200 (coe v4)))
                  (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
...
du_R_2634 v0 v1 v2 v3
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'thunk_2208 (coe v1)
            (coe v2)))
      (coe
         MAlonzo.Code.Data.List.Base.du__'43''43'__32 (coe v0)
         (coe
            ...
            (coe
               MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
               (coe
                  MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'ret_2210 (coe v2)))
            (coe
               MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
               (coe
                  MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
                  (coe
                     MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2200 (coe v3)))
               (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))
...
du_tail_2660 v0 v1
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'ret_2210 (coe v0)))
      (coe
         MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
            (coe
               MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2200 (coe v1)))
         (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
...
du_tailB_3076 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'ctrl_2280
         (coe
            MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'thunk_2208
            (coe
               MAlonzo.Code.Once.CCC.Label.d_ℓ_252 (coe v0)
               (coe du_bodyL_3064 (coe v1) (coe v3)))
            (coe v2)))
