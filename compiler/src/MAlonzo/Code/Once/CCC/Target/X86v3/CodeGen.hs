...
module MAlonzo.Code.Once.CCC.Target.X86v3.CodeGen where
...
-- Once.CCC.Target.X86v3.CodeGen.id-instrs
d_id'45'instrs_10 ::
...
-- Once.CCC.Target.X86v3.CodeGen.fst-instrs
d_fst'45'instrs_12 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_fst'45'instrs_12
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Once.Target.X86.Syntax.C_rdi_20))))
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
-- Once.CCC.Target.X86v3.CodeGen.snd-instrs
d_snd'45'instrs_14 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_snd'45'instrs_14
  = coe
      ...
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
-- Once.CCC.Target.X86v3.CodeGen.terminal-instrs
d_terminal'45'instrs_16 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_terminal'45'instrs_16
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      ...
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
-- Once.CCC.Target.X86v3.CodeGen.compose-bridge
d_compose'45'bridge_18 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_compose'45'bridge_18
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         ...
         (coe
            ...
            (coe MAlonzo.Code.Once.Target.X86.Syntax.C_rax_10)))
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
-- Once.CCC.Target.X86v3.CodeGen.pair-setup
d_pair'45'setup_20 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_pair'45'setup_20
  = coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Once.Target.X86.Syntax.C_rdi_20)))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))
-- Once.CCC.Target.X86v3.CodeGen.pair-middle
d_pair'45'middle_22 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_pair'45'middle_22
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Once.Target.X86.Syntax.C_r14_38)))
         (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
-- Once.CCC.Target.X86v3.CodeGen.pair-cleanup
d_pair'45'cleanup_24 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_pair'45'cleanup_24
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe MAlonzo.Code.Once.Target.X86.Syntax.C_r14_38))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
-- Once.CCC.Target.X86v3.CodeGen.curry-closure-setup
d_curry'45'closure'45'setup_26 ::
  Integer -> [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_curry'45'closure'45'setup_26 v0
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         MAlonzo.Code.Once.Target.X86.Syntax.C_sub_66
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
-- Once.CCC.Target.X86v3.CodeGen.curry-thunk-setup
d_curry'45'thunk'45'setup_30 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_curry'45'thunk'45'setup_30
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Once.Target.X86.Syntax.C_rsp_24)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))))
-- Once.CCC.Target.X86v3.CodeGen.curry-thunk-cleanup
d_curry'45'thunk'45'cleanup_32 ::
  Integer -> [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_curry'45'thunk'45'cleanup_32 v0
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         MAlonzo.Code.Once.Target.X86.Syntax.C_mov_60
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
-- Once.CCC.Target.X86v3.CodeGen.apply-instrs
d_apply'45'instrs_36 ::
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_apply'45'instrs_36
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Once.Target.X86.Syntax.C_r15_40))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))))
-- Once.CCC.Target.X86v3.CodeGen.compile-length
d_compile'45'length_42 ::
  MAlonzo.Code.Once.Type.T_Type_32 ->
  MAlonzo.Code.Once.Type.T_Type_32 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 -> Integer
d_compile'45'length_42 v0 v1 v2
  = case coe v2 of
      MAlonzo.Code.Once.CCC.IR.C_id_16
        -> coe MAlonzo.Code.Data.List.Base.du_length_268 d_id'45'instrs_10
      MAlonzo.Code.Once.CCC.IR.C__'8728'__24 v4 v6 v7
        -> coe
             ...
             (coe
                addInt
                (coe
                   MAlonzo.Code.Data.List.Base.du_length_268 d_compose'45'bridge_18)
                (coe d_compile'45'length_42 (coe v0) (coe v4) (coe v7)))
             (coe d_compile'45'length_42 (coe v4) (coe v1) (coe v6))
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             addInt
                             (coe
                                MAlonzo.Code.Data.List.Base.du_length_268 d_pair'45'cleanup_24)
                             (coe
                                MAlonzo.Code.Data.List.Base.du_length_268 d_pair'45'middle_22))
                          (coe MAlonzo.Code.Data.List.Base.du_length_268 d_pair'45'setup_20))
                       (coe d_compile'45'length_42 (coe v0) (coe v9) (coe v6)))
                    (coe d_compile'45'length_42 (coe v0) (coe v10) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_fst'45'ir_38
        -> coe MAlonzo.Code.Data.List.Base.du_length_268 d_fst'45'instrs_12
      MAlonzo.Code.Once.CCC.IR.C_snd'45'ir_44
        -> coe MAlonzo.Code.Data.List.Base.du_length_268 d_snd'45'instrs_14
      ...
      MAlonzo.Code.Once.CCC.IR.C_case'45'ir_64 v6 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C__'43'__40 v8 v9
               -> coe
                    addInt (coe d_compile'45'length_42 (coe v8) (coe v1) (coe v6))
                    (coe d_compile'45'length_42 (coe v9) (coe v1) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_terminal_68
        -> coe
             MAlonzo.Code.Data.List.Base.du_length_268 d_terminal'45'instrs_16
      ...
      MAlonzo.Code.Once.CCC.IR.C_apply_90
        -> coe
             MAlonzo.Code.Data.List.Base.du_length_268 d_apply'45'instrs_36
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Target.X86v3.CodeGen.compile-ir
d_compile'45'ir_62 ::
  MAlonzo.Code.Once.Type.T_Type_32 ->
  MAlonzo.Code.Once.Type.T_Type_32 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  [MAlonzo.Code.Once.Target.X86.Syntax.T_Instr_58]
d_compile'45'ir_62 v0 v1 v2
  = case coe v2 of
      MAlonzo.Code.Once.CCC.IR.C_id_16 -> coe d_id'45'instrs_10
      MAlonzo.Code.Once.CCC.IR.C__'8728'__24 v4 v6 v7
        -> coe
             MAlonzo.Code.Data.List.Base.du__'43''43'__32
             (coe d_compile'45'ir_62 (coe v0) (coe v4) (coe v7))
             (coe
                MAlonzo.Code.Data.List.Base.du__'43''43'__32
                (coe d_compose'45'bridge_18)
                (coe d_compile'45'ir_62 (coe v4) (coe v1) (coe v6)))
      MAlonzo.Code.Once.CCC.IR.C_'10216'_'44'_'10217'__32 v6 v7 v8
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'42'__38 v9 v10
               -> coe
                    MAlonzo.Code.Data.List.Base.du__'43''43'__32
                    (coe d_pair'45'setup_20)
                    (coe
                       MAlonzo.Code.Data.List.Base.du__'43''43'__32
                       (coe d_compile'45'ir_62 (coe v0) (coe v9) (coe v6))
                       (coe
                          MAlonzo.Code.Data.List.Base.du__'43''43'__32
                          (coe d_pair'45'middle_22)
                          (coe
                             MAlonzo.Code.Data.List.Base.du__'43''43'__32
                             (coe d_compile'45'ir_62 (coe v0) (coe v10) (coe v7))
                             (coe d_pair'45'cleanup_24))))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_fst'45'ir_38 -> coe d_fst'45'instrs_12
      MAlonzo.Code.Once.CCC.IR.C_snd'45'ir_44 -> coe d_snd'45'instrs_14
      ...
      MAlonzo.Code.Once.CCC.IR.C_case'45'ir_64 v6 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C__'43'__40 v8 v9
               -> coe
                    MAlonzo.Code.Data.List.Base.du__'43''43'__32
                    (coe d_compile'45'ir_62 (coe v8) (coe v1) (coe v6))
                    (coe d_compile'45'ir_62 (coe v9) (coe v1) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_terminal_68
        -> coe d_terminal'45'instrs_16
        ...
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__42 v9 v10 v11
               -> coe
                    ...
                    (coe
                       MAlonzo.Code.Data.List.Base.du__'43''43'__32
                       (coe d_curry'45'thunk'45'setup_30)
                       (coe
                          MAlonzo.Code.Data.List.Base.du__'43''43'__32
                          (coe
                             d_compile'45'ir_62
                          ...
                          (coe
                             ...
                             (coe
                                ...
                                (coe v11) (coe v7)))))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_apply_90 -> coe d_apply'45'instrs_36
      MAlonzo.Code.Once.CCC.IR.C_arr_98 -> coe d_id'45'instrs_10
      MAlonzo.Code.Once.CCC.IR.C_fold'45'ir_102 v4
        -> coe d_id'45'instrs_10
