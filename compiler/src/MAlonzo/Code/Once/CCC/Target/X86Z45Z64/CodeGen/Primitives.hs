...
d_compile'45'sigOp'45'size_156 ::
  MAlonzo.Code.Once.CanonicalName.T_CanonicalName_4 -> Integer
d_compile'45'sigOp'45'size_156 ~v0
  = du_compile'45'sigOp'45'size_156
du_compile'45'sigOp'45'size_156 :: Integer
du_compile'45'sigOp'45'size_156 = coe (1 :: Integer)
-- Once.CCC.Target.X86-64.CodeGen.Primitives.compile-sigOp-length
d_compile'45'sigOp'45'length_160 ::
  MAlonzo.Code.Once.CanonicalName.T_CanonicalName_4 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'sigOp'45'length_160 = erased
-- Once.CCC.Target.X86-64.CodeGen.Primitives.compile-const
d_compile'45'const_166 ::
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_FitsInReg_196 ->
  AgdaAny ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28]
d_compile'45'const_166 ~v0 v1 v2 = du_compile'45'const_166 v1 v2
du_compile'45'const_166 ::
  MAlonzo.Code.Once.Type.T_FitsInReg_196 ->
  AgdaAny ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28]
du_compile'45'const_166 v0 v1
  = case coe v0 of
...
d_compile'45'const'45'size_174 ::
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_FitsInReg_196 -> Integer
d_compile'45'const'45'size_174 ~v0 v1
  = du_compile'45'const'45'size_174 v1
du_compile'45'const'45'size_174 ::
  MAlonzo.Code.Once.Type.T_FitsInReg_196 -> Integer
du_compile'45'const'45'size_174 v0
  = coe seq (coe v0) (coe (1 :: Integer))
-- Once.CCC.Target.X86-64.CodeGen.Primitives.compile-const-length
d_compile'45'const'45'length_182 ::
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_FitsInReg_196 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'const'45'length_182 = erased
