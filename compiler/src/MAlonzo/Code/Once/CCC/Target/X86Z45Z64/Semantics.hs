                       ...
                       (case coe v7 of
                          MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v8
                            -> coe
                                 MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                                 (coe
                                    C_mkstate_236 (coe d_writeReg_114 (d_regs_226 (coe v1)) v3 v8)
                                    (coe d_memory_228 (coe v1)) (coe d_flags_230 (coe v1))
                                    (coe addInt (coe (1 :: Integer)) (coe d_pc_232 (coe v1)))
      ...
      (:) v2 v3
        -> case coe v1 of
             ...
             _ -> let v4 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe (coe d_fetch_568 (coe v3) (coe v4))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Target.X86-64.Semantics.step-not-halted
d_step'45'not'45'halted_576 ::
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28] ->
  T_State_214 -> Maybe T_State_214
d_step'45'not'45'halted_576 v0 v1
  = let v2 = d_fetch_568 (coe v0) (coe d_pc_232 (coe v1)) in
    coe
      (case coe v2 of
...
d_step_586 v0 v1
  = coe
      ...
      (coe d_step'45'not'45'halted_576 (coe v0) (coe v1))
      ...
      _ -> let v3 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (coe
                ...
                (coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v2))
                (coe
                   d_exec'45'cont_594 (coe v3) (coe v1)
                   (coe d_step'45'not'45'halted_576 (coe v1) (coe v2))))
-- Once.CCC.Target.X86-64.Semantics.exec-cont
d_exec'45'cont_594 ::
  Integer ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28] ->
  Maybe T_State_214 -> Maybe T_State_214
d_exec'45'cont_594 v0 v1 v2
  = case coe v2 of
      MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v3
        -> coe
             MAlonzo.Code.Data.Bool.Base.du_if_then_else__44
             (coe d_halted_234 (coe v3)) (coe v2)
             (coe d_exec_592 (coe v0) (coe v1) (coe v3))
      MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Target.X86-64.Semantics.defaultFuel
d_defaultFuel_610 :: Integer
d_defaultFuel_610 = coe (10000 :: Integer)
-- Once.CCC.Target.X86-64.Semantics.run
d_run_612 ::
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28] ->
  T_State_214 -> Maybe T_State_214
d_run_612 = coe d_exec_592 (coe d_defaultFuel_610)
