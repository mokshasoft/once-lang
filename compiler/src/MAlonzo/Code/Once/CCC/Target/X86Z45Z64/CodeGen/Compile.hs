...
d_curry'45'thunk'45'setup''_34 v0
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_label_96 (coe v0))
      (coe
         MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
         (coe
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
               (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_ret_84)
               (coe
                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                  (coe
                     MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_label_96
                     (coe addInt (coe (1 :: Integer)) (coe v0)))
                  (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
-- Once.CCC.Target.X86-64.CodeGen.Compile.curry-thunk-setup
...
d_compile'45'sigOp_48 ::
  ...
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_60]
d_compile'45'sigOp_48 v0
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_call'45'sym_82
         (coe MAlonzo.Code.Once.Target.Symbol.d_once'45'symbol_8 (coe v0)))
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-sigOp-size
d_compile'45'sigOp'45'size_52 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 -> Integer
d_compile'45'sigOp'45'size_52 ~v0 = du_compile'45'sigOp'45'size_52
du_compile'45'sigOp'45'size_52 :: Integer
du_compile'45'sigOp'45'size_52 = coe (1 :: Integer)
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-sigOp-length
d_compile'45'sigOp'45'length_56 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'sigOp'45'length_56 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-const
d_compile'45'const_60 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_IsPrimitive_188 ->
  AgdaAny ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_60]
d_compile'45'const_60 ~v0 v1 v2 = du_compile'45'const_60 v1 v2
du_compile'45'const_60 ::
  MAlonzo.Code.Once.Type.T_IsPrimitive_188 ->
  AgdaAny ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_60]
du_compile'45'const_60 v0 v1
  = case coe v0 of
      MAlonzo.Code.Once.Type.C_is'45'unit_190
        -> coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16
      MAlonzo.Code.Once.Type.C_is'45'int_192
        -> coe
             MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
             (coe
                MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_mov_62
                (coe
                   ...
                   (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_rax_12))
                (coe
                   MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_imm_58 (coe v1)))
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
      MAlonzo.Code.Once.Type.C_is'45'float_194
        -> coe
             MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
             (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_ud2_92)
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
...
d_compile'45'const'45'size_66 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_IsPrimitive_188 -> Integer
d_compile'45'const'45'size_66 ~v0 v1
  = du_compile'45'const'45'size_66 v1
du_compile'45'const'45'size_66 ::
  MAlonzo.Code.Once.Type.T_IsPrimitive_188 -> Integer
du_compile'45'const'45'size_66 v0
  = case coe v0 of
...
d_compile'45'const'45'length_74 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-length
d_compile'45'length_80 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_264 -> Integer
d_compile'45'length_80 v0 v1 v2
  = case coe v2 of
      ...
      MAlonzo.Code.Once.CCC.IR.C__'8728'__276 v4 v6 v7
        -> coe
             ...
             (coe
                ...
                (coe d_compile'45'length_80 (coe v0) (coe v4) (coe v7)))
             (coe d_compile'45'length_80 (coe v4) (coe v1) (coe v6))
             ...
             MAlonzo.Code.Once.Type.C__'42'__122 v9 v10
               -> coe
                    ...
                    (coe
                       ...
                       (coe d_compile'45'length_80 (coe v0) (coe v9) (coe v6)))
                    (coe d_compile'45'length_80 (coe v0) (coe v10) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      ...
      MAlonzo.Code.Once.CCC.IR.C_inl_302 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_inr_308 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_case_316 v6 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C__'43'__124 v8 v9
               -> coe
                    addInt (coe d_compile'45'length_80 (coe v8) (coe v1) (coe v6))
                    (coe d_compile'45'length_80 (coe v9) (coe v1) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_terminal_320
        -> coe
             MAlonzo.Code.Data.List.Base.du_length_268 d_terminal'45'instrs_18
      MAlonzo.Code.Once.CCC.IR.C_initial_324 -> coe (1 :: Integer)
      ...
      MAlonzo.Code.Once.CCC.IR.C_arr_350
        -> coe MAlonzo.Code.Data.List.Base.du_length_268 d_id'45'instrs_12
      MAlonzo.Code.Once.CCC.IR.C_In_354 v4 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_358 v4 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Cata_364 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Para_370 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Out_374 v4 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_in'45'ν_378 v4 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Ana_384 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Hylo_392 v3 v5 v6 v8 v9
        -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Fuse_400 v3 v5 v6 v8 v9
        -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_free'45'heap_402 v3
        -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_const_406 v4 v5 v6
        -> coe du_compile'45'const'45'size_66 (coe v4)
      MAlonzo.Code.Once.CCC.IR.C_SigOp_412 v5
        -> coe du_compile'45'sigOp'45'size_52
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-ir'
d_compile'45'ir''_104 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_Type_108 ->
  Integer ->
  MAlonzo.Code.Once.CCC.IR.T_IR_264 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_compile'45'ir''_104 v0 v1 v2 v3
  = case coe v3 of
      MAlonzo.Code.Once.CCC.IR.C_id_268
        -> coe
        ...
        -> coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe d_compile'45'ir''_104 (coe v0) (coe v5) (coe v2) (coe v8)))
                (coe
                   MAlonzo.Code.Data.List.Base.du__'43''43'__32
                   ...
                   (coe
                      MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                      (coe
                         d_compile'45'ir''_104 (coe v5) (coe v1)
                         (coe
               ...
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                             (coe d_compile'45'ir''_104 (coe v0) (coe v10) (coe v2) (coe v7)))
                          (coe
                             MAlonzo.Code.Data.List.Base.du__'43''43'__32
                             ...
                             (coe
                                ...
                                (coe
                                   MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                                   (coe
                                      d_compile'45'ir''_104 (coe v0) (coe v11)
                                      (coe
                                         MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                         (coe
                                            d_compile'45'ir''_104 (coe v0) (coe v10) (coe v2)
                                            (coe v7)))
                                      (coe v8)))
             ...
             MAlonzo.Code.Once.Type.C__'43'__124 v9 v10
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                          (coe d_compile'45'ir''_104 (coe v9) (coe v1) (coe v2) (coe v7)))
                       (coe
                          MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                          (coe
                             d_compile'45'ir''_104 (coe v10) (coe v1)
                             (coe
                                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                (coe d_compile'45'ir''_104 (coe v9) (coe v1) (coe v2) (coe v7)))
                             (coe v8))))
      ...
      MAlonzo.Code.Once.CCC.IR.C_const_406 v5 v6 v7
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe du_compile'45'const_60 (coe v5) (coe v7)) (coe v2)
...
d_compile'45'ir_210 ::
  ...
  MAlonzo.Code.Once.CCC.IR.T_IR_264 ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_60]
d_compile'45'ir_210 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
      (coe
         d_compile'45'ir''_104 (coe v0) (coe v1) (coe (0 :: Integer))
         (coe v2))
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-ir'-length
d_compile'45'ir'''45'length_222 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_Type_108 ->
  Integer ->
  MAlonzo.Code.Once.CCC.IR.T_IR_264 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'ir'''45'length_222 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-ir-length
d_compile'45'ir'45'length_428 ::
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.Type.T_Type_108 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_264 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'ir'45'length_428 = erased
