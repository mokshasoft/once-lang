      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_rdi_22)
               (coe
                  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.d_slot'45'size_108))))
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
  ...
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_imm_58
            (coe
               MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.d_slots_110
               (coe (3 :: Integer)))))
      (coe
         MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
         (coe
...
d_curry'45'thunk'45'setup''_34 v0
  = coe
      MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_label_92 (coe v0))
      (coe
         MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
         (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                  (coe
                     MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_label_92
                     (coe addInt (coe (1 :: Integer)) (coe v0)))
                  (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
-- Once.CCC.Target.X86-64.CodeGen.Compile.curry-thunk-setup
...
d_compile'45'length_52 v0 v1 v2
  = case coe v2 of
      ...
      MAlonzo.Code.Once.CCC.IR.C__'8728'__24 v4 v6 v7
        -> coe
             ...
             (coe
                ...
                (coe d_compile'45'length_52 (coe v0) (coe v4) (coe v7)))
             (coe d_compile'45'length_52 (coe v4) (coe v1) (coe v6))
             ...
             MAlonzo.Code.Once.Type.C__'42'__52 v9 v10
               -> coe
                    ...
                    (coe
                       ...
                       (coe d_compile'45'length_52 (coe v0) (coe v9) (coe v6)))
                    (coe d_compile'45'length_52 (coe v0) (coe v10) (coe v7))
      ...
      MAlonzo.Code.Once.CCC.IR.C_case_64 v6 v7
        -> case coe v0 of
             MAlonzo.Code.Once.Type.C__'43'__54 v8 v9
               -> coe
                    addInt (coe d_compile'45'length_52 (coe v8) (coe v1) (coe v6))
                    (coe d_compile'45'length_52 (coe v9) (coe v1) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      ...
      MAlonzo.Code.Once.CCC.IR.C_applyEff_104
        -> coe
             MAlonzo.Code.Data.List.Base.du_length_268 d_apply'45'instrs_46
      MAlonzo.Code.Once.CCC.IR.C_In_108 v4 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_112 v4 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Cata_118 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Para_124 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Out_128 v4 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_in'45'ν_132 v4 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Ana_138 v4 v6 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Hylo_146 v3 v5 v6 v8 v9
        -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Fuse_154 v3 v5 v6 v8 v9
        -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_free'45'heap_156 v3
        -> coe (0 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_Prim_162 v5 -> coe (1 :: Integer)
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_compile'45'ir''_72 v0 v1 v2 v3
  = case coe v3 of
      MAlonzo.Code.Once.CCC.IR.C_id_16
        -> coe
        ...
        -> coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe d_compile'45'ir''_72 (coe v0) (coe v5) (coe v2) (coe v8)))
                (coe
                   MAlonzo.Code.Data.List.Base.du__'43''43'__32
                   ...
                   (coe
                      MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                      (coe
                         d_compile'45'ir''_72 (coe v5) (coe v1)
                         (coe
      ...
      MAlonzo.Code.Once.CCC.IR.C_'10216'_'44'_'10217'_32 v7 v8 v9
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'42'__52 v10 v11
               -> coe
                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                    (coe
                       MAlonzo.Code.Data.List.Base.du__'43''43'__32
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                             (coe d_compile'45'ir''_72 (coe v0) (coe v10) (coe v2) (coe v7)))
                          (coe
                             MAlonzo.Code.Data.List.Base.du__'43''43'__32
                             ...
                             (coe
                                ...
                                (coe
                                   MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                                   (coe
                                      d_compile'45'ir''_72 (coe v0) (coe v11)
                                      (coe
                                         MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                         (coe
                                            d_compile'45'ir''_72 (coe v0) (coe v10) (coe v2)
                                            (coe v7)))
                                      (coe v8)))
             ...
             MAlonzo.Code.Once.Type.C__'43'__54 v9 v10
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                          (coe d_compile'45'ir''_72 (coe v9) (coe v1) (coe v2) (coe v7)))
                       (coe
                          MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                          (coe
                             d_compile'45'ir''_72 (coe v10) (coe v1)
                             (coe
                                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                (coe d_compile'45'ir''_72 (coe v9) (coe v1) (coe v2) (coe v7)))
                             (coe v8))))
      ...
      MAlonzo.Code.Once.CCC.IR.C_curry_82 v8 v9
        -> case coe v1 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__56 v10 v11 v12
               -> coe
                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                    (coe
                       MAlonzo.Code.Data.List.Base.du__'43''43'__32
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                ...
                                (coe
                                   d_compile'45'ir''_72
                                   (coe MAlonzo.Code.Once.Type.C__'42'__52 (coe v0) (coe v10))
      ...
      MAlonzo.Code.Once.CCC.IR.C_applyEff_104
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe d_apply'45'instrs_46) (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_In_108 v5 v6
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe d_id'45'instrs_12)
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_112 v5
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe d_id'45'instrs_12)
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Cata_118 v5 v7
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                ...
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Para_124 v5 v7
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                ...
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Out_128 v5
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe d_id'45'instrs_12)
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_in'45'ν_132 v5 v6
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe d_id'45'instrs_12)
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Ana_138 v5 v7
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                ...
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Hylo_146 v4 v6 v7 v9 v10
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                ...
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Fuse_154 v4 v6 v7 v9 v10
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                ...
                (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
             (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_free'45'heap_156 v4
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16) (coe v2)
      MAlonzo.Code.Once.CCC.IR.C_Prim_162 v6
        -> coe
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
...
d_compile'45'ir_172 ::
  ...
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  [MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_60]
d_compile'45'ir_172 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
      (coe
         d_compile'45'ir''_72 (coe v0) (coe v1) (coe (0 :: Integer))
         (coe v2))
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-ir'-length
d_compile'45'ir'''45'length_184 ::
  MAlonzo.Code.Once.Type.T_Type_38 ->
  MAlonzo.Code.Once.Type.T_Type_38 ->
  Integer ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'ir'''45'length_184 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile.compile-ir-length
d_compile'45'ir'45'length_384 ::
  MAlonzo.Code.Once.Type.T_Type_38 ->
  MAlonzo.Code.Once.Type.T_Type_38 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'ir'45'length_384 = erased
