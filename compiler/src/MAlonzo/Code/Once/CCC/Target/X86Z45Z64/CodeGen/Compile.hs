...
d_compile'45'length_80 v0 v1 v2
  = case coe v2 of
      ...
      MAlonzo.Code.Once.CCC.IR.C_inl_312 v5 -> coe (1 :: Integer)
      MAlonzo.Code.Once.CCC.IR.C_inr_318 v5 -> coe (1 :: Integer)
      ...
      MAlonzo.Code.Once.CCC.IR.C_Cata_374 v4 v6 -> coe (1 :: Integer)
