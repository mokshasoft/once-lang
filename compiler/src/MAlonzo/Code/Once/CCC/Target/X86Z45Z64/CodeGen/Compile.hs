  ...
  = case coe v2 of
      ...
      MAlonzo.Code.Once.CCC.IR.C_'10216'_'44'_'10217'_32 v6 v7 v8
        -> case coe v1 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.CCC.IR.C_fst_38 -> coe d_fst'45'instrs_14
      MAlonzo.Code.Once.CCC.IR.C_snd_44 -> coe d_snd'45'instrs_16
      ...
      MAlonzo.Code.Once.CCC.IR.C_In_102 v4 v5 -> coe d_id'45'instrs_12
      MAlonzo.Code.Once.CCC.IR.C_out'45'μ_106 v4 -> coe d_id'45'instrs_12
      ...
      MAlonzo.Code.Once.CCC.IR.C_Para_118 v4 v6
        -> coe
             ...
             (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.C_ud2_90)
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
      MAlonzo.Code.Once.CCC.IR.C_Out_122 v4 -> coe d_id'45'instrs_12
...
d_compile'45'ir'45'length_90 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_compile'45'ir'45'length_90 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile._.pair-length-proof
d_pair'45'length'45'proof_132 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  ...
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_pair'45'length'45'proof_132 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile._.closure-setup-length
d_closure'45'setup'45'length_194 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
...
d_closure'45'setup'45'length_194 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile._.thunk-cleanup-length
d_thunk'45'cleanup'45'length_198 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Quantity_4 ->
  ...
  MAlonzo.Code.Once.CCC.IR.T_AllocMode_6 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_thunk'45'cleanup'45'length_198 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile._.curry-length-eq
d_curry'45'length'45'eq_212 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Quantity_4 ->
  ...
  MAlonzo.Code.Once.CCC.IR.T_AllocMode_6 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_curry'45'length'45'eq_212 = erased
-- Once.CCC.Target.X86-64.CodeGen.Compile._._`trans`_
d__'96'trans'96'__266 ::
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.Type.T_Type_34 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_12 ->
