...
module MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams where
...
-- Once.CCC.Target.RiscV64.RuntimeParams.rv64-runtime
d_rv64'45'runtime_10
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.CCC.Target.RiscV64.RuntimeParams.rv64-runtime"
-- Once.CCC.Target.RiscV64.RuntimeParams._.code-bounds
d_code'45'bounds_14 ::
...
d_code'45'bounds_14
  = coe
      ...
      (coe d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.RuntimeParams._.code-upper
d_code'45'upper_16 :: Integer
d_code'45'upper_16
  = coe
      MAlonzo.Code.Once.Memory.RuntimeContract.d_code'45'upper_38
      (coe d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.RuntimeParams._.heap-bounds
d_heap'45'bounds_18 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_heap'45'bounds_18
  = coe
...
d_intervals'45'disjoint_26
  = coe
      ...
      (coe d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.RuntimeParams._.prog-fits
d_prog'45'fits_28 ::
...
d_prog'45'fits_28
  = coe
      ...
      (coe d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.RuntimeParams._.stack-bounds
...
d_stack'45'bounds_30
  = coe
      ...
      (coe d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.RuntimeParams._.stack-upper
