...
module MAlonzo.Code.Once.CCC.Target.RiscV64.Layout where
...
import qualified MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams
...
-- Once.CCC.Target.RiscV64.Layout.rv64-stack-bounds
d_rv64'45'stack'45'bounds_10 ::
...
d_rv64'45'stack'45'bounds_10
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams.d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.Layout.rv64-heap-bounds
d_rv64'45'heap'45'bounds_12 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_rv64'45'heap'45'bounds_12
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams.d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.Layout.rv64-code-bounds
d_rv64'45'code'45'bounds_14 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_rv64'45'code'45'bounds_14
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams.d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.Layout.rv64-layout
d_rv64'45'layout_16 ::
...
d_rv64'45'layout_16
  = coe
      ...
      (coe d_rv64'45'stack'45'bounds_10)
      (coe d_rv64'45'heap'45'bounds_12) (coe d_rv64'45'code'45'bounds_14)
      (coe
         MAlonzo.Code.Once.Memory.RuntimeContract.d_intervals'45'disjoint_50
         (coe
            MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams.d_rv64'45'runtime_10))
-- Once.CCC.Target.RiscV64.Layout._.HeapAddr
d_HeapAddr_20 = ()
-- Once.CCC.Target.RiscV64.Layout._.HeapPointer
d_HeapPointer_24 :: ()
d_HeapPointer_24 = erased
-- Once.CCC.Target.RiscV64.Layout._.InCode
d_InCode_26 :: Integer -> ()
d_InCode_26 = erased
-- Once.CCC.Target.RiscV64.Layout._.InHeap
d_InHeap_28 :: Integer -> ()
d_InHeap_28 = erased
-- Once.CCC.Target.RiscV64.Layout._.InStack
d_InStack_30 :: Integer -> ()
d_InStack_30 = erased
-- Once.CCC.Target.RiscV64.Layout._.code-bounds
d_code'45'bounds_32 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_code'45'bounds_32
  = coe
      MAlonzo.Code.Once.Memory.Regions.d_code'45'bounds_12
      (coe d_rv64'45'layout_16)
-- Once.CCC.Target.RiscV64.Layout._.haddr
d_haddr_34 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 -> Integer
d_haddr_34 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_haddr_114 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.heap-bounds
d_heap'45'bounds_38 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_heap'45'bounds_38
  = coe
      ...
      (coe d_rv64'45'layout_16)
-- Once.CCC.Target.RiscV64.Layout._.heap-code-addr-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.heap-code-disjoint
...
d_intervals'45'disjoint_46
  = coe
      ...
      (coe d_rv64'45'layout_16)
-- Once.CCC.Target.RiscV64.Layout._.stack-bounds
...
d_stack'45'bounds_48
  = coe
      ...
      (coe d_rv64'45'layout_16)
-- Once.CCC.Target.RiscV64.Layout._.stack-code-addr-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.stack-code-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.stack-heap-addr-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.stack-heap-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.HeapAddr.haddr
d_haddr_60 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 -> Integer
d_haddr_60 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_haddr_114 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.HeapAddr.in-heap
d_in'45'heap_62 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'heap_62 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_in'45'heap_116 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.FramePreserved
d_FramePreserved_66 :: Integer -> Integer -> ()
d_FramePreserved_66 = erased
-- Once.CCC.Target.RiscV64.Layout._.StackAddr
d_StackAddr_68 = ()
-- Once.CCC.Target.RiscV64.Layout._.StackGrew
d_StackGrew_72 :: Integer -> Integer -> ()
d_StackGrew_72 = erased
-- Once.CCC.Target.RiscV64.Layout._.StackPointer
d_StackPointer_74 :: ()
d_StackPointer_74 = erased
-- Once.CCC.Target.RiscV64.Layout._.addr
d_addr_76 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_addr_76 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.frame-preserved-under-growth
...
d_frame'45'preserved'45'under'45'growth_78 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.du_rv64'45'frame'45'preserved'45'under'45'growth_90
      v3 v4
-- Once.CCC.Target.RiscV64.Layout._.from-raw-stack
...
-- Once.CCC.Target.RiscV64.Layout._.grow
d_grow_82 :: Integer -> Integer -> Integer
d_grow_82
  = coe
      MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.d_rv64'45'grow_12
-- Once.CCC.Target.RiscV64.Layout._.grow-addr-injective
...
-- Once.CCC.Target.RiscV64.Layout._.grow-identity
d_grow'45'identity_86 ::
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_grow'45'identity_86 = erased
-- Once.CCC.Target.RiscV64.Layout._.grow-injective
...
-- Once.CCC.Target.RiscV64.Layout._.in-stack
d_in'45'stack_90 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'stack_90 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_in'45'stack_22 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.init-slot-at-base
d_init'45'slot'45'at'45'base_92 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_init'45'slot'45'at'45'base_92 = erased
-- Once.CCC.Target.RiscV64.Layout._.offset-distinct
...
-- Once.CCC.Target.RiscV64.Layout._.slot-addr
d_slot'45'addr_96 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer -> Integer
d_slot'45'addr_96
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.d_rv64'45'stack'45'growth_118)
-- Once.CCC.Target.RiscV64.Layout._.slot-in-preserved-frame
...
d_slot'45'in'45'preserved'45'frame_98 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.du_rv64'45'slot'45'in'45'preserved'45'frame_108
      v0 v3
-- Once.CCC.Target.RiscV64.Layout._.slot-in-stack
...
d_slot'45'in'45'stack_100
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.d_rv64'45'stack'45'growth_118)
-- Once.CCC.Target.RiscV64.Layout._.slot-in-stack-0
...
-- Once.CCC.Target.RiscV64.Layout._.sp-distinct
...
-- Once.CCC.Target.RiscV64.Layout._.to-raw-stack
d_to'45'raw'45'stack_108 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_to'45'raw'45'stack_108 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.StackAddr.addr
d_addr_112 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_addr_112 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.StackAddr.in-stack
d_in'45'stack_114 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'stack_114 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_in'45'stack_22 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.frameSlot
d_frameSlot_118 ::
...
d_frameSlot_118
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.StackGrowth.d_rv64'45'stack'45'growth_118)
-- Once.CCC.Target.RiscV64.Layout._.stackAddr-write-preserves-code
...
-- Once.CCC.Target.RiscV64.Layout._.stackAddr-write-preserves-heap
...
-- Once.CCC.Target.RiscV64.Layout._.FrameSlotInternal.frameSlot-is-readMem
d_frameSlot'45'is'45'readMem_126 ::
  (Integer -> Maybe Integer) ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_frameSlot'45'is'45'readMem_126 = erased
-- Once.CCC.Target.RiscV64.Layout._.FrameSlotInternal.init-frame-slot-at-base
d_init'45'frame'45'slot'45'at'45'base_128 ::
  (Integer -> Maybe Integer) ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_init'45'frame'45'slot'45'at'45'base_128 = erased
-- Once.CCC.Target.RiscV64.Layout.rv64-stack-lower-zero
d_rv64'45'stack'45'lower'45'zero_130 ::
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_rv64'45'stack'45'lower'45'zero_130 = erased
-- Once.CCC.Target.RiscV64.Layout.rv64-code-lower-zero
d_rv64'45'code'45'lower'45'zero_132 ::
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_rv64'45'code'45'lower'45'zero_132 = erased
-- Once.CCC.Target.RiscV64.Layout.prog-fits-in-code
...
d_prog'45'fits'45'in'45'code_136
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.RuntimeParams.d_rv64'45'runtime_10)
-- Once.CCC.Target.RiscV64.Layout.pc-in-code
...
-- Once.CCC.Target.RiscV64.Layout._.pc≤upper
d_pc'8804'upper_154 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
...
-- Once.CCC.Target.RiscV64.Layout.stack-sub-preserves
...
-- Once.CCC.Target.RiscV64.Layout._.a∸k≤upper
...
du_a'8760'k'8804'upper_176 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe v1))
      (coe v2)
-- Once.CCC.Target.RiscV64.Layout.slot-addr-≥-base
...
du_slot'45'addr'45''8805''45'base_182 v0
  = coe
      ...
      (coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0))
-- Once.CCC.Target.RiscV64.Layout.slot-addr-next-is-base-plus-word
d_slot'45'addr'45'next'45'is'45'base'45'plus'45'word_190 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_slot'45'addr'45'next'45'is'45'base'45'plus'45'word_190 = erased
-- Once.CCC.Target.RiscV64.Layout.frame-below-slot0-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.slot0-eq
d_slot0'45'eq_216 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
...
-- Once.CCC.Target.RiscV64.Layout._.slot-k-≥-frame2
...
-- Once.CCC.Target.RiscV64.Layout._.slot0<slot-k
...
-- Once.CCC.Target.RiscV64.Layout.frame-preserved-slot0-disjoint
...
-- Once.CCC.Target.RiscV64.Layout._.word-size>0
...
du_word'45'size'62'0_246
  = coe
      ...
      (coe MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26)
-- Once.CCC.Target.RiscV64.Layout._.frame1<frame1+8
d_frame1'60'frame1'43'8_248 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_frame1'60'frame1'43'8_248 v0 ~v1 ~v2 ~v3
  = du_frame1'60'frame1'43'8_248 v0
du_frame1'60'frame1'43'8_248 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_frame1'60'frame1'43'8_248 v0
  = coe
...
-- Once.CCC.Target.RiscV64.Layout._.frame1<frame2
...
du_frame1'60'frame2_250 v0 v1
  = coe
      MAlonzo.Code.Data.Nat.Properties.du_'60''45''8804''45'trans_3134
      (coe du_frame1'60'frame1'43'8_248 (coe v0)) (coe v1)
-- Once.CCC.Target.RiscV64.Layout.slot-addr-above-thunk-fp
d_slot'45'addr'45'above'45'thunk'45'fp_260 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_slot'45'addr'45'above'45'thunk'45'fp_260 ~v0 ~v1 v2 ~v3 ~v4 ~v5
                                           ~v6
  = du_slot'45'addr'45'above'45'thunk'45'fp_260 v2
du_slot'45'addr'45'above'45'thunk'45'fp_260 ::
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_slot'45'addr'45'above'45'thunk'45'fp_260 v0
  = coe du_slot'62'fp_294 (coe v0)
-- Once.CCC.Target.RiscV64.Layout._.slot-eq
d_slot'45'eq_280 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
...
-- Once.CCC.Target.RiscV64.Layout._.slot≥rsp+8
d_slot'8805'rsp'43'8_284 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_slot'8805'rsp'43'8_284 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6
  = du_slot'8805'rsp'43'8_284 v2
du_slot'8805'rsp'43'8_284 ::
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_slot'8805'rsp'43'8_284 v0
  = coe
      MAlonzo.Code.Data.Nat.Properties.du_m'8804'm'43'n_3624
      (coe addInt (coe (8 :: Integer)) (coe v0))
-- Once.CCC.Target.RiscV64.Layout._.rsp+8>rsp
d_rsp'43'8'62'rsp_288 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_rsp'43'8'62'rsp_288 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6
  = du_rsp'43'8'62'rsp_288 v2
du_rsp'43'8'62'rsp_288 ::
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_rsp'43'8'62'rsp_288 v0
  = coe
      MAlonzo.Code.Data.Nat.Properties.du_m'60'm'43'n_3736 (coe v0)
      (coe
         MAlonzo.Code.Data.Nat.Base.C_s'8804's_34
         (coe MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26))
-- Once.CCC.Target.RiscV64.Layout._.fp≤rsp
d_fp'8804'rsp_290 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_fp'8804'rsp_290 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6
  = du_fp'8804'rsp_290 v2
du_fp'8804'rsp_290 ::
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_fp'8804'rsp_290 v0
  = coe
      MAlonzo.Code.Data.Nat.Properties.d_m'8760'n'8804'm_5184 (coe v0)
      (coe (16 :: Integer))
-- Once.CCC.Target.RiscV64.Layout._.slot>fp
d_slot'62'fp_294 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_slot'62'fp_294 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6 = du_slot'62'fp_294 v2
du_slot'62'fp_294 ::
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_slot'62'fp_294 v0
  = coe
      MAlonzo.Code.Data.Nat.Properties.du_'8804''45''60''45'trans_3128
      (coe du_fp'8804'rsp_290 (coe v0))
      (coe
         MAlonzo.Code.Data.Nat.Properties.du_'60''45''8804''45'trans_3134
         (coe du_rsp'43'8'62'rsp_288 (coe v0))
         (coe du_slot'8805'rsp'43'8_284 (coe v0)))
-- Once.CCC.Target.RiscV64.Layout.init-frame-slot-at-base
