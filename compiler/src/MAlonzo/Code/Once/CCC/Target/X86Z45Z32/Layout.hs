...
module MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Layout where
...
import qualified MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams
...
-- Once.CCC.Target.X86-32.Layout.x86-32-stack-bounds
d_x86'45'32'45'stack'45'bounds_10 ::
...
d_x86'45'32'45'stack'45'bounds_10
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams.d_x86'45'32'45'runtime_10)
-- Once.CCC.Target.X86-32.Layout.x86-32-heap-bounds
d_x86'45'32'45'heap'45'bounds_12 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_x86'45'32'45'heap'45'bounds_12
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams.d_x86'45'32'45'runtime_10)
-- Once.CCC.Target.X86-32.Layout.x86-32-code-bounds
d_x86'45'32'45'code'45'bounds_14 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_x86'45'32'45'code'45'bounds_14
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams.d_x86'45'32'45'runtime_10)
-- Once.CCC.Target.X86-32.Layout.x86-32-layout
d_x86'45'32'45'layout_16 ::
...
d_x86'45'32'45'layout_16
  = coe
      ...
      (coe d_x86'45'32'45'stack'45'bounds_10)
      (coe d_x86'45'32'45'heap'45'bounds_12)
      (coe d_x86'45'32'45'code'45'bounds_14)
      (coe
         MAlonzo.Code.Once.Memory.RuntimeContract.d_intervals'45'disjoint_50
         (coe
            MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams.d_x86'45'32'45'runtime_10))
-- Once.CCC.Target.X86-32.Layout._.HeapAddr
d_HeapAddr_20 = ()
-- Once.CCC.Target.X86-32.Layout._.HeapPointer
d_HeapPointer_24 :: ()
d_HeapPointer_24 = erased
-- Once.CCC.Target.X86-32.Layout._.InCode
d_InCode_26 :: Integer -> ()
d_InCode_26 = erased
-- Once.CCC.Target.X86-32.Layout._.InHeap
d_InHeap_28 :: Integer -> ()
d_InHeap_28 = erased
-- Once.CCC.Target.X86-32.Layout._.InStack
d_InStack_30 :: Integer -> ()
d_InStack_30 = erased
-- Once.CCC.Target.X86-32.Layout._.code-bounds
d_code'45'bounds_32 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_code'45'bounds_32
  = coe
      MAlonzo.Code.Once.Memory.Regions.d_code'45'bounds_12
      (coe d_x86'45'32'45'layout_16)
-- Once.CCC.Target.X86-32.Layout._.haddr
d_haddr_34 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 -> Integer
d_haddr_34 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_haddr_114 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.heap-bounds
d_heap'45'bounds_38 ::
  MAlonzo.Code.Once.Memory.MemoryLayoutSemantics.T_RegionBounds_8
d_heap'45'bounds_38
  = coe
      ...
      (coe d_x86'45'32'45'layout_16)
-- Once.CCC.Target.X86-32.Layout._.heap-code-addr-disjoint
...
-- Once.CCC.Target.X86-32.Layout._.heap-code-disjoint
...
d_intervals'45'disjoint_46
  = coe
      ...
      (coe d_x86'45'32'45'layout_16)
-- Once.CCC.Target.X86-32.Layout._.stack-bounds
...
d_stack'45'bounds_48
  = coe
      ...
      (coe d_x86'45'32'45'layout_16)
-- Once.CCC.Target.X86-32.Layout._.stack-code-addr-disjoint
...
-- Once.CCC.Target.X86-32.Layout._.stack-code-disjoint
...
-- Once.CCC.Target.X86-32.Layout._.stack-heap-addr-disjoint
...
-- Once.CCC.Target.X86-32.Layout._.stack-heap-disjoint
...
-- Once.CCC.Target.X86-32.Layout._.HeapAddr.haddr
d_haddr_60 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 -> Integer
d_haddr_60 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_haddr_114 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.HeapAddr.in-heap
d_in'45'heap_62 ::
  MAlonzo.Code.Once.Memory.Regions.T_HeapAddr_108 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'heap_62 v0
  = coe MAlonzo.Code.Once.Memory.Regions.d_in'45'heap_116 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.FramePreserved
d_FramePreserved_66 :: Integer -> Integer -> ()
d_FramePreserved_66 = erased
-- Once.CCC.Target.X86-32.Layout._.StackAddr
d_StackAddr_68 = ()
-- Once.CCC.Target.X86-32.Layout._.StackGrew
d_StackGrew_72 :: Integer -> Integer -> ()
d_StackGrew_72 = erased
-- Once.CCC.Target.X86-32.Layout._.StackPointer
d_StackPointer_74 :: ()
d_StackPointer_74 = erased
-- Once.CCC.Target.X86-32.Layout._.addr
d_addr_76 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_addr_76 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.frame-preserved-under-growth
...
d_frame'45'preserved'45'under'45'growth_78 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.du_x86'45'32'45'frame'45'preserved'45'under'45'growth_90
      v3 v4
-- Once.CCC.Target.X86-32.Layout._.from-raw-stack
...
-- Once.CCC.Target.X86-32.Layout._.grow
d_grow_82 :: Integer -> Integer -> Integer
d_grow_82
  = coe
      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.d_x86'45'32'45'grow_12
-- Once.CCC.Target.X86-32.Layout._.grow-addr-injective
...
-- Once.CCC.Target.X86-32.Layout._.grow-identity
d_grow'45'identity_86 ::
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_grow'45'identity_86 = erased
-- Once.CCC.Target.X86-32.Layout._.grow-injective
...
-- Once.CCC.Target.X86-32.Layout._.in-stack
d_in'45'stack_90 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'stack_90 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_in'45'stack_22 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.init-slot-at-base
d_init'45'slot'45'at'45'base_92 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_init'45'slot'45'at'45'base_92 = erased
-- Once.CCC.Target.X86-32.Layout._.offset-distinct
...
-- Once.CCC.Target.X86-32.Layout._.slot-addr
d_slot'45'addr_96 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer -> Integer
d_slot'45'addr_96
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.d_x86'45'32'45'stack'45'growth_118)
-- Once.CCC.Target.X86-32.Layout._.slot-in-preserved-frame
...
d_slot'45'in'45'preserved'45'frame_98 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.du_x86'45'32'45'slot'45'in'45'preserved'45'frame_108
      v0 v3
-- Once.CCC.Target.X86-32.Layout._.slot-in-stack
...
d_slot'45'in'45'stack_100
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.d_x86'45'32'45'stack'45'growth_118)
-- Once.CCC.Target.X86-32.Layout._.slot-in-stack-0
...
-- Once.CCC.Target.X86-32.Layout._.sp-distinct
...
-- Once.CCC.Target.X86-32.Layout._.to-raw-stack
d_to'45'raw'45'stack_108 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_to'45'raw'45'stack_108 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.StackAddr.addr
d_addr_112 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 -> Integer
d_addr_112 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_addr_20 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.StackAddr.in-stack
d_in'45'stack_114 ::
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_in'45'stack_114 v0
  = coe MAlonzo.Code.Once.Memory.StackSlots.d_in'45'stack_22 (coe v0)
-- Once.CCC.Target.X86-32.Layout._.frameSlot
d_frameSlot_118 ::
...
d_frameSlot_118
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.StackGrowth.d_x86'45'32'45'stack'45'growth_118)
-- Once.CCC.Target.X86-32.Layout._.stackAddr-write-preserves-code
...
-- Once.CCC.Target.X86-32.Layout._.stackAddr-write-preserves-heap
...
-- Once.CCC.Target.X86-32.Layout._.FrameSlotInternal.frameSlot-is-readMem
d_frameSlot'45'is'45'readMem_126 ::
  (Integer -> Maybe Integer) ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_frameSlot'45'is'45'readMem_126 = erased
-- Once.CCC.Target.X86-32.Layout._.FrameSlotInternal.init-frame-slot-at-base
d_init'45'frame'45'slot'45'at'45'base_128 ::
  (Integer -> Maybe Integer) ->
  MAlonzo.Code.Once.Memory.StackSlots.T_StackAddr_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_init'45'frame'45'slot'45'at'45'base_128 = erased
-- Once.CCC.Target.X86-32.Layout.x86-32-stack-lower-zero
d_x86'45'32'45'stack'45'lower'45'zero_130 ::
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_x86'45'32'45'stack'45'lower'45'zero_130 = erased
-- Once.CCC.Target.X86-32.Layout.x86-32-code-lower-zero
d_x86'45'32'45'code'45'lower'45'zero_132 ::
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_x86'45'32'45'code'45'lower'45'zero_132 = erased
-- Once.CCC.Target.X86-32.Layout.prog-fits-in-code
...
d_prog'45'fits'45'in'45'code_136
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.RuntimeParams.d_x86'45'32'45'runtime_10)
-- Once.CCC.Target.X86-32.Layout.pc-in-code
...
-- Once.CCC.Target.X86-32.Layout._.pc≤upper
d_pc'8804'upper_154 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
...
-- Once.CCC.Target.X86-32.Layout._.a∸k≤upper
