  ...
  = case coe v0 of
        ...
        -> coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe
                      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.d_slots_88
                      (coe v1))))
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
               ...
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_eax_12))
                       (coe
                          MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_imm_42 (coe v3)))
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
      ...
      MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'load'45'code'45'addr_2104 v1
        -> coe
             MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
             (coe
                MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_mov'45'code_80
                (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_eax_12)
                (coe v1))
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
        ...
        -> coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_eax_12))
                (coe
                   MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_imm_42 (coe v1)))
             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
      ...
      MAlonzo.Code.Once.CCC.Machine.SMCore.C_instr'45'alloc'45'heap_2112 v1
        -> coe
             ...
             (coe
                ...
                (coe
                   MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_reg_38
                   (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_esi_20)))
             (coe
                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                (coe
                   MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_add_54
             ...
             MAlonzo.Code.Once.CCC.Machine.SMCore.C_scratch'45'load'45'count_430
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_reg_38
                          (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_edi_22)))
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
        ...
        -> case coe v1 of
             MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'label_2040 v2
               -> coe
                    MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                    (coe
                       MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_label_78 (coe v2))
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
             MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'jmp_2042 v2
               -> coe
                    MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                    (coe
                       MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_jmp'45'l_82
                       (coe v2))
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
             MAlonzo.Code.Once.CCC.Machine.SMCore.C_c'45'branch'45'scratch'45'zero_2044 v2
               -> coe
                    MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                    (coe
                       MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_cmp_58
                       (coe
                          MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_reg_38
                          (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_edx_18))
                       (coe
                    ...
                    (coe
                       MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                       (coe
                          MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_je_66 (coe v2))
                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                                (coe
                                   MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_je_66 (coe v0))
                                (coe
                                   MAlonzo.Code.Data.List.Base.du__'43''43'__32
                                   (coe
                                      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                                            (coe
                                               MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_label_78
                                               (coe v0))
                                            (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))
                                      (coe
                                         MAlonzo.Code.Data.List.Base.du__'43''43'__32
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                             (coe
                                MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_label_78 (coe v0))
                             (coe
                                MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                                (coe
                                   MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_cmp_58
                                ...
                                (coe
                                   MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                                   (coe
                                      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Syntax.C_je_66
                                      (coe addInt (coe (1 :: Integer)) (coe v0)))
                                   (coe
                                      MAlonzo.Code.Data.List.Base.du__'43''43'__32
                                      (coe
