...
d_sem'45'ana'45'Out'45'id_200 ::
  MAlonzo.Code.Once.Type.T_Functor_106 ->
  MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 ->
  MAlonzo.Code.Once.Functor.Base.T_νS_246 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sem'45'ana'45'Out'45'id_200 = erased
-- Once.CCC.IR.M.sem-ana-bisim-anaS
d_sem'45'ana'45'bisim'45'anaS_202 ::
  MAlonzo.Code.Once.Type.T_Functor_106 ->
  MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 ->
  MAlonzo.Code.Once.Functor.Base.T_νS_246 ->
  MAlonzo.Code.Once.Functor.Base.T__'8764'S__688
d_sem'45'ana'45'bisim'45'anaS_202 v0 v1 v2
  = coe
      MAlonzo.Code.Once.Semantics.Core.du_sem'45'ana'45'bisim'45'anaS_1472
      v0 v2
-- Once.CCC.IR.M.sem-ana-is-anaS-unfoldS
d_sem'45'ana'45'is'45'anaS'45'unfoldS_204 ::
  MAlonzo.Code.Once.Type.T_Functor_106 ->
  MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 ->
  MAlonzo.Code.Once.Functor.Base.T_νS_246 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sem'45'ana'45'is'45'anaS'45'unfoldS_204 = erased
...
d_sem'45'fuse_228 ::
  ...
  (AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Once.Functor.Base.T_μS_230 -> AgdaAny
d_sem'45'fuse_228 v0 v1 v2 v3 v4 v5 v6
  = coe
      MAlonzo.Code.Once.Semantics.Core.du_sem'45'fuse_1130 v0 v1 v2 v3 v5
      v6
...
d_sem'45'hylo_232 ::
  ...
  (MAlonzo.Code.Once.Functor.Base.T_μS_230 -> AgdaAny) ->
  MAlonzo.Code.Once.Functor.Base.T_μS_230 -> AgdaAny
d_sem'45'hylo_232 v0 v1 v2 v3 v4 v5 v6
  = coe
      MAlonzo.Code.Once.Semantics.Core.du_sem'45'hylo_1176 v0 v1 v2 v3 v5
      v6
-- Once.CCC.IR.M.sem-hylo-is-fuse
d_sem'45'hylo'45'is'45'fuse_234 ::
  MAlonzo.Code.Once.Type.T_Functor_106 ->
  MAlonzo.Code.Once.Type.T_Functor_106 ->
  MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 ->
  MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 ->
  ...
  MAlonzo.Code.Once.Functor.Base.T_μS_230 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sem'45'hylo'45'is'45'fuse_234 = erased
...
d_sfmap'45'bisim_248 v0 v1 v2 v3 v4 v5
  = coe
      MAlonzo.Code.Once.Semantics.Core.du_sfmap'45'bisim_1410 v0 v4 v5
-- Once.CCC.IR.M.⟦_⟧
d_'10214'_'10215'_250 :: MAlonzo.Code.Once.Type.T_Type_108 -> ()
...
-- Once.CCC.IR.M.⟦μ⟧
d_'10214'μ'10215'_254 :: MAlonzo.Code.Once.Type.T_Functor_106 -> ()
d_'10214'μ'10215'_254 = erased
-- Once.CCC.IR.M.⟦ν⟧
d_'10214'ν'10215'_256 :: MAlonzo.Code.Once.Type.T_Functor_106 -> ()
...
data T_IR_264
  = C_id_268 |
    C__'8728'__276 MAlonzo.Code.Once.Type.T_Type_108 T_IR_264
                   T_IR_264 |
    C_'10216'_'44'_'10217'_284 T_IR_264 T_IR_264 T_AllocMode_258 |
    C_fst_290 | C_snd_296 | C_inl_302 T_AllocMode_258 |
    C_inr_308 T_AllocMode_258 | C_case_316 T_IR_264 T_IR_264 |
    C_terminal_320 | C_initial_324 |
    C_curry_334 T_IR_264 T_AllocMode_258 | C_apply_342 | C_arr_350 |
    C_In_354 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
             T_AllocMode_258 |
    C_out'45'μ_358 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 |
    C_Cata_364 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
               T_IR_264 |
    C_Para_370 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
               T_IR_264 |
    C_Out_374 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 |
    C_in'45'ν_378 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
                  T_AllocMode_258 |
    C_Ana_384 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
              T_IR_264 |
    C_Hylo_392 MAlonzo.Code.Once.Type.T_Functor_106
               MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
               MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 T_IR_264
               T_IR_264 |
    C_Fuse_400 MAlonzo.Code.Once.Type.T_Functor_106
               MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174
               MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_174 T_IR_264
               T_IR_264 |
    C_free'45'heap_402 MAlonzo.Code.Once.CCC.Machine.SMCore.T_HeapRef_20 |
    C_const_406 MAlonzo.Code.Once.Type.T_IsPrimitive_188 AgdaAny
                AgdaAny |
    C_SigOp_412 MAlonzo.Code.Once.CCC.SigOp.Info.T_SigOpInfo_264
