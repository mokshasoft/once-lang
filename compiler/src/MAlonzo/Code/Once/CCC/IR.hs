...
data T_IR_12
  = C_id_16 |
    ...
    C_apply_90 | C_arr_98 |
    C_In_102 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176
             T_AllocMode_6 |
    C_out'45'μ_106 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176 |
    C_Cata_112 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176
               T_IR_12 |
    C_Para_118 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176
               T_IR_12 |
    C_Out_122 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176 |
    C_in'45'ν_126 MAlonzo.Code.Once.Functor.Translate.T_WellFormedF_176
                  T_AllocMode_6 |
