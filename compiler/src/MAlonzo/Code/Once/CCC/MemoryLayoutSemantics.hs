...
module MAlonzo.Code.Once.CCC.MemoryLayoutSemantics where
...
-- Once.CCC.MemoryLayoutSemantics.Addr
d_Addr_6 :: ()
d_Addr_6 = erased
-- Once.CCC.MemoryLayoutSemantics.RegionBounds
d_RegionBounds_8 = ()
data T_RegionBounds_8
  = C_constructor_22 Integer Integer
                     MAlonzo.Code.Data.Nat.Base.T__'8804'__22
-- Once.CCC.MemoryLayoutSemantics.RegionBounds.lower
d_lower_16 :: T_RegionBounds_8 -> Integer
d_lower_16 v0
  = case coe v0 of
      C_constructor_22 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.MemoryLayoutSemantics.RegionBounds.upper
d_upper_18 :: T_RegionBounds_8 -> Integer
d_upper_18 v0
  = case coe v0 of
      C_constructor_22 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.MemoryLayoutSemantics.RegionBounds.bounds-valid
...
d_intervals'45'disjoint_50 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.MemoryLayoutSemantics.StackGrowth
d_StackGrowth_54 = ()
...
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.grow
d_grow_98 :: T_StackGrowth_54 -> Integer -> Integer -> Integer
d_grow_98 v0
  = case coe v0 of
      C_constructor_140 v1 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.grow-identity
d_grow'45'identity_102 ::
  T_StackGrowth_54 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_grow'45'identity_102 = erased
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.grow-injective
...
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.grow-addr-injective
...
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.FramePreserved
d_FramePreserved_120 ::
  T_StackGrowth_54 -> Integer -> Integer -> ()
d_FramePreserved_120 = erased
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.StackGrew
d_StackGrew_122 :: T_StackGrowth_54 -> Integer -> Integer -> ()
d_StackGrew_122 = erased
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.frame-preserved-under-growth
...
d_frame'45'preserved'45'under'45'growth_130 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.CCC.MemoryLayoutSemantics.StackGrowth.slot-in-preserved-frame
