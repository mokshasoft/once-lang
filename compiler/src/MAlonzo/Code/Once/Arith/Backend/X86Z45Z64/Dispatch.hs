...
d_step'45'instr_26 ::
  ...
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_356 ->
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28 ->
  Maybe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_356
...
d_step'45'wp_68 v0 v1 v2 v3
  = let v4
          = MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_fetch_710
              (coe v2)
              (coe
                 MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_pc_374
                 (coe v3)) in
           ...
           -> coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe v3))
                   (coe
                      MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_pc_374 (coe v3))
