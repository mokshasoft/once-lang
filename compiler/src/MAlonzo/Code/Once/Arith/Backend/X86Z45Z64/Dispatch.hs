...
module MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.Dispatch where
...
import qualified MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith
...
-- Once.Arith.Backend.X86-64.Dispatch._.ArithEnv
d_ArithEnv_16 ::
...
-- Once.Arith.Backend.X86-64.Dispatch._.dispatch-arith
d_dispatch'45'arith_18 ::
  ...
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214 ->
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214
d_dispatch'45'arith_18 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith.d_exec1_78
               (coe v0))
            (coe v1) (coe v2)))
      (coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe v0))
            (coe v1) (coe v2)))
-- Once.Arith.Backend.X86-64.Dispatch._.step-instr
d_step'45'instr_24 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214 ->
   MAlonzo.Code.Once.Target.X86Z45Z64.PhysReg.T_Reg_8 -> Integer) ->
...
d_step'45'instr_24 v0 v1 v2 v3 v4
  = let v5
    ...
    coe
      (case coe v4 of
                ...
                (case coe v7 of
                   MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v8
                     -> coe
                          ...
                          (coe d_dispatch'45'arith_18 (coe v0) (coe v8) (coe v3))
         ...
         _ -> coe v5)
-- Once.Arith.Backend.X86-64.Dispatch._.step-wp
d_step'45'wp_64 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214 ->
   MAlonzo.Code.Once.Target.X86Z45Z64.PhysReg.T_Reg_8 -> Integer) ->
    ...
    coe
      (case coe v4 of
         MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v5
           -> coe
                d_step'45'instr_24 (coe v0) (coe v1) (coe v2) (coe v3) (coe v5)
         MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
           -> coe
                MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                (coe
                   ...
                   (coe
                      ...
                      (coe v3))
                   (coe
                      MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_pc_232 (coe v3))
                   (coe MAlonzo.Code.Agda.Builtin.Bool.C_true_10))
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Once.Arith.Backend.X86-64.Dispatch._.dispatch-arith-preserves
d_dispatch'45'arith'45'preserves_94 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214 ->
   MAlonzo.Code.Once.Target.X86Z45Z64.PhysReg.T_Reg_8 -> Integer) ->
  [MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24] ->
...
d_dispatch'45'arith'45'preserves_94 v0 v1 v2 v3
  = coe
      ...
      (coe
         ...
         (coe d_P_106 (coe v0) (coe v1) (coe v2) (coe v3)))
      (coe
         MAlonzo.Code.Once.Arith.Backend.StatePreserveCore.d_mem'8776'_70
         (coe d_P_106 (coe v0) (coe v1) (coe v2) (coe v3)))
-- Once.Arith.Backend.X86-64.Dispatch._._.P
d_P_106 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_214 ->
   MAlonzo.Code.Once.Target.X86Z45Z64.PhysReg.T_Reg_8 -> Integer) ->
...
d_P_106 v0 v1 v2 v3
  = coe
      ...
      (\ v4 v5 v6 v7 v8 v9 ->
         coe
           MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith.du_exec1'45'preserves_94
           (coe v0) v4 v5 v6 v8 v9)
      (coe (\ v4 v5 v6 v7 v8 v9 -> v8)) (coe v1)
      (coe
      ...
      (coe v2) erased (coe v3)
      (coe
         MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith.d_all'45'InFrame_24
         (coe v1))
