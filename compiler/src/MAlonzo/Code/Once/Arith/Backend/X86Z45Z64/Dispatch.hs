  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith.du_exec1_68
               (coe v0))
            (coe v1) (coe v2)))
      (coe
...
d_step'45'instr_26 ::
  ...
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_348 ->
  MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Syntax.T_Instr_28 ->
  Maybe MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.T_State_348
...
d_step'45'wp_68 v0 v1 v2 v3
  = let v4
          = MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_fetch_702
              (coe v2)
              (coe
                 MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_pc_366
                 (coe v3)) in
           ...
           -> coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe v3))
                   (coe
                      MAlonzo.Code.Once.CCC.Target.X86Z45Z64.Semantics.d_pc_366 (coe v3))
...
d_P_116 v0 v1 v2 v3 v4 v5
  = coe
      ...
      (\ v6 v7 v8 v9 v10 v11 ->
         coe
           MAlonzo.Code.Once.Arith.Backend.X86Z45Z64.ExecArith.du_exec1'45'preserves_84
