...
module MAlonzo.Code.Once.Arith.Backend.RiscV64.Emit where
...
-- Once.Arith.Backend.RiscV64.Emit.arith-reg
d_arith'45'reg_10 ::
...
d_arith'45'reg_10 v0
  = case coe v0 of
      MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.C_XR0_12
        -> coe MAlonzo.Code.Once.Target.RiscV64.PhysReg.C_a3_24
      MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.C_XR1_14
        -> coe MAlonzo.Code.Once.Target.RiscV64.PhysReg.C_a4_26
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit.arith-disjoint
d_arith'45'disjoint_14 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_arith'45'disjoint_14 = erased
-- Once.Arith.Backend.RiscV64.Emit.reg-text
d_reg'45'text_16 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
...
-- Once.Arith.Backend.RiscV64.Emit.scratch-text
  ...
  = case coe v0 of
      MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.C_mk'45'scratch_22 v1
        -> coe
             ...
             ("(sp)" :: Data.Text.Text)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit.instr-text
d_instr'45'text_24 ::
...
d_instr'45'text_24 v0
  = case coe v0 of
      ...
      MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.C_Xmov'45'arg_34 v1 v2
        -> coe du_path'45'load'45'text_96 (coe v1) (coe v2)
      ...
      MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.C_Xmov'45'out_72 v1
        -> coe
             ...
             (coe
                ...
                (d_reg'45'text_16 (coe v1)) ("\n" :: Data.Text.Text))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit._.side-offset
d_side'45'offset_80 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_side'45'offset_80 ~v0 ~v1 v2 = du_side'45'offset_80 v2
du_side'45'offset_80 ::
  MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_side'45'offset_80 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit._.walk-a0-rest
d_walk'45'a0'45'rest_82 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_walk'45'a0'45'rest_82 ~v0 ~v1 v2 v3
  = du_walk'45'a0'45'rest_82 v2 v3
du_walk'45'a0'45'rest_82 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_walk'45'a0'45'rest_82 v0 v1
  = case coe v1 of
      [] -> coe ("" :: Data.Text.Text)
      (:) v2 v3
        -> let v4
                 = coe
                     MAlonzo.Code.Data.String.Base.d__'43''43'__20
                     ("    ld a0, " :: Data.Text.Text)
                     (coe
                        MAlonzo.Code.Data.String.Base.d__'43''43'__20
                        (coe du_side'45'offset_80 (coe v2))
                        (coe
                           MAlonzo.Code.Data.String.Base.d__'43''43'__20
                           ("(a0)\n" :: Data.Text.Text)
                           (coe du_walk'45'a0'45'rest_82 (coe v0) (coe v3)))) in
           coe
             (case coe v3 of
                []
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (coe du_side'45'offset_80 (coe v2)) ("(a0)\n" :: Data.Text.Text))))
                _ -> coe v4)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit._.path-load-text
d_path'45'load'45'text_96 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_path'45'load'45'text_96 ~v0 ~v1 v2 v3
  = du_path'45'load'45'text_96 v2 v3
du_path'45'load'45'text_96 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_24] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_path'45'load'45'text_96 v0 v1
  = case coe v1 of
      []
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (coe du_side'45'offset_80 (coe v2)) ("(t0)\n" :: Data.Text.Text))))
                _ -> coe v4)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit.program-text
d_program'45'text_162 ::
  [MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_program'45'text_162 v0
  = case coe v0 of
      [] -> coe ("" :: Data.Text.Text)
      (:) v1 v2
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             (d_instr'45'text_24 (coe v1)) (d_program'45'text_162 (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.Backend.RiscV64.Emit.emit-arith-block
d_emit'45'arith'45'block_170 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.Arith.Machine.IR.T_ArithBlock_142 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_emit'45'arith'45'block_170 v0 v1
  = case coe v1 of
      MAlonzo.Code.Once.Arith.Machine.IR.C_mk'45'block_156 v2 v3 v4
        -> case coe v3 of
                             ...
                             (coe
                                ...
                                (mulInt
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Once.Arith.Machine.Compile.du_normalize_292
                                         (coe v4)))))
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                ("\n" :: Data.Text.Text)
                                (coe
                                   ...
                                   (d_program'45'text_162
                                      (coe
                                         ...
                                         (coe
                                            MAlonzo.Code.Once.Arith.Machine.Compile.du_compile'45'abs_262
                                            (coe v3)
                                            (coe
                                               MAlonzo.Code.Once.Arith.Machine.Compile.du_normalize_292
                                               (coe v4)))))
...
d_arith'45'block'45'symbol_200 ::
  MAlonzo.Code.Once.Arith.Machine.IR.T_ArithBlock_142 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_arith'45'block'45'symbol_200 v0
  = coe
      MAlonzo.Code.Once.Target.Symbol.d_once'45'symbol'45'own_56
      (coe
         MAlonzo.Code.Once.Arith.SigOp.Block.du_block'45'name_342
         (coe
            MAlonzo.Code.Once.Arith.Machine.IR.d_block'45'body_154 (coe v0)))
-- Once.Arith.Backend.RiscV64.Emit.emit-arith-blocks
d_emit'45'arith'45'blocks_204 ::
  [MAlonzo.Code.Once.Arith.Machine.IR.T_ArithBlock_142] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_emit'45'arith'45'blocks_204 v0
  = case coe v0 of
      [] -> coe ("" :: Data.Text.Text)
      (:) v1 v2
        -> coe
             ...
             (coe
                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                (d_arith'45'block'45'symbol_200 (coe v1))
                (coe
                   MAlonzo.Code.Data.String.Base.d__'43''43'__20
                   ("\n" :: Data.Text.Text)
                   (coe
                      MAlonzo.Code.Data.String.Base.d__'43''43'__20
                      (d_emit'45'arith'45'block_170
                         (coe d_arith'45'block'45'symbol_200 (coe v1)) (coe v1))
                      (d_emit'45'arith'45'blocks_204 (coe v2)))))
      _ -> MAlonzo.RTE.mazUnreachableError
