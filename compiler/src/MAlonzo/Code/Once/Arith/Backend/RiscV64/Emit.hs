...
d_walk'45'a0'45'rest_44 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_walk'45'a0'45'rest_44 ~v0 ~v1 v2 v3
  = du_walk'45'a0'45'rest_44 v2 v3
du_walk'45'a0'45'rest_44 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_walk'45'a0'45'rest_44 v0 v1
  = case coe v1 of
      [] -> coe ("" :: Data.Text.Text)
      (:) v2 v3
        -> let v4
                 = coe
                     ...
                     (coe
                        ...
                        (coe
                           MAlonzo.Code.Data.String.Base.d__'43''43'__20
                           ("(a0)\n" :: Data.Text.Text)
                           (coe du_walk'45'a0'45'rest_44 (coe v0) (coe v3)))) in
           coe
             (case coe v3 of
                []
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (coe du_side'45'offset_42 (coe v2)) ("(a0)\n" :: Data.Text.Text))))
                _ -> coe v4)
      _ -> MAlonzo.RTE.mazUnreachableError
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (coe du_side'45'offset_42 (coe v2)) ("(t0)\n" :: Data.Text.Text))))
                _ -> coe v4)
      _ -> MAlonzo.RTE.mazUnreachableError
