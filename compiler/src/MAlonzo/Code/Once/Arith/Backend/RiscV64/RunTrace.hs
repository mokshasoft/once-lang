...
module MAlonzo.Code.Once.Arith.Backend.RiscV64.RunTrace where
...
-- Once.Arith.Backend.RiscV64.RunTrace.matchCall
d_matchCall_10 ::
...
d_ret'45'past_14 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_pc_408 (coe v0)))
      (coe
...
d_run'45'events_30 v0
  = coe
      ...
      (coe
         (\ v1 ->
            MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_pc_408 (coe v1)))
      (coe MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_fetch_474)
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_execInstr_532)
...
d_run'45'events'45'exec_38 ::
  ...
  [MAlonzo.Code.Once.CCC.Target.RiscV64.Syntax.T_Instr_10] ->
  MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
  Maybe MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
  [MAlonzo.Code.Once.Denotation.Trace.T_SigOpEvent_118]
d_run'45'events'45'exec_38 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (coe
         (\ v7 ->
            MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_pc_408 (coe v7)))
      (coe MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_fetch_474)
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_execInstr_532)
      (coe d_matchCall_10) (coe d_ret'45'past_14)
