...
module MAlonzo.Code.Once.Arith.Backend.RiscV64.ExecArith where
...
-- Once.Arith.Backend.RiscV64.ExecArith.InFrame
d_InFrame_10 ::
  Integer ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 -> ()
d_InFrame_10 = erased
-- Once.Arith.Backend.RiscV64.ExecArith._.scratch-addr
...
-- Once.Arith.Backend.RiscV64.ExecArith._.frontier
d_frontier_32 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
   MAlonzo.Code.Once.Target.RiscV64.PhysReg.T_Reg_8 -> Integer) ->
...
du_frontier_32 v0 v1
  = coe
      ...
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_readReg_244
         (coe
            MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_regs_404 (coe v1))
         (coe MAlonzo.Code.Once.Target.RiscV64.PhysReg.C_sp_14))
      (coe v0)
-- Once.Arith.Backend.RiscV64.ExecArith._.scratch-below
...
du_scratch'45'below_44 v0 v1
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Once.Target.RiscV64.PhysReg.C_sp_14))
      (coe v1)
-- Once.Arith.Backend.RiscV64.ExecArith._.exec1
d_exec1_68 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
   MAlonzo.Code.Once.Target.RiscV64.PhysReg.T_Reg_8 -> Integer) ->
...
du_exec1_68 v0 v1 v2
  = coe
      ...
      (coe
         ...
         MAlonzo.Code.Once.Arith.Backend.RiscV64.Confine.d_writes_10 v1
         (coe v0 v1 v2)
      ...
      (coe
         ...
         (coe
            (\ v3 ->
               MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_regs_404
                 (coe v3)))
         (coe MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_readReg_244)
         (coe MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_writeMem_384)
         (coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_pc_408 (coe v2)))
      (coe
         MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_halted_410
         (coe v2))
-- Once.Arith.Backend.RiscV64.ExecArith._.Valid
d_Valid_74 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
   MAlonzo.Code.Once.Target.RiscV64.PhysReg.T_Reg_8 -> Integer) ->
  ...
  Integer -> ()
d_Valid_74 = erased
-- Once.Arith.Backend.RiscV64.ExecArith._.exec1-preserves
...
du_exec1'45'preserves_84 v0 v1 v2 v3 v4 v5
  = coe
      ...
      (coe
         ...
         MAlonzo.Code.Once.Arith.Backend.RiscV64.Confine.d_confined_58 v1
         (coe v0 v1 v2)
         (MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.d_regs_404
            (coe v2)))
      (coe
...
-- Once.Arith.Backend.RiscV64.ExecArith._.frontier-inv
...
-- Once.Arith.Backend.RiscV64.ExecArith._.valid-inv
d_valid'45'inv_122 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
   MAlonzo.Code.Once.Target.RiscV64.PhysReg.T_Reg_8 -> Integer) ->
...
-- Once.Arith.Backend.RiscV64.ExecArith._._.exec-block
d_exec'45'block_134 ::
  (MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
   MAlonzo.Code.Once.CCC.Target.RiscV64.Semantics.T_State_394 ->
   MAlonzo.Code.Once.Target.RiscV64.PhysReg.T_Reg_8 -> Integer) ->
...
-- Once.Arith.Backend.RiscV64.ExecArith._._.exec-block-preserves
