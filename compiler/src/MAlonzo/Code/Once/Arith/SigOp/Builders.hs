...
d_sem'45'fuse_104 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      v6
-- Once.Arith.SigOp.Builders.M.sem-fuse-events
...
d_sem'45'hylo_110 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      v6
-- Once.Arith.SigOp.Builders.M.sem-hylo-events
...
d_mul'45'semM_150 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer
d_mul'45'semM_150 v0
  = case coe v0 of
      MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v1 v2
        -> coe mulInt (coe v1) (coe v2)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.SigOp.Builders.neg-semM
d_neg'45'semM_156 :: Integer -> Integer
d_neg'45'semM_156 ~v0 = du_neg'45'semM_156
du_neg'45'semM_156 :: Integer
du_neg'45'semM_156 = coe (0 :: Integer)
...
d_str'45'lit'45'semM_174 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.Unit.T_'8868'_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_str'45'lit'45'semM_174 v0 ~v1 = du_str'45'lit'45'semM_174 v0
du_str'45'lit'45'semM_174 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_str'45'lit'45'semM_174 v0 = coe v0
...
d_add'45'info_178
  = coe
      ...
      (coe ("arith.add.int" :: Data.Text.Text)) (coe d_add'45'semM_138)
...
d_sub'45'info_180
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.sub.int" :: Data.Text.Text)) (coe d_sub'45'semM_144)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_mul'45'info_182
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.mul.int" :: Data.Text.Text)) (coe d_mul'45'semM_150)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_div'45'info_184
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.div.int" :: Data.Text.Text)) (coe d_div'45'semM_158)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_mod'45'info_186
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.mod.int" :: Data.Text.Text)) (coe d_mod'45'semM_160)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_lt'45'info_190
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.lt.int" :: Data.Text.Text)) (coe d_lt'45'semM_162)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_le'45'info_192
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.le.int" :: Data.Text.Text)) (coe d_le'45'semM_164)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_gt'45'info_194
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.gt.int" :: Data.Text.Text)) (coe d_gt'45'semM_166)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_ge'45'info_196
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.ge.int" :: Data.Text.Text)) (coe d_ge'45'semM_168)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_eq'45'info_198
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.eq.int" :: Data.Text.Text)) (coe d_eq'45'semM_170)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
...
d_ne'45'info_200
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe ("arith.ne.int" :: Data.Text.Text)) (coe d_ne'45'semM_172)
      (coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144)
-- Once.Arith.SigOp.Builders.str-lit-info
d_str'45'lit'45'info_202 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.CCC.SigOp.Info.T_SigOpInfo_154
d_str'45'lit'45'info_202 v0
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172
      (coe
...
d_generic'45'semM_210
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Arith.SigOp.Builders.generic-semM"
-- Once.Arith.SigOp.Builders.classify-name
d_classify'45'name_214 ::
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.CCC.SigOp.Info.T_EffectShape_140
d_classify'45'name_214 v0 v1
  = let v2 = coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Pure_144 in
    coe
      (case coe v0 of
         MAlonzo.Code.Once.Type.C_Unit_122
           -> case coe v1 of
                l | (==) l ("linux.exit" :: Data.Text.Text) ->
                    coe MAlonzo.Code.Once.CCC.SigOp.Info.C_Halts_148
                _ -> coe v2
         _ -> coe v2)
-- Once.Arith.SigOp.Builders.generic-info
d_generic'45'info_220 ::
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.CCC.SigOp.Info.T_SigOpInfo_154
d_generic'45'info_220 v0 v1 v2
  = coe
      MAlonzo.Code.Once.CCC.SigOp.Info.C_mk'45'info_172 (coe v2)
      (coe d_generic'45'semM_210 v0 v1 v2)
      (coe d_classify'45'name_214 (coe v1) (coe v2))
...
d_arrow'45'info_236 ::
  ...
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.CCC.SigOp.Info.T_SigOpInfo_154
d_arrow'45'info_236 v0 v1 v2 v3
  = case coe v2 of
      MAlonzo.Code.Once.Type.C_mk'45'kind_50 v4 v5
        -> case coe v5 of
             MAlonzo.Code.Once.Type.C_pure_34
               -> coe d_value'45'info_228 (coe v0) (coe v1) (coe v3)
             MAlonzo.Code.Once.Type.C_eff_36
               -> coe d_generic'45'info_220 (coe v0) (coe v1) (coe v3)
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
