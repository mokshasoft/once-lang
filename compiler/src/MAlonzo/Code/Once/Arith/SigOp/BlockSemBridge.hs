...
d__'8801''695'__138 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  Integer -> Integer -> Bool
d__'8801''695'__138 ~v0 = du__'8801''695'__138
...
d_'37''738''45'in'45'range_148 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_'37''738''45'in'45'range_148 v0 v1 v2 v3 v4 v5
  = coe
...
d_'47''738''45'in'45'range_158 v0 v1 v2 v3 v4
  = coe
...
d_0'60'modulus_170 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_0'60'modulus_170 ~v0 = du_0'60'modulus_170
...
d_Word_184 :: MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 -> ()
d_Word_184 = erased
...
d_half'60'modulus_198 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_half'60'modulus_198 v0 v1 v2
  = coe
...
d_half'8804'negOne_202 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_half'8804'negOne_202 v0 v1 v2
  = coe
...
d_lit'45'hi_208 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_lit'45'hi_208 ~v0 = du_lit'45'hi_208
du_lit'45'hi_208 ::
  Integer ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  Integer ->
...
d_lit'45'lo_210 ::
  ...
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_lit'45'lo_210 v0 v1 v2 v3 v4
  = coe
...
d_negOne'60'modulus_224 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_negOne'60'modulus_224 v0 v1 v2
  = coe
...
d_'8854''8801''8760'_272 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8854''8801''8760'_272 = erased
-- Once.Arith.SigOp.BlockSemBridge._.W.⊗-pow2
d_'8855''45'pow2_274 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  Integer ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8855''45'pow2_274 = erased
...
d_'8861'__276 v0
  = coe
      ...
      (coe MAlonzo.Code.Once.Target.Arch.d_int'45'bits_22 (coe v0))
-- Once.Arith.SigOp.BlockSemBridge._.W.⊝-fromℤ
d_'8861''45'fromℤ_278 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8861''45'fromℤ_278 = erased
-- Once.Arith.SigOp.BlockSemBridge._.W.⊝-intMin
d_'8861''45'intMin_280 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  Integer ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8861''45'intMin_280 = erased
-- Once.Arith.SigOp.BlockSemBridge._.W.⊝-invol-norm
d_'8861''45'invol'45'norm_282 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8861''45'invol'45'norm_282 = erased
-- Once.Arith.SigOp.BlockSemBridge._.toWord
d_toWord_286 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  AgdaAny -> AgdaAny
d_toWord_286 v0 v1 v2
  = case coe v1 of
        ...
        -> case coe v2 of
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v5 v6
               -> coe
                    ...
                    (coe d_toWord_286 (coe v0) (coe v3) (coe v5))
                    (coe d_toWord_286 (coe v0) (coe v4) (coe v6))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Arith.SigOp.BlockSemBridge._.project-commute
d_project'45'commute_304 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_project'45'commute_304 = erased
-- Once.Arith.SigOp.BlockSemBridge._.ainput-leaf
d_ainput'45'leaf_348 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_ainput'45'leaf_348 = erased
-- Once.Arith.SigOp.BlockSemBridge._.eval≡semM
d_eval'8801'semM_380 ::
  MAlonzo.Code.Once.Target.Arch.T_TargetNum_14 ->
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  MAlonzo.Code.Once.Arith.Machine.IR.T_MArithIR_10 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_eval'8801'semM_380 = erased
