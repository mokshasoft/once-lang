...
d_funType_96 :: T_FunInfo_84 -> MAlonzo.Code.Once.Type.T_Type_108
d_funType_96 v0
  = case coe v0 of
...
d_pfunType_116 ::
  T_PolyFunInfo_104 -> MAlonzo.Code.Once.Type.T_PolyType_238
d_pfunType_116 v0
  = case coe v0 of
...
d_projectSig_124 v0 v1 v2
  = let v3 = MAlonzo.Code.Once.Type.d_isGround_420 (coe v2) in
    coe
      (case coe v3 of
         MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v4
           -> coe
                ...
                (coe
                   ...
                   (coe MAlonzo.Code.Once.Type.d_extractGround_314 (coe v2) (coe v4)))
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe
                            MAlonzo.Code.Data.String.Base.d__'43''43'__20
                            (MAlonzo.Code.Once.Type.d_showPolyType_578 (coe v2))
                            (coe
                               MAlonzo.Code.Data.String.Base.d__'43''43'__20
           ...
           coe
             (case coe v3 of
                MAlonzo.Code.Once.Parser.Module.Core.C_DTypeSig_34 v6 v7
                  -> let v8 = MAlonzo.Code.Once.Type.d_isGround_420 (coe v7) in
                     coe
                       (case coe v8 of
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             ...
                                             (coe v0)
                                             (coe
                                                MAlonzo.Code.Once.Type.d_extractGround_314 (coe v7)
                                                (coe v9))))))
                ...
                MAlonzo.Code.Once.Parser.Module.Core.C_DSignature_38 v6 v7 v8
                  -> case coe v7 of
                       MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v9
                         -> let v10 = MAlonzo.Code.Once.Type.d_isGround_420 (coe v8) in
                            coe
                              (let v11
                                     = coe
                               ...
                               coe
                                 (case coe v10 of
                                    MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v12
                                      -> let v13
                                               = MAlonzo.Code.Once.Parser.TypeAlias.d_expandAliases_48
                                                   (coe v0)
                                                   (coe
                                                      MAlonzo.Code.Once.Type.d_extractGround_314
                                                      (coe v8) (coe v12)) in
                                         coe
                                           (coe
                                              du_consFun_164
                                           ...
                                           (coe
                                              ...
                                              (coe
                                                 ...
                                                 (coe
                                                    ...
                                                    (coe
                                                       MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                                       (MAlonzo.Code.Once.Type.d_showPolyType_578
                                                          (coe v8))
                                                       (coe
                                                          MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                                          (" \8212 primitives and type aliases must be ground. "
                                    ...
                                    _ -> MAlonzo.RTE.mazUnreachableError))
                       MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
                         -> let v9 = MAlonzo.Code.Once.Type.d_isGround_420 (coe v8) in
                            coe
                              (case coe v9 of
