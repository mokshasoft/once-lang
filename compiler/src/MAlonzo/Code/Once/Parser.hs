...
d_FunInfo_84 = ()
data T_FunInfo_84
  = C_mkFunInfo_102 MAlonzo.Code.Agda.Builtin.String.T_String_6
...
d_funName_94 v0
  = case coe v0 of
      C_mkFunInfo_102 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Parser.FunInfo.funType
d_funType_96 :: T_FunInfo_84 -> MAlonzo.Code.Once.Type.T_Type_38
d_funType_96 v0
  = case coe v0 of
      C_mkFunInfo_102 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_funAlloc_98 v0
  = case coe v0 of
      C_mkFunInfo_102 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_funBody_100 v0
  = case coe v0 of
      C_mkFunInfo_102 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Parser.PolyFunInfo
d_PolyFunInfo_104 = ()
data T_PolyFunInfo_104
  = C_mkPolyFunInfo_122 MAlonzo.Code.Agda.Builtin.String.T_String_6
                        MAlonzo.Code.Once.Type.T_PolyType_170
                        (Maybe MAlonzo.Code.Once.Parser.Module.Core.T_AllocStrategy_8)
                        MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34
-- Once.Parser.PolyFunInfo.pfunName
d_pfunName_114 ::
  T_PolyFunInfo_104 -> MAlonzo.Code.Agda.Builtin.String.T_String_6
d_pfunName_114 v0
  = case coe v0 of
      C_mkPolyFunInfo_122 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Parser.PolyFunInfo.pfunType
d_pfunType_116 ::
  T_PolyFunInfo_104 -> MAlonzo.Code.Once.Type.T_PolyType_170
d_pfunType_116 v0
  = case coe v0 of
      C_mkPolyFunInfo_122 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pfunAlloc_118 v0
  = case coe v0 of
      C_mkPolyFunInfo_122 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Once.Parser.PolyFunInfo.pfunBody
d_pfunBody_120 ::
  T_PolyFunInfo_104 -> MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34
d_pfunBody_120 v0
  = case coe v0 of
      C_mkPolyFunInfo_122 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_projectSig_124 ::
  ...
  MAlonzo.Code.Once.Type.T_PolyType_170 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_projectSig_124 v0 v1 v2
  = let v3 = MAlonzo.Code.Once.Type.d_isGround_352 (coe v2) in
    coe
      (case coe v3 of
         MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v4
           -> coe
                ...
                (coe
                   ...
                   (coe MAlonzo.Code.Once.Type.d_extractGround_246 (coe v2) (coe v4)))
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe
                            MAlonzo.Code.Data.String.Base.d__'43''43'__20
                            (MAlonzo.Code.Once.Type.d_showPolyType_510 (coe v2))
                            (coe
                               MAlonzo.Code.Data.String.Base.d__'43''43'__20
...
d_PendingSig_150 :: ()
d_PendingSig_150 = erased
-- Once.Parser.extractFunctions
d_extractFunctions_152 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_extractFunctions_152 v0 v1
  = case coe v1 of
      MAlonzo.Code.Once.Parser.Module.Core.C_mkModule_50 v2
        -> coe
             du_go_184 (coe v0) (coe v2)
...
d_consFun_164 ~v0 ~v1 v2 v3 = du_consFun_164 v2 v3
du_consFun_164 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  T_FunInfo_84 -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30
du_consFun_164 v0 v1
  = case coe v0 of
...
d_consPoly_174 ::
  ...
  [MAlonzo.Code.Once.Parser.Module.Core.T_Decl_32] ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  T_PolyFunInfo_104 -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_consPoly_174 ~v0 ~v1 v2 v3 = du_consPoly_174 v2 v3
du_consPoly_174 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  T_PolyFunInfo_104 -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30
du_consPoly_174 v0 v1
  = case coe v0 of
      MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v2 -> coe v0
      MAlonzo.Code.Data.Sum.Base.C_inj'8322'_42 v2
        -> case coe v2 of
...
d_go_184 ::
  ...
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_go_184 v0 ~v1 v2 v3 = du_go_184 v0 v2 v3
du_go_184 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Once.Parser.Module.Core.T_Decl_32] ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
du_go_184 v0 v1 v2
  = case coe v1 of
      ...
      (:) v3 v4
        -> let v5 = coe du_go_184 (coe v0) (coe v4) (coe v2) in
           coe
             (case coe v3 of
                MAlonzo.Code.Once.Parser.Module.Core.C_DTypeSig_34 v6 v7
                  -> let v8 = MAlonzo.Code.Once.Type.d_isGround_352 (coe v7) in
                     coe
                       (case coe v8 of
                          MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v9
                            -> coe
                                 du_go_184 (coe v0) (coe v4)
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             ...
                                             (coe v0)
                                             (coe
                                                MAlonzo.Code.Once.Type.d_extractGround_246 (coe v7)
                                                (coe v9))))))
                ...
                MAlonzo.Code.Once.Parser.Module.Core.C_DPrimitive_38 v6 v7 v8
                  -> case coe v7 of
                       MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v9
                         -> let v10 = MAlonzo.Code.Once.Type.d_isGround_352 (coe v8) in
                            coe
                              (let v11
                                     = coe
                               ...
                               coe
                                 (case coe v10 of
                                    MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v12
                                      -> let v13
                                               = MAlonzo.Code.Once.Parser.TypeAlias.d_expandAliases_48
                                                   (coe v0)
                                                   (coe
                                                      MAlonzo.Code.Once.Type.d_extractGround_246
                                                      (coe v8) (coe v12)) in
                                         coe
                                           (coe
                                              du_consFun_164
                                    ...
                                    _ -> MAlonzo.RTE.mazUnreachableError))
                       MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
                         -> let v9 = MAlonzo.Code.Once.Type.d_isGround_352 (coe v8) in
                            coe
                              (case coe v9 of
                                 MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v10
                                   -> let v11
                                      ...
                                      coe
                                        (coe
                                           du_consFun_164 (coe du_go_184 (coe v0) (coe v4) (coe v7))
                                           (coe
                                              C_mkFunInfo_102 (coe v6) (coe v11) (coe v7)
                                              (coe
                                                 MAlonzo.Code.Once.TypeCheck.Raw.C_RVar_36
                                                 (coe v6))))
...
d_inlineAll_356 :: Integer -> [T_FunInfo_84] -> [T_FunInfo_84]
d_inlineAll_356 v0 v1
  = coe
      du_go_366 (coe v0)
...
d_go_366 v0 ~v1 v2 v3 = du_go_366 v0 v2 v3
du_go_366 ::
  Integer ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [T_FunInfo_84] -> [T_FunInfo_84]
             ...
             C_mkFunInfo_102 v5 v6 v7 v8
               -> coe
                    ...
                    (coe
                       C_mkFunInfo_102 (coe v5) (coe v6) (coe v7)
                       (coe
                          MAlonzo.Code.Once.Parser.Inline.d_betaReduceApps_468 (coe v0)
                          (coe
                             MAlonzo.Code.Once.Parser.Inline.d_expandBuiltins_182
                             (coe
                                MAlonzo.Code.Once.Parser.Inline.d_inlineReferences_68 (coe v0)
                                (coe v1) (coe v8)))))
                    (coe
