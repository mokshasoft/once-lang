...
d_resolveExpr'45'sigOp'45'closure'45'faithful_20
  = error
...
d_resolveExpr'45'poly'45'splice'45'faithful_58
  = error
...
d_resolveExpr'45'poly'45'faithful_86 ::
  Integer ->
...
d_resolveExpr'45'poly'45'faithful_86 = erased
-- Once.Adequacy.ResolveFaithful.bind2-faithful
d_bind2'45'faithful_210 ::
  () ->
  () ->
  ...
  (AgdaAny ->
   Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_bind2'45'faithful_210 = erased
-- Once.Adequacy.ResolveFaithful.resolveExpr-faithful
d_resolveExpr'45'faithful_256 ::
  Integer ->
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  ...
  AgdaAny ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_resolveExpr'45'faithful_256 = erased
