...
d_noImports'63'_16 v0
  = case coe v0 of
      ...
      (:) v1 v2
        -> case coe v1 of
             MAlonzo.Code.Once.Parser.Module.Core.C_DTypeSig_22 v3 v4
               -> let v5 = d_noImports'63'_16 (coe v2) in
                  coe
                    (case coe v5 of
                       ...
                       _ -> MAlonzo.RTE.mazUnreachableError)
             MAlonzo.Code.Once.Parser.Module.Core.C_DFunDef_24 v3 v4
               -> let v5 = d_noImports'63'_16 (coe v2) in
                  coe
                    (case coe v5 of
                       MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v6 v7
                         ...
                         -> if coe v7
                              then case coe v8 of
                                     ...
                                     (coe
                                        ...
                                        (coe MAlonzo.Code.Relation.Nullary.Reflects.C_of'8319'_26))
                       _ -> MAlonzo.RTE.mazUnreachableError)
             MAlonzo.Code.Once.Parser.Module.Core.C_DImport_30 v3
               -> coe
                    MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32
