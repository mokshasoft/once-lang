...
d_resolver'45'preserves'45'typing'45'imports_16
  = error
...
d_canon'45'preserves'45'typing_28 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_canon'45'preserves'45'typing_28 v0 v1 v2 v3
  = coe
      d_go_50 (coe v0) (coe v1) (coe v2) (coe v3)
      (coe
...
d_ds_42 ~v0 v1 ~v2 ~v3 = du_ds_42 v1
du_ds_42 ::
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  [MAlonzo.Code.Once.Parser.Module.Core.T_Decl_32]
du_ds_42 v0
             ...
             then coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Once.Adequacy.CanonModuleTyped.d_module'45'typed'45'and'45'valid_354
                             (coe du_ds_42 (coe v1)) (coe v2) (coe v3))))
             else coe
                    seq (coe v6)
                    (coe d_resolver'45'preserves'45'typing'45'imports_16 v0 v1 v2 v3)
