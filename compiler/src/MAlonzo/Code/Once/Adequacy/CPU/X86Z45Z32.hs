...
d_run'45'trace'45'x86'45'32_14 v0 v1
  = coe
      ...
      (coe
         (\ v2 ->
            MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.d_pc_286
              (coe v2)))
      (coe MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.d_fetch_624)
      (coe
         MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.d_execInstr_384)
      (coe
      ...
      (coe
         ...
         (\ v2 v3 v4 ->
            coe
              MAlonzo.Code.Once.Adequacy.ArchCorrectness.ArithSimX86Z45Z32.du_val'45'x86'45'32_170
              v2 v3))
...
d_arch'45'semantics_24
  = coe
      ...
      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.d_initState_302
      MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.d_run_668
