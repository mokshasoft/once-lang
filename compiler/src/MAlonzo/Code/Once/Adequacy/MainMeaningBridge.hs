...
d_main'45'bridge'45'leaf_22 = erased
-- Once.Adequacy.MainMeaningBridge.main-bridge-go
d_main'45'bridge'45'go_44 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  AgdaAny ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_main'45'bridge'45'go_44 = erased
-- Once.Adequacy.MainMeaningBridge.main-bridge-dispatch
d_main'45'bridge'45'dispatch_76 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
...
d_main'45'bridge'45'dispatch_76 = erased
-- Once.Adequacy.MainMeaningBridge.main-bridge-ef
d_main'45'bridge'45'ef_144 ::
  ...
  AgdaAny ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_main'45'bridge'45'ef_144 = erased
-- Once.Adequacy.MainMeaningBridge.main-bridge
d_main'45'bridge_168 ::
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_main'45'bridge_168 = erased
