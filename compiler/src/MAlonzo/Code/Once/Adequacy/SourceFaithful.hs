...
du_ef_590 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.Surface.Elaborate.du_elaborate_246 (coe v0)
      (coe
...
d_dγ''_1176 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> AgdaAny
d_dγ''_1176 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 ~v9 v10 ~v11
  = du_dγ''_1176 v10
du_dγ''_1176 :: AgdaAny -> AgdaAny
du_dγ''_1176 v0 = coe v0
...
d_ee1_1178 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> MAlonzo.Code.Once.IR.T_IR_16
d_ee1_1178 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6 v7 v8 ~v9 ~v10 ~v11
  = du_ee1_1178 v2 v7 v8
du_ee1_1178 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  MAlonzo.Code.Once.IR.T_IR_16
du_ee1_1178 v0 v1 v2
  = coe
      MAlonzo.Code.Once.Surface.Elaborate.du_elaborate_246 (coe v0)
      (coe v1) (coe MAlonzo.Code.Once.IR.C_Heap_8) (coe v2)
...
d_ee2_1180 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> MAlonzo.Code.Once.IR.T_IR_16
d_ee2_1180 ~v0 ~v1 v2 v3 ~v4 ~v5 ~v6 v7 ~v8 v9 ~v10 ~v11
  = du_ee2_1180 v2 v3 v7 v9
du_ee2_1180 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
...
d_dγ''_1366 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> AgdaAny
d_dγ''_1366 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 ~v9 ~v10 ~v11 ~v12
            ~v13 v14 ~v15
  = du_dγ''_1366 v14
du_dγ''_1366 :: AgdaAny -> AgdaAny
du_dγ''_1366 v0 = coe v0
...
d_es_1368 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> MAlonzo.Code.Once.IR.T_IR_16
d_es_1368 ~v0 ~v1 v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 v9 v10 v11 ~v12 ~v13
          ~v14 ~v15
  = du_es_1368 v2 v9 v10 v11
du_es_1368 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
...
d_ll_1370 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> MAlonzo.Code.Once.IR.T_IR_16
d_ll_1370 ~v0 ~v1 v2 v3 ~v4 ~v5 ~v6 ~v7 ~v8 v9 ~v10 ~v11 v12 ~v13
          ~v14 ~v15
  = du_ll_1370 v2 v3 v9 v12
du_ll_1370 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
...
d_rr_1372 ::
  ...
  MAlonzo.Code.Once.Surface.Syntax.T_Expr_8 ->
  AgdaAny -> Integer -> MAlonzo.Code.Once.IR.T_IR_16
d_rr_1372 ~v0 ~v1 v2 v3 ~v4 ~v5 ~v6 ~v7 ~v8 ~v9 v10 ~v11 ~v12 v13
          ~v14 ~v15
  = du_rr_1372 v2 v3 v10 v13
du_rr_1372 ::
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
...
d_reshape_1374 ::
  ...
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_reshape_1374 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 ~v9 ~v10 ~v11
               ~v12 ~v13 v14 ~v15 v16
  = du_reshape_1374 v14 v16
du_reshape_1374 ::
  AgdaAny ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
du_reshape_1374 v0 v1
  = coe
...
d_branch'7472'_1382 ::
  ...
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_branch'7472'_1382 v0 ~v1 v2 v3 ~v4 ~v5 ~v6 ~v7 ~v8 v9 v10 ~v11
                    v12 v13 v14 ~v15
  = du_branch'7472'_1382 v0 v2 v3 v9 v10 v12 v13 v14
du_branch'7472'_1382 ::
  MAlonzo.Code.Once.Float.Dyadic.T_FloatFormat_28 ->
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  ...
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_branch'7472'_1382 v0 v1 v2 v3 v4 v5 v6 v7
  = coe
      MAlonzo.Code.Data.Sum.Base.du_'91'_'44'_'93''8242'_66
      (\ v8 ->
         MAlonzo.Code.Once.Denotation.DenotTrace.d_eval'7472'_12
           ...
           (coe MAlonzo.Code.Once.IRTy.d_'8970'_'8971'_38 (coe v2))
           (coe du_ll_1370 (coe v1) (coe v2) (coe v3) (coe v5))
           (coe
      ...
      (\ v8 ->
         MAlonzo.Code.Once.Denotation.DenotTrace.d_eval'7472'_12
           ...
           (coe MAlonzo.Code.Once.IRTy.d_'8970'_'8971'_38 (coe v2))
           (coe du_rr_1372 (coe v1) (coe v2) (coe v4) (coe v6))
           (coe
              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v7) (coe v8)))
...
d_case'45'fuse_1402 ::
  ...
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_case'45'fuse_1402 = erased
-- Once.Adequacy.SourceFaithful._.assoc-fuse
d_assoc'45'fuse_1412 ::
  MAlonzo.Code.Once.Float.Dyadic.T_FloatFormat_28 ->
  Integer ->
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  ...
  (Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14) ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_assoc'45'fuse_1412 = erased
-- Once.Adequacy.SourceFaithful._.case-reduce
d_case'45'reduce_1424 ::
  MAlonzo.Code.Once.Float.Dyadic.T_FloatFormat_28 ->
  Integer ->
  MAlonzo.Code.Once.Surface.Context.T_Ctx_6 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
