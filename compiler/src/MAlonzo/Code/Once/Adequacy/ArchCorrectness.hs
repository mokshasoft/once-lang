...
d_x86'45'32'45'correct_6
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Adequacy.ArchCorrectness.x86-32-correct"
-- Once.Adequacy.ArchCorrectness.riscv64-correct
d_riscv64'45'correct_8
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Adequacy.ArchCorrectness.riscv64-correct"
...
d_arch'45'correctness_12 v0
  = case coe v0 of
      MAlonzo.Code.Once.Target.Arch.C_x86'45'64_8
        -> coe
             MAlonzo.Code.Once.Adequacy.ArchCorrectness.X86Z45Z64.d_x86'45'64'45'correct_24
