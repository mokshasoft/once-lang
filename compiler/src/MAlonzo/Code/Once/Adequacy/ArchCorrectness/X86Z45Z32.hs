...
-- Once.Adequacy.ArchCorrectness.X86-32._.IRObsCorrectF
d_IRObsCorrectF_12 ::
...
-- Once.Adequacy.ArchCorrectness.X86-32.x86-32-flat-from-obs
d_x86'45'32'45'flat'45'from'45'obs_22
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Adequacy.ArchCorrectness.X86-32.x86-32-flat-from-obs"
-- Once.Adequacy.ArchCorrectness.X86-32.x86-32-correct
d_x86'45'32'45'correct_24 ::
