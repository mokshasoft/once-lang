...
-- Once.Adequacy.ArchCorrectness.X86-32.flat-trace
d_flat'45'trace_10
  = error
      "MAlonzo Runtime Error: postulate evaluated: Once.Adequacy.ArchCorrectness.X86-32.flat-trace"
