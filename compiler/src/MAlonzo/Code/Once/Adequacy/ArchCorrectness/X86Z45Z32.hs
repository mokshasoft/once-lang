...
d_entry'45'frame'45'x86'45'32_136
  = error
...
d_entry'45'alloc_144 v0 v1
  = coe
      ...
      (coe d_entry'45'frame'45'x86'45'32_136 v0 v1)
...
d_x86'45'32'45'loader'45'faithful_180
  = error
...
d_x86'45'32'45'conc'45'flat'45'sim_186
  = error
...
d_asm'45'trace'45'correct'45'x86'45'32_188 ::
  MAlonzo.Code.Once.CanonicalName.T_CanonicalName_4 ->
  Integer ->
  MAlonzo.Code.Once.Parser.Module.Core.T_Module_44 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
