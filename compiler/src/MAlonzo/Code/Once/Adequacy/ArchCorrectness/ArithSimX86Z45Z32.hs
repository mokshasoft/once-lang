...
d_val'45'x86'45'32_152 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_State_134 ->
  MAlonzo.Code.Once.Target.X86Z45Z32.PhysReg.T_Reg_8 -> Integer
d_val'45'x86'45'32_152 v0 v1 ~v2 = du_val'45'x86'45'32_152 v0 v1
du_val'45'x86'45'32_152 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XInstr_24 ->
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_State_134 ->
  Integer
du_val'45'x86'45'32_152 v0 v1
  = case coe v0 of
...
d_readReg'45'wr'45'arith'45'other_266 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_readReg'45'wr'45'arith'45'other_266 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.readReg-wr-arith-same
d_readReg'45'wr'45'arith'45'same_294 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_readReg'45'wr'45'arith'45'same_294 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.readReg-wr-eax-arith
d_readReg'45'wr'45'eax'45'arith_310 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_readReg'45'wr'45'eax'45'arith_310 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.readReg-wr-eax-same
d_readReg'45'wr'45'eax'45'same_324 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_readReg'45'wr'45'eax'45'same_324 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.wr-arith-esp
d_wr'45'arith'45'esp_336 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_wr'45'arith'45'esp_336 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.wr-eax-esp
d_wr'45'eax'45'esp_350 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_wr'45'eax'45'esp_350 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.wr-arith-ecx
d_wr'45'arith'45'ecx_362 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_wr'45'arith'45'ecx_362 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32.wr-eax-ecx
d_wr'45'eax'45'ecx_376 ::
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_RegFile_12 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_wr'45'eax'45'ecx_376 = erased
...
d_V_394 ::
  ...
  MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_State_134 ->
  Integer
d_V_394 v0 v1 = coe du_val'45'x86'45'32_152 (coe v0) (coe v1)
...
d_readMem'45'writeMem'45'other_618 ::
  (Integer -> Maybe Integer) ->
  Integer ->
  Integer ->
  Integer ->
  (MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_readMem'45'writeMem'45'other_618 = erased
...
d_heapchase'45'agree_1032 ::
  ...
  MAlonzo.Code.Once.Adequacy.ArchCorrectness.ArithSimPathLoadRegion.T_HeapChase_42
d_heapchase'45'agree_1032 v0 v1 v2 v3 v4 v5
  = coe
...
d_plg'45'stack'45'write'45'invisible_1036 ::
  (Integer -> Maybe Integer) ->
  Integer ->
  Integer ->
  Integer ->
...
d_mem'45'agree'45'heap_1080 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_mem'45'agree'45'heap_1080 = erased
...
d_wf'45'e1_1286 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_wf'45'e1_1286 ~v0 ~v1 v2 = du_wf'45'e1_1286 v2
du_wf'45'e1_1286 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_wf'45'e1_1286 v0
...
d_R'45'scratch'45'init_1598 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_R'45'scratch'45'init_1598 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32._.R-step-arg
d_R'45'step'45'arg_1600 ::
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  [MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
  MAlonzo.Code.Once.Arith.Machine.AbsState.T_ArithAbsState_130 ->
...
d_R'45'step'45'reload_1604 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_R'45'step'45'reload_1604 = erased
...
d_Rf'45'init_1608 ::
  ...
  ([MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
   MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_Rf'45'init_1608 v0 v1 v2 v3 v4
  = coe
...
d_Rf'45'sim_1610 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_Rf'45'sim_1610 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         ...
         (\ v5 v6 v7 -> coe du_val'45'x86'45'32_152 v5 v6))
      (\ v5 v6 v7 -> coe du_wf'45'e1_1286 v7) v1 v3 v4
...
d_Rf'45'step_1612 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_Rf'45'step_1612 v0 v1 v2 v3 v4
  = coe
...
d_arith'45'block'45'correct_1614 ::
  MAlonzo.Code.Once.Arith.Machine.Shape.T_InputShape_8 ->
  ...
  ([MAlonzo.Code.Once.Arith.Machine.Shape.T_Side_22] ->
   MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_arith'45'block'45'correct_1614 = erased
...
d_un'45'value_1640 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_un'45'value_1640 = erased
-- Once.Adequacy.ArchCorrectness.ArithSimX86-32._.xreg-idx-inj
d_xreg'45'idx'45'inj_1642 ::
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  MAlonzo.Code.Once.Arith.Backend.XInstr.Syntax.T_XReg_10 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_xreg'45'idx'45'inj_1642 = erased
