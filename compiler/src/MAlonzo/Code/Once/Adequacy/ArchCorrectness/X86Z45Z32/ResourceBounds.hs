...
-- Once.Adequacy.ArchCorrectness.X86-32.ResourceBounds.W.<⇒<ᵇtrue
...
-- Once.Adequacy.ArchCorrectness.X86-32.ResourceBounds.W.lit-hi
d_lit'45'hi_90 ::
  MAlonzo.Code.Once.CanonicalName.T_CanonicalName_4 ->
  Integer ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
...
-- Once.Adequacy.ArchCorrectness.X86-32.ResourceBounds.W.lit-lo
d_lit'45'lo_92 ::
  MAlonzo.Code.Once.CanonicalName.T_CanonicalName_4 ->
  Integer ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
...
data T_AddrNoWrap_224
  = C_constructor_290 (MAlonzo.Code.Once.Adequacy.ArchCorrectness.FlatCore.FlatCorrespondence.T_HeapView_436 ->
...
d_LitFits_292 a0 = ()
data T_LitFits_292
  = C_constructor_342 (MAlonzo.Code.Once.Adequacy.ArchCorrectness.FlatCore.FlatCorrespondence.T_HeapView_436 ->
                       [MAlonzo.Code.Once.CCC.Machine.SMCore.T_AbstractInstr_2218] ->
                       MAlonzo.Code.Once.CCC.Machine.Flat.T_FlatState_68 ->
                       MAlonzo.Code.Once.CCC.Target.X86Z45Z32.Semantics.T_State_290 ->
                       Integer ->
