...
module MAlonzo.Code.Once.Adequacy.ArchCorrectness.X86Z45Z32.RunContext where
...
-- Once.Adequacy.ArchCorrectness.X86-32.RunContext._.Emitted
d_Emitted_18 ::
...
-- Once.Adequacy.ArchCorrectness.X86-32.RunContext._.Reachable
d_Reachable_22 a0 a1 a2 a3 a4 a5 = ()
-- Once.Adequacy.ArchCorrectness.X86-32.RunContext._.RunAt
...
d_run'45'emitted_36 v0
  = coe
      ...
      (coe
         ...
         (coe v0))
      erased
-- Once.Adequacy.ArchCorrectness.X86-32.RunContext._.run-heap
d_run'45'heap_38 ::
  MAlonzo.Code.Once.Adequacy.ArchCorrectness.FlatCore.RunContext.T_RunAt_288 ->
  AgdaAny
d_run'45'heap_38 v0
...
-- Once.Adequacy.ArchCorrectness.X86-32.RunContext._.RunAt.run-heap
d_run'45'heap_54 ::
  MAlonzo.Code.Once.Adequacy.ArchCorrectness.FlatCore.RunContext.T_RunAt_288 ->
  AgdaAny
d_run'45'heap_54 v0
