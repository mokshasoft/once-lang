                       ...
                       (\ v10 ->
                          coe
                            ...
                            (coe
                               ...
                               (coe
                                  MAlonzo.Code.Once.Semantics.Core.du_sem'45'cata_940 v9 v6
                       ...
                       (\ v10 ->
                          coe
                            ...
                            (coe
                               d_inject_30 (coe v1)
                               (coe
                                  MAlonzo.Code.Once.Semantics.Core.du_sem'45'ana_1024 (coe v9)
                                  (coe
                                     (\ v11 ->
                                        coe
                                          MAlonzo.Code.Once.Semantics.Core.du_coerce'45'functor_94
                                          (coe v9)
                                          (coe
                                             d_forget_26
                                             (coe
                ...
                (\ v8 ->
                   coe
                     ...
                     (coe
                        d_inject_30 (coe v1)
                        (coe
                           MAlonzo.Code.Once.CCC.SigOp.Info.d_semM_150 v7
                           (d_forget_26 (coe v0) (coe v3)))))
         _ -> coe v4)
           ...
           -> case coe v0 of
                MAlonzo.Code.Once.Type.C_μ'45'type_132 v10
                  -> coe
                       MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                       (coe
                          MAlonzo.Code.Once.Semantics.Core.du_sem'45'cata_940 v10 v7
                          (d_cata'45'ev'45'alg'7472'_166
           ...
           -> case coe v0 of
                MAlonzo.Code.Once.Type.C_μ'45'type_132 v10
                  -> coe
                       MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                       (coe
                          MAlonzo.Code.Once.Semantics.Core.du_sem'45'para_956 (coe v10)
                          (coe v7)
                          (coe
...
d_z_402 ::
  MAlonzo.Code.Once.Type.T_Functor_110 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  Integer -> MAlonzo.Code.Once.CCC.IR.T_IR_246 -> AgdaAny -> AgdaAny
...
du_z_402 v0 v1
  = coe
      ...
      (coe v0)
      (coe
         MAlonzo.Code.Once.Semantics.Core.du_sem'45'fmap_418 (coe v0)
...
d_layer_444 ::
  MAlonzo.Code.Once.Type.T_Functor_110 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.CCC.IR.T_IR_246 -> AgdaAny -> Integer -> AgdaAny
d_layer_444 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Once.Semantics.Core.du_coerce'45'functor_94 (coe v0)
      (coe
         d_forget_26
         (coe
            MAlonzo.Code.Once.Type.d_'10214'_'10215'T_162 (coe v0) (coe v1))
