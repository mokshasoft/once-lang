        ...
        -> case coe v2 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v11 v12 v13
               -> coe
                    ...
                    (coe du_realize'45'morph_60 (coe v1) (coe v11) (coe v13) (coe v10))
      ...
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'value'45'lift_560 v10
        -> case coe v2 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v11 v12 v13
               -> coe
                    MAlonzo.Code.Once.Surface.Syntax.C_lift'45'morphism_534
                    (coe du_realize'45'global_34 (coe v1) (coe v13) (coe v10))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'pair'45'lit'45'check_576 v10 v11 v12 v13
        -> case coe v1 of
             MAlonzo.Code.Once.TypeCheck.Raw.C_RPair_48 v14 v15
               -> case coe v2 of
                    ...
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'In'45'app'45'check_588 v8 v9 v11
        -> case coe v1 of
             ...
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v11 v12
               -> coe
                    ...
                    (d_realize'45'infer_24
                       ...
                       (coe v9) (coe v10))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'inl'45'app'45'check_612 v9 v10
        -> case coe v1 of
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v11 v12
               -> case coe v2 of
                    ...
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'inr'45'app'45'check_624 v9 v10
        -> case coe v1 of
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v11 v12
               -> case coe v2 of
                    MAlonzo.Code.Once.Type.C__'43'__128 v13 v14
             ...
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v10 v11
               -> coe
                    ...
                    (d_realize_14
                       ...
                       (coe v9))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'subsume_646 v10
        -> case coe v2 of
             MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v11 v12 v13
               -> coe
  ...
  = case coe v4 of
      ...
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'app_268 v8 v10 v11 v12 v14 v15
        -> case coe v1 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Once.TypeCheck.Judgment.C_t'45'effApp_284 v8 v10 v11 v13 v14
        -> case coe v1 of
             MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v15 v16
               -> case coe v2 of
                    MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v17 v18 v19
...
d_realize'45'morph_60 ~v0 v1 v2 v3 ~v4 v5
  = du_realize'45'morph_60 v1 v2 v3 v5
du_realize'45'morph_60 ::
  MAlonzo.Code.Once.TypeCheck.Raw.T_RawExpr_34 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.Type.T_Type_112 ->
  MAlonzo.Code.Once.TypeCheck.Judgment.T__'8866''7504'_'8758'_'8680''91'_'93'__18 ->
  MAlonzo.Code.Once.IR.T_IR_16
du_realize'45'morph_60 v0 v1 v2 v3
  = case coe v3 of
               ...
               -> case coe v14 of
                    MAlonzo.Code.Once.TypeCheck.Raw.C_RApp_42 v16 v17
                      -> coe
                           ...
                           (coe du_realize'45'morph_60 (coe v17) (coe v8) (coe v2) (coe v12))
                           (coe du_realize'45'morph_60 (coe v15) (coe v1) (coe v8) (coe v13))
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
                      ...
                      -> case coe v1 of
                           MAlonzo.Code.Once.Type.C__'43'__128 v17 v18
                             -> coe
                                  ...
                                  (coe
                                     du_realize'45'morph_60 (coe v16) (coe v17) (coe v2) (coe v11))
                                  (coe
                                     du_realize'45'morph_60 (coe v14) (coe v18) (coe v2) (coe v12))
                           _ -> MAlonzo.RTE.mazUnreachableError
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
                      ...
                      -> case coe v2 of
                           MAlonzo.Code.Once.Type.C__'42'__126 v16 v17
                             -> coe
                                  MAlonzo.Code.Once.IR.C_'10216'_'44'_'10217'_38
                                  (coe
                                     du_realize'45'morph_60 (coe v15) (coe v1) (coe v16) (coe v10))
                                  (coe
                                     du_realize'45'morph_60 (coe v13) (coe v1) (coe v17) (coe v11))
                                  (coe MAlonzo.Code.Once.IR.C_Heap_8)
                           _ -> MAlonzo.RTE.mazUnreachableError
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
               ...
               -> case coe v2 of
                    MAlonzo.Code.Once.Type.C__'8658''91'_'93'__130 v12 v13 v14
                      -> coe
                           ...
                           (coe
                              du_realize'45'morph_60 (coe v11)
               ...
               -> case coe v1 of
                    MAlonzo.Code.Once.Type.C_μ'45'type_132 v14
                      -> coe
                           ...
                           (coe
                              du_realize'45'morph_60 (coe v13)
                              (coe
                                 MAlonzo.Code.Once.Type.d_'10214'_'10215'T_166 (coe v14) (coe v2))
                              (coe v2) (coe v11))
                    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      MAlonzo.Code.Once.TypeCheck.Judgment.C_m'45'const_484 v9
        -> coe du_realize'45'global_34 (coe v0) (coe v2) (coe v9)
