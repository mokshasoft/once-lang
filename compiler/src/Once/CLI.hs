...
import Once.Monomorphize (monomorphizeWithContext, extractPrimitiveFamilies, PrimitiveFamilies)
                    ...
                    _ -> do
                      ...
                      case elaborateAllWithEnv modEnv allFunctions of
                        ...
                        Right irFunctions -> do
                          ...
                          let monoFunctions = [(n, t, a, monomorphizeWithContext families t ir) | (n, t, a, ir) <- irFunctions]
                          -- Optimize
